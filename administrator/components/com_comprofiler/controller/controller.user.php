...
* @version $Id: controller.user.php 1814 2012-06-20 09:00:04Z beat $
...
class CBController_user {
	...
	*/
	...
	function saveUser( $option ) {
		...
		if ( ! ( ( ( isset( $_POST['approved'] ) && isset( $_POST['confirmed'] ) ) || ! CBuser::getMyInstance()->authoriseAction( 'core.edit.state', 'com_users' ) ) && isset( $_POST['username'] ) ) ) {
			echo "<script type=\"text/javascript\"> alert('" . addslashes( CBTxt::T('Not Authorized') ) ."'); window.history.go(-1);</script>\n";
			exit;
		}
