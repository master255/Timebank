...
* @version $Id: view.users.php 1774 2012-02-21 14:29:06Z beat $
...
?>
	  ...
	  <th width="13%" class="title"><?php echo 'Телефон'; ?></th>
...
?>
	  ...
	  <td><?php
	  $_CB_database->SetQuery('SELECT cb_telnum FROM `#__comprofiler` where id='.$row->id);
		$tell=$_CB_database->loadResult();
	  echo $tell; ?></td>
