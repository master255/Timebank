...
$versionstring	= "uddeIM 2.6/dev";				// version string for about boxes
$checkversion	= "2.6";							// version as above for check for update - this is the version we have
$checkhotfix	= "0";								// version as above for check for update - this is the version we have
$configversion	= "2.0";							// this is the version number of the configuration file we expect to load
