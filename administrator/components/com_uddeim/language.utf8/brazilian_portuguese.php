...
// *******************************************************************
DEFINE ('_UDDEADM_TRANSLATORS_CREDITS', 'Traduzido por Ed Blender');	// Enter your credits line here, e.g. 'Translation by <a href="http://domain.com" target="_new">John Doe</a>'
...
// New: 2.4
DEFINE ('_UDDEIM_SECURITYCODE', 'Código de Segurança:');

// New: 2.3
DEFINE ('_UDDEADM_CC_HEAD', 'Botão "Exibir linha CC:"');
DEFINE ('_UDDEADM_CC_EXP', 'Quando ativado um usuário pode escorlher se o uddeIM adiciona uma linha CC: contendo ou não todos os destinatários da mensagem.');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_9', '...definir padrão para linha CC:, e moderação');
DEFINE ('_UDDEIM_TOOLBAR_MCP', 'Central de Mensagens');
DEFINE ('_UDDEIM_TOOLBAR_REMOVEMESSAGE', 'Deletar mensagem');
DEFINE ('_UDDEIM_TOOLBAR_DELIVERMESSAGE', 'Entregar mensagem');
DEFINE ('_UDDEADM_OOD_MCP', 'Message Center Plugin desatualizado!');
DEFINE ('_UDDEADM_MCP_STAT', 'Mensagens para moderar:');
DEFINE ('_UDDEADM_MCP_TRASHED', 'Descartado');
DEFINE ('_UDDEADM_MCP_NOTEDEL', 'Deletar esta mensagem do banco de dados?');
DEFINE ('_UDDEADM_MCP_NOTEDELIVER', 'Entregar esta mensagem ao destinatário?');
DEFINE ('_UDDEADM_MCP_SHOWHIDE', 'Exibir/Ocultar');
DEFINE ('_UDDEADM_MCP_EDIT', 'Centro de Controle de Mensagem');
DEFINE ('_UDDEADM_MCP_FROM', 'De');
DEFINE ('_UDDEADM_MCP_TO', 'Para');
DEFINE ('_UDDEADM_MCP_TEXT', 'Mensagem');
DEFINE ('_UDDEADM_MCP_DELETE', 'Deletar');
DEFINE ('_UDDEADM_MCP_DATE', 'Data');
DEFINE ('_UDDEADM_MCP_DELIVER', 'Entregar');
DEFINE ('_UDDEADM_USERSET_MODERATE', 'Mod');
DEFINE ('_UDDEADM_USERSET_SELMODERATE', '- Mod -');
DEFINE ('_UDDEIM_MCP_MODERATED', 'Suas mensagens serão moderadas. Um moderador irá verificá-las antes que sejam entregues aos destinatários.');
DEFINE ('_UDDEIM_STATUS_DELAYED', 'Aguardando pelo moderador');
DEFINE ('_UDDEADM_MODNEWUSERS_HEAD', 'Moderar novos usuários');
DEFINE ('_UDDEADM_MODNEWUSERS_EXP', 'Quando ativado as mensagens de novos usuários serão moderadas por padrão.');
DEFINE ('_UDDEADM_MODPUBUSERS_HEAD', 'Moderar usuários públicos');
DEFINE ('_UDDEADM_MODPUBUSERS_EXP', 'Quando ativado as mensagens de usuários públicos serão moderadas.');
DEFINE ('_UDDEIM_MENUICONS_P3', 'Sem menu');

// New: 2.2
DEFINE ('_UDDEADM_OOD_PF', 'Public Frontend Plugin desatualizado!');
DEFINE ('_UDDEADM_OOD_A', 'File Attachment Plugin desatualizado!');
DEFINE ('_UDDEADM_OOD_RSS', 'RSS Plugin desatualizado!');
DEFINE ('_UDDEADM_OOD_ASC', 'Message Report Center Plugin desatualizado!');
DEFINE ('_UDDEIM_NOMESSAGES3_FILTERED', '<b>Você não tem mensagens filtradas em seu %s.</b>');
DEFINE ('_UDDEIM_FILTER_UNREAD', 'não lida');
DEFINE ('_UDDEIM_FILTER_FLAGGED', 'sinalizada');
DEFINE ('_UDDEADM_GRAVATAR_HEAD', 'gravatar ativado');
DEFINE ('_UDDEADM_GRAVATAR_EXP', 'Ativa o suporte ao gravatar.');
DEFINE ('_UDDEADM_GRAVATARD_HEAD', 'imageset gravatar');
DEFINE ('_UDDEADM_GRAVATARD_EXP', 'Selecione o imageset padrão para imagens.');
DEFINE ('_UDDEADM_GRAVATARR_HEAD', 'classificação gravatar');
DEFINE ('_UDDEADM_GRAVATARR_EXP', 'Por padrão, apenas imagens com classificação "G" são exibidas a menos que você indique classificações superiores. "X" exibe todas as imagens gravatar.');
...
DEFINE ('_UDDEADM_GRG', 'G = Geral');
DEFINE ('_UDDEADM_GRPG', 'PG = Controle de Pais');
DEFINE ('_UDDEADM_GRR', 'R = Restrito');
DEFINE ('_UDDEADM_GRX', 'X = Adultos apenas');
DEFINE ('_UDDEADM_NINJABOARD', 'Ninjaboard');
DEFINE ('_UDDEADM_KUNENA16', 'Kunena 1.6+');
DEFINE ('_UDDEIM_PROCESSING', 'Processando...');
DEFINE ('_UDDEIM_SEND_NONOTIFY', 'Não enviar e-mails de notificação');
DEFINE ('_UDDEIM_SYSGM_NONOTIFY', 'E-mails de notificação não serão enviados');
DEFINE ('_UDDEIM_SYSGM_FORCEEMBEDDED', 'O texto será incorporado no e-mail de notificação');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_8', '...definir padrão para miniaturas');
DEFINE ('_UDDEADM_AVATARWH_HEAD', 'Tamanho de exibição de miniaturas');
DEFINE ('_UDDEADM_AVATARWH_EXP', 'Largura e altura (em pixels) das miniaturas (0 = o tamanho não será alterado).');
DEFINE ('_UDDEIM_SAVE', 'Salvar');

// New: 2.1
DEFINE ('_UDDEIM_BODY_SPAMREPORT',
"Olá %you%,\n\n%touser% reportou uma mensagem suspeita de %fromuser%. Por favor efetue o login e verifique!\n\n%livesite%");
DEFINE ('_UDDEIM_SUBJECT_SPAMREPORT', 'Uma mensagem foi reportada em %site%');
DEFINE ('_UDDEADM_KBYTES', 'KByte');
DEFINE ('_UDDEADM_MBYTES', 'MByte');
DEFINE ('_UDDEIM_ATT_FILEDELETED', 'O arquivo foi deletado');
DEFINE ('_UDDEIM_ATT_FILENOTEXISTS', 'Erro: O arquivo não existe');
DEFINE ('_UDDEIM_ATTACHMENTS2', 'Anexos (máx. %s por arquivo):');
DEFINE ('_UDDEADM_JOOCM', 'Joo!CM');
DEFINE ('_UDDEADM_UNPROTECTATTACHMENT_HEAD', 'Downloads de arquivo desprotegido');
DEFINE ('_UDDEADM_UNPROTECTATTACHMENT_EXP', 'Normalmente o uddeIM não revela o caminho do servidor de arquivos anexados, assim ninguém - mesmo que o nome do arquivo seja conhecido - pode baixar o arquivo. Habilitar esta opção força o uddeIM à retornar o caminho completo no servidor. Por razões de segurança, o uddeIM adiciona um hash MD5 ao nome original do arquivo. Os usuários podem baixar o arquivo diretamente quando o caminho completo é conhecido. Somente utilize com cuidado! LEIA O FAQ AO USAR ESTA OPÇÃO!');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_7', '...definir o padrão para arquivos anexos, frontend público');
DEFINE ('_UDDEIM_FILETYPE_NOTALLOWED', 'Tipo de arquivo não permitido');
DEFINE ('_UDDEADM_ALLOWEDEXTENSIONS_HEAD', 'Extensões permitidas');
DEFINE ('_UDDEADM_ALLOWEDEXTENSIONS_EXP', 'Informe todas as extensões permitidas (separadas por ";"). Deixe em branco para sem restrições.');
DEFINE ('_UDDEADM_PUBEMAIL_HEAD', 'E-mail requerido');
DEFINE ('_UDDEADM_PUBEMAIL_EXP', 'Se ativado um usuário público terá que informar um endereço de e-mail.');
DEFINE ('_UDDEADM_WAITDAYS_HEAD', 'Dias de espera');
DEFINE ('_UDDEADM_WAITDAYS_EXP', 'Especifique quantos dias um usuário deverá esperar até que ele tenha permissão para enviar mensagens (para 3 horas informe 0.125).');
DEFINE ('_UDDEIM_WAITDAYS1', 'Você tem que esperar ');
DEFINE ('_UDDEIM_WAITDAYS2', ' dias até que você possa enviar mensagens.');
DEFINE ('_UDDEIM_WAITDAYS2H', ' horas até que você possa enviar mensagens.');

// New: 2.0
DEFINE ('_UDDEADM_RECAPTCHAPRV_HEAD', 'Chave privativa do reCaptcha');
DEFINE ('_UDDEADM_RECAPTCHAPRV_EXP', 'Quando quiser usar o reCaptcha, informe sua chave privativa aqui.');
DEFINE ('_UDDEADM_RECAPTCHAPUB_HEAD', 'Chave pública do reCaptcha');
DEFINE ('_UDDEADM_RECAPTCHAPUB_EXP', 'Quando quiser usar o reCaptcha, informe sua chave pública aqui.');
DEFINE ('_UDDEADM_CAPTCHA_INTERNAL', 'Interna');
DEFINE ('_UDDEADM_CAPTCHA_RECAPTCHA', 'reCaptcha');
DEFINE ('_UDDEADM_CAPTCHATYPE_HEAD', 'Serviço Captcha');
DEFINE ('_UDDEADM_CAPTCHATYPE_EXP', 'Qual serviço captcha deseja utilizar: o serviço interno ou o reCaptcha (consulte <a href="http://recaptcha.net" target="_new">reCaptcha</a> para mais informações)?');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_6', '...definir padrão para serviço captcha');
DEFINE ('_UDDEADM_AUP', 'AlphaUserPoints');
DEFINE ('_UDDEADM_CHECKFILESFOLDER', 'Por favor mova <i>\uddeimfiles</i> para <i>\images\uddeimfiles</i>. Consulte a documentação!');
DEFINE ('_UDDEADM_CRYPT4', 'Encriptografia forte');
DEFINE ('_UDDEADM_ALLOWTOALL2_HEAD', 'Permitir envio de mensagens de sistema');
DEFINE ('_UDDEADM_ALLOWTOALL2_EXP', 'o uddeIM suporta mensagens de sistema. Elas são enviadas para todos os usuários de seu sistema. Use-as moderadamente.');
DEFINE ('_UDDEADM_ALLOWTOALL2_0', 'desativado');
DEFINE ('_UDDEADM_ALLOWTOALL2_1', 'apenas admins');
DEFINE ('_UDDEADM_ALLOWTOALL2_2', 'admins e gerentes');

// New: 1.9
DEFINE ('_UDDEIM_FILEUPLOAD_FAILED', 'Upload de arquivo falhou');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_5', '...definir padrão para arquivo anexado');
DEFINE ('_UDDEADM_ENABLEATTACHMENT_HEAD', 'Habilitar anexação de arquivos');
DEFINE ('_UDDEADM_ENABLEATTACHMENT_EXP', 'Isto habilita o envio de arquivos anexos para todos os usuários registrados ou apenas para os admins.');
DEFINE ('_UDDEADM_MAXSIZEATTACHMENT_HEAD', 'Tam. máx. de arquivo');
DEFINE ('_UDDEADM_MAXSIZEATTACHMENT_EXP', 'Tamanho máximo permitido para arquivos anexados.');
DEFINE ('_UDDEIM_FILESIZE_EXCEEDED', 'Foi excedido o tamanho máximo permitido para o arquivo');
DEFINE ('_UDDEADM_BYTES', 'Bytes');
DEFINE ('_UDDEADM_MAXATTACHMENTS_HEAD', 'Máximo de anexos');
DEFINE ('_UDDEADM_MAXATTACHMENTS_EXP', 'Número máximo de anexos por mensagem.');
DEFINE ('_UDDEIM_DOWNLOAD', 'Download');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_HEAD', 'Deleção de arquivos invocada');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_YES', 'apenas por admins');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_NO', 'por qualquer usuário');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_MANUALLY', 'manualmente');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_EXP', 'Deleções automáticas causam a sobrecarga do servidor. Se você escolher <b>apenas por admins</b> as deleções automáticas são invocadas quando um admin verificar a caixa de entrada dele. Escolha esta opção se um admin verifica suas mensagens regularmente. Sites pequenos ou raramente administrados podem escolher  <b>por qualquer usuário</b>.');
DEFINE ('_UDDEADM_FILEMAINTENANCE_PRUNE', 'Limpar arquivos agora');
DEFINE ('_UDDEADM_FILEMAINTENANCEDEL_HEAD', 'Invocar deleção de arquivos');
DEFINE ('_UDDEADM_FILEMAINTENANCEDEL_EXP', 'Remove os arquivos deletados do banco de dados. É o mesmo que \'Podar arquivos agora\' da aba sistema.');
DEFINE ('_UDDEADM_FILEMAINTENANCEDEL_ERASE', 'APAGAR');
DEFINE ('_UDDEIM_ATTACHMENTS', 'Anexos (máx. de %u bytes por arquivo):');
DEFINE ('_UDDEADM_MAINTENANCE_F1', 'Anexos órfãos armazenados no sistema de arquivos: ');
DEFINE ('_UDDEADM_MAINTENANCE_F2', 'Deletando arquivos órfãos');
DEFINE ('_UDDEADM_BACKUP_DONE', 'Configuração de Backup feita.');
DEFINE ('_UDDEADM_RESTORE_DONE', 'Configuração de Restauração feita.');
DEFINE ('_UDDEADM_PRUNE_DONE', 'Limpeza de mensagem feita.');
DEFINE ('_UDDEADM_FILEPRUNE_DONE', 'Limpeza de arquivos anexos feita.');
DEFINE ('_UDDEADM_FOLDERCREATE_ERROR', 'Erro ao criar pasta: ');
DEFINE ('_UDDEADM_ATTINSTALL_WRITEFAILED', 'Erro ao criar arquivo: ');
DEFINE ('_UDDEADM_ATTINSTALL_IGNORE', 'Você pode ignorar este erro quando você não possui o File attachments premium plugin (consultar a FAQ).');
DEFINE ('_UDDEADM_ATTACHMENTGROUPS_HEAD', 'Grupos permitidos');
DEFINE ('_UDDEADM_ATTACHMENTGROUPS_EXP', 'Grupos que tem permissão para enviar arquivos anexos.');
DEFINE ('_UDDEIM_SELECT', 'Selecionar');
DEFINE ('_UDDEIM_ATTACHMENT', 'Anexo');
DEFINE ('_UDDEADM_SHOWLISTATTACHMENT_HEAD', 'Exibir ícones de anexos');
DEFINE ('_UDDEADM_SHOWLISTATTACHMENT_EXP', 'Mostra ícones de anexos nas listas de mensagens (caixa de entrada, saída, arquivo).');
DEFINE ('_UDDEIM_HELP_ATTACHMENT', 'A mensagem contém anexos.');
DEFINE ('_UDDEADM_MAINTENANCE_COUNTFILES', 'Referências de arquivo no banco de dados:');
DEFINE ('_UDDEADM_MAINTENANCE_COUNTFILESDISTINCT', 'Arquivos anexos armazenados:');
DEFINE ('_UDDEADM_SHOWMENUCOUNT_HEAD', 'Exibir contadores');
DEFINE ('_UDDEADM_SHOWMENUCOUNT_EXP', 'Quando definido com <b>sim</b>, a barra de menu contém contadores de mensagem. Nota: isto requer várias consultas adicionais ao banco de dados, portanto não deve ser usado em sistemas com baixo poder de processamento.');
DEFINE ('_UDDEADM_CONFIG_FTPLAYER', 'Configuração (acesso via camada FTP):');
DEFINE ('_UDDEADM_ENCODEHEADER_HEAD', 'Encodificar cabeçalhos de mensagens');
DEFINE ('_UDDEADM_ENCODEHEADER_EXP', 'Defina <b>sim</b>, se os cabeçalhos das mensagens (campo assunto, por exemplo) deve ser encodificado no padrão rfc 2047. Útil para evitar problemas envolvendo caracteres especiais.');
DEFINE ('_UDDEIM_UP', 'ordenação ascendente');
DEFINE ('_UDDEIM_DOWN', 'ordenação descendente');
DEFINE ('_UDDEIM_UPDOWN', 'ordenação');
DEFINE ('_UDDEADM_ENABLESORT_HEAD', 'Habilitar ordenação');
DEFINE ('_UDDEADM_ENABLESORT_EXP', 'Defina <b>sim</b>, se o usuário poderá efetuar a ordenação na caixa de entrada, saída e arquivo (isto causará uma carga adicional no servidor do banco de dados).');
...
DEFINE ('_UDDEIM_NOMESSAGES2_FR_FILTERED', '<b>Não há mensagens deste usuário em sua%s.</b>');
DEFINE ('_UDDEIM_NOMESSAGES2_TO_FILTERED', '<b>Não há mensagens para este usuário em sua%s.</b>');
DEFINE ('_UDDEIM_NOMESSAGES2_UNFR_FILTERED', '<b>Não há mensagens não lidas deste usuário em sua%s.</b>');
DEFINE ('_UDDEIM_NOMESSAGES2_UNTO_FILTERED', '<b>Não há mensagens não lidas para este usuário em sua%s.</b>');

// New: 1.7
DEFINE ('_UDDEADM_EMAILSTOPPED', '\'Parar email\' ativado.');
DEFINE ('_UDDEIM_ACCOUNTLOCKED', 'O acesso à sua caixa postal foi bloqueado. Por favor contate o administrador do site.');
DEFINE ('_UDDEADM_USERSET_LOCKED', 'Bloqueado');
DEFINE ('_UDDEADM_USERSET_SELLOCKED', '- Bloqueado -');
DEFINE ('_UDDEADM_CBBANNED_HEAD', 'Verificar por usuários banidos do CB');
DEFINE ('_UDDEADM_CBBANNED_EXP', 'Quando ativado, o uddeIM verifica se um usuário foi banido no CB e não permite que ele acesse o uddeIM. Adicionalmente, também impede que os demais usuários enviem mensagens ao usuário banido.');
DEFINE ('_UDDEIM_YOUAREBANNED', 'Você foi banido. Por favor contate o administrador ou o moderador.');
DEFINE ('_UDDEIM_USERBANNED', 'Usuário foi banido');
DEFINE ('_UDDEADM_JOOBB', 'Joo!BB');
DEFINE ('_UDDEPLUGIN_SEARCHSECTION', 'Mensagem Privativa');
DEFINE ('_UDDEPLUGIN_MESSAGES', 'Mensagens Privativas');
DEFINE ('_UDDEADM_MAINTENANCEDEL_HEAD', 'Invocar deleção de mensagem');
// note "This  is the same as _UDDEADM_MAINTENANCE_PRUNE on the system tab."
DEFINE ('_UDDEADM_MAINTENANCEDEL_EXP', 'Remove mensagens deletadas do banco de dados. É o mesmo que \'Apagar mensagens agora\' na aba de sistema.');
DEFINE ('_UDDEADM_MAINTENANCEDEL_ERASE', 'APAGAR');
DEFINE ('_UDDEADM_REPORTSPAM_HEAD', 'Link Denunciar SPAM');
DEFINE ('_UDDEADM_REPORTSPAM_EXP', 'Quando ativado, exibe um link \'Denúnciar SPAM\' que permite aos usuários reportarem SPAM para os administradores.');
DEFINE ('_UDDEIM_TOOLBAR_REMOVESPAM', 'Deletar mensagem');
DEFINE ('_UDDEIM_TOOLBAR_REMOVEREPORT', 'Remover denúncia');
DEFINE ('_UDDEIM_TOOLBAR_SPAMCONTROL', 'Controle de Denúncias');
DEFINE ('_UDDEADM_INFORMATION', 'Informação');
DEFINE ('_UDDEADM_SPAMCONTROL_STAT', 'Mensagens denúnciadas:');
DEFINE ('_UDDEADM_SPAMCONTROL_TRASHED', 'Apagada');
DEFINE ('_UDDEADM_SPAMCONTROL_NOTEDEL', 'Deletar esta mensagem do banco de dados?');
DEFINE ('_UDDEADM_SPAMCONTROL_NOTEREMOVE', 'Remover esta denúncia?');
DEFINE ('_UDDEADM_SPAMCONTROL_SHOWHIDE', 'Exibir/Ocultar');
DEFINE ('_UDDEADM_SPAMCONTROL_EDIT', 'Centro de Controle de Denúncias');
DEFINE ('_UDDEADM_SPAMCONTROL_FROM', 'De');
DEFINE ('_UDDEADM_SPAMCONTROL_TO', 'Para');
DEFINE ('_UDDEADM_SPAMCONTROL_TEXT', 'Mensagem');
DEFINE ('_UDDEADM_SPAMCONTROL_DELETE', 'Deletar');
DEFINE ('_UDDEADM_SPAMCONTROL_REMOVE', 'Remover');
...
DEFINE ('_UDDEIM_SPAMCONTROL_UNREPORT', 'Recuperar esta denúncia');
DEFINE ('_UDDEADM_JOMSOCIAL', 'JomSocial');
DEFINE ('_UDDEADM_KUNENA', 'Kunena');
DEFINE ('_UDDEADM_ADMIN_FILTER', 'Filtro');
DEFINE ('_UDDEADM_ADMIN_DISPLAY', 'Exibir #');
DEFINE ('_UDDEADM_TRASHORIGINALSENT_HEAD', 'Apagar mensagem enviada');
DEFINE ('_UDDEADM_TRASHORIGINALSENT_EXP', 'Quando ativado, coloca um checkbox próximo do botão \'Enviar\' chamado \'Apagar mensagem\', desmarcado por padrão. Os usuários podem marcar o checkbox se quiserem apagar uma mensagem imediatamente após enviá-la.');
DEFINE ('_UDDEIM_TRASHORIGINALSENT', 'apagar mensagem');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_4', '...definir padrões para deletar mensagens enviadas, denunciar spam, usuários banidos do CB');
DEFINE ('_UDDEADM_VERSIONCHECK_IMPORTANT', 'Links importantes:');
...
DEFINE ('_UDDEADM_MAINTENANCEFIX_EXP', "o uddeIM usa dois arquivos XML para assegurar que os pacotes podem ser instalados no Joomla 1.0 e 1.5. No Joomla 1.5 um arquivo XML não é necessário e isso faz com que o gerenciador de extensões mostre um aviso de incompatibilidade (o que é incorreto). Isso remove os arquivos desnecessários, e o aviso deixa de ser exibido.");
DEFINE ('_UDDEADM_MAINTENANCE_FIX', "CORREÇÃO");
DEFINE ('_UDDEADM_MAINTENANCE_XML1', "Os instaladores XML do Joomla 1.0 e Joomla 1.5 para os pacotes do uddeIM existem.<br />");
DEFINE ('_UDDEADM_MAINTENANCE_XML2', "Isto é necessário devido aos pacotes de instalação no Joomla 1.0 e Joomla 1.5.<br />");
DEFINE ('_UDDEADM_MAINTENANCE_XML3', "Uma vez que isso não é necessário depois que a instalação foi concluída, o instalador do Joomla 1.0 pode ser removido nos sistemas Joomla 1.5.<br />");
DEFINE ('_UDDEADM_MAINTENANCE_XML4', "Isso será feito para os seguintes pacotes:<br />");
DEFINE ('_UDDEADM_MAINTENANCE_FXML1', "Serão removidos os instaladores XML desnecessários para os seguintes pacotes do uddeIM:<br />");
DEFINE ('_UDDEADM_MAINTENANCE_FXML2', "Não foi encontrado nenhum instalador XML desnecessário para os pacotes do uddeIM!<br />");
DEFINE ('_UDDEADM_SHOWMENUICONS1_HEAD', 'Aparência da barra de menu');
DEFINE ('_UDDEADM_SHOWMENUICONS1_EXP', 'Aqui você pode configurar se a barra de menu deve ser exibida com ícones e/ou textos.');
DEFINE ('_UDDEIM_MENUICONS_P1', 'Ícones e texto');
DEFINE ('_UDDEIM_MENUICONS_P2', 'Ícones somente');
DEFINE ('_UDDEIM_MENUICONS_P0', 'Texto somente');
DEFINE ('_UDDEIM_LISTSLIMIT_2', 'Número máximo de destinatários na lista:');
DEFINE ('_UDDEADM_ADDEMAIL_ADMIN', 'Admins podem selecionar');
DEFINE ('_UDDEAIM_ADDEMAIL_SELECT', 'Notificar com mensagem');
DEFINE ('_UDDEAIM_ADDEMAIL_TITLE', 'Incluir a mensagem completa no e-mail de notificação.');

// New: 1.6
DEFINE ('_UDDEIM_NOLISTSELECTED', 'Nenhuma lista de usuário selecionada!');
DEFINE ('_UDDEADM_NOPREMIUM', 'Plugin Premium não instalado');
DEFINE ('_UDDEIM_LISTGLOBAL_CREATOR', 'Criador:');
...
DEFINE ('_UDDEIM_LISTGLOBAL_RESTRICTED', 'Restrita');
DEFINE ('_UDDEIM_LISTGLOBAL_P0', 'Lista de contatos normal');
DEFINE ('_UDDEIM_LISTGLOBAL_P1', 'Lista de contatos global');
DEFINE ('_UDDEIM_LISTGLOBAL_P2', 'Lista de contatos restrita (apenas membros da lista podem acessar a lista)');
DEFINE ('_UDDEIM_TOOLBAR_USERSETTINGS', 'Configurações do usuário');
DEFINE ('_UDDEIM_TOOLBAR_REMOVESETTINGS', 'Remover configurações');
DEFINE ('_UDDEIM_TOOLBAR_CREATESETTINGS', 'Criar configurações');
DEFINE ('_UDDEIM_TOOLBAR_SAVE', 'Salvar');
DEFINE ('_UDDEIM_TOOLBAR_BACK', 'Voltar');
DEFINE ('_UDDEIM_TOOLBAR_TRASHMSGS', 'Apagar mensagens');
DEFINE ('_UDDEIM_CBPLUG_CONT', '[continuar]');
DEFINE ('_UDDEIM_CBPLUG_UNBLOCKNOW', '[desbloquear]');
DEFINE ('_UDDEIM_CBPLUG_DOBLOCK', 'Bloquear usuário');
DEFINE ('_UDDEIM_CBPLUG_DOUNBLOCK', 'Desbloquear usuário');
DEFINE ('_UDDEIM_CBPLUG_BLOCKINGCFG', 'Bloqueando');
DEFINE ('_UDDEIM_CBPLUG_BLOCKED', 'Você bloqueou este usuário.');
DEFINE ('_UDDEIM_CBPLUG_UNBLOCKED', 'Este usuário pode contatar você.');
DEFINE ('_UDDEIM_CBPLUG_NOWBLOCKED', 'Este usuário agora está bloqueado.');
DEFINE ('_UDDEIM_CBPLUG_NOWUNBLOCKED', 'Este usuário não está bloqueado.');
DEFINE ('_UDDEADM_PARTIALIMPORTDONE', 'Concluída a importação parcial das mensagens do antigo PMS. Não importe esta parte novamente, senão as mensagens serão importadas outra vez, e serão exibidas em duplicidade.');
DEFINE ('_UDDEADM_IMPORT_HELP', 'Nota: AS mensagens podem ser importadas todas de uma vez ou em partes. A importação em partes é necessária se houverem falhas, quando a quantidade de mensagens à importar for muito grande.');
DEFINE ('_UDDEADM_IMPORT_PARTIAL', 'Importação parcial:');
DEFINE ('_UDDEADM_UPDATEYOURDB', 'Importante: Você não atualizou o seu banco de dados! Por favor consulte o README sobre como atualizar o uddeIM corretamente!');
DEFINE ('_UDDEADM_RESTRALLUSERS_HEAD', 'Restringir acesso de "Todos os usuários"');
DEFINE ('_UDDEADM_RESTRALLUSERS_EXP', 'Você pode restringir o acesso para a lista "Todos os usuários". Normalmente a lista "Todos os usuários" está disponível para todos (<i>sem restrição</i>).');
DEFINE ('_UDDEADM_RESTRALLUSERS_0', 'sem restrição');
DEFINE ('_UDDEADM_RESTRALLUSERS_1', 'usuários especiais');
DEFINE ('_UDDEADM_RESTRALLUSERS_2', 'apenas administradores');
DEFINE ('_UDDEIM_MESSAGE_UNARCHIVED', 'Mensagem restaurada.');
DEFINE ('_UDDEADM_AUTOFORWARD_SPECIAL', 'usuários especiais');
DEFINE ('_UDDEIM_HELP', 'Ajuda');
DEFINE ('_UDDEIM_HELP_HEADLINE1', 'Ajuda do uddeIM');
DEFINE ('_UDDEIM_HELP_HEADLINE2', 'Breve resumo de todas as funções');
DEFINE ('_UDDEIM_HELP_INBOX', 'A <b>Caixa de Entrada</b> contém todas as suas mensagens recebidas, todo e-mail que você recebe fica aqui.');
DEFINE ('_UDDEIM_HELP_OUTBOX', 'A <b>Caixa de Saída</b> contém uma cópia de cada mensagem que você envia, nela você pode ver as mensagens que enviou.');
DEFINE ('_UDDEIM_HELP_TRASHCAN', 'A <b>Lixeira</b> contém todas as mensagens apagadas. As mensagens não são excluídas imediatamente e são mantidas durante um certo período de tempo. Enquanto a mensagem estiver armazenada na lixeira, você poderá restaurá-la.');
DEFINE ('_UDDEIM_HELP_ARCHIVE', 'O <b>Arquivo</b> contém todas as mensagens da Caixa de Entrada, que foram arquivadas. Você só pode arquivar mensagens de sua Caixa de Entrada. Quando precisar arquivar uma mensagem escrita por você, selecione a opção <i>cópia para mim</i> ao enviá-la.');
DEFINE ('_UDDEIM_HELP_USERLISTS', '<b>Contatos</b> permite que sejam mantidas listas de contato (também conhecidas como listas de distribuição). Estas listas permitem enviar mensagens privativas à múltiplos destinatários. Ao invés de adicionar os destinatários um por um, você simplesmente informa o <i>#nome_da_lista</i>.');
DEFINE ('_UDDEIM_HELP_SETTINGS', '<b>Configurações</b> engloba todas as opções configuráveis pelo usuário...');
DEFINE ('_UDDEIM_HELP_COMPOSE', '<b>Compor</b> permite a criação de uma nova mensagem privativa.');
DEFINE ('_UDDEIM_HELP_IREAD', 'A mensagem foi lida (você pode mudar o status).');
DEFINE ('_UDDEIM_HELP_IUNREAD', 'A mensagem continua não-lida (você pode mudar o status).');
DEFINE ('_UDDEIM_HELP_OREAD', 'A mensagem foi lida.');
DEFINE ('_UDDEIM_HELP_OUNREAD', 'A mensagem ainda não foi lida. Mensagens enviadas e não-lidas podem ser recolhidas.');
DEFINE ('_UDDEIM_HELP_TREAD', 'A mensagem foi lida.');
DEFINE ('_UDDEIM_HELP_TUNREAD', 'A mensagem continua não-lida.');
DEFINE ('_UDDEIM_HELP_FLAGGED', 'A mensagem foi marcada, ex.: quando é uma mensagem importante (você pode mudar o status).');
DEFINE ('_UDDEIM_HELP_UNFLAGGED', 'Mensagem <i>Normal</i> (você pode mudar o status).');
DEFINE ('_UDDEIM_HELP_ONLINE', 'O usuário está online.');
DEFINE ('_UDDEIM_HELP_OFFLINE', 'O usuário está offline.');
DEFINE ('_UDDEIM_HELP_DELETE', 'Deletar a mensagem (mover a mensagem para a Lixeira).');
DEFINE ('_UDDEIM_HELP_FORWARD', 'Encaminhar a mensagem para outro destinatário.');
DEFINE ('_UDDEIM_HELP_ARCHIVEMSG', 'Arquivar a mensagem. Mensagens arquivadas não serão deletadas automaticamente, se o administrador tiver configurado um prazo para as mensagens fiquem armazenadas na Caixa de Entrada.');
DEFINE ('_UDDEIM_HELP_UNARCHIVEMSG', 'Desarquivar a mensagem. A mensagem sejá movida de volta para a Caixa de Entrada.');
DEFINE ('_UDDEIM_HELP_RECALL', 'Recolher a mensagem. Mensagens enviadas podem ser recolhidas quando elas ainda não foram lidas pelo destinatário.');
DEFINE ('_UDDEIM_HELP_RECYCLE', 'Restaurar a mensagem (mover a mensagem da Lixeira de volta para a Caixa de Entrada/Saída).');
DEFINE ('_UDDEIM_HELP_NOTIFY', 'Configuração do e-mail de notificação quando uma nova mensagem é recebida.');
DEFINE ('_UDDEIM_HELP_AUTORESPONDER', 'Quando a auto-resposta está ativada cada mensagem recebida será imediatamente respondida.');
DEFINE ('_UDDEIM_HELP_AUTOFORWARD', 'Novas mensagens podem ser encaminhadas para outro usuário automaticamente.');
DEFINE ('_UDDEIM_HELP_BLOCKING', 'Você pode bloquear usuários. Estes usuários não poderão enviar mensagens privativas para você.');
DEFINE ('_UDDEIM_HELP_MISC', 'Aqui você encontrará mais algumas opções de configuração');
DEFINE ('_UDDEIM_HELP_FEED', 'Você pode acessar sua Caixa de Entrada usando uma fonte RSS.');
DEFINE ('_UDDEADM_SEPARATOR_HEAD', 'Separador');
DEFINE ('_UDDEADM_SEPARATOR_EXP', 'Selecione o separador usado para múltiplos destinatários (o padrão é ",").');
DEFINE ('_UDDEADM_SEPARATOR_P0', 'vírgula (padrão)');
DEFINE ('_UDDEADM_SEPARATOR_P1', 'ponto-e-vírgula');
DEFINE ('_UDDEADM_RSSLIMIT_HEAD', 'itens RSS');
DEFINE ('_UDDEADM_RSSLIMIT_EXP', 'Limita o número de itens retornados pelo RSS (0 para ilimitado).');
DEFINE ('_UDDEADM_SHOWHELP_HEAD', 'Mostrar botão de ajuda');
DEFINE ('_UDDEADM_SHOWHELP_EXP', 'Quando ativado, um botão de ajuda é exibido.');
DEFINE ('_UDDEADM_SHOWIGOOGLE_HEAD', 'Mostrar botão de iGoogle gadget');
DEFINE ('_UDDEADM_SHOWIGOOGLE_EXP', 'Quando ativado um botão <i>Adicionar ao iGoogle</i> para o uddeIM é exibido nas preferências do usuário.');
DEFINE ('_UDDEADM_MOOTOOLS_NONE11', 'não carregar MooTools (1.1 é usado)');
DEFINE ('_UDDEADM_MOOTOOLS_NONE12', 'não carregar MooTools (1.2 é usado)');
DEFINE ('_UDDEIM_RSS_INTRO1', 'Você pode acessar sua Caixa de Entrada usando uma fonte RSS (0.91).');
DEFINE ('_UDDEIM_RSS_INTRO1B', 'A URL de acesso é:');
DEFINE ('_UDDEIM_RSS_INTRO2', 'Não forneça esta URL para outros usuários, pois ela permite o acesso à sua Caixa de Entrada.');
DEFINE ('_UDDEIM_RSS_FEED', 'Fonte de Mensagem RSS');
DEFINE ('_UDDEIM_RSS_NOOBJECT', 'Erro de objeto ausente...');
DEFINE ('_UDDEIM_RSS_USERBLOCKED', 'Usuário bloqueado...');
DEFINE ('_UDDEIM_RSS_NOTALLOWED', 'Acesso negado...');
DEFINE ('_UDDEIM_RSS_WRONGPASSWORD', 'Nome de usuário ou senha incorreto...');
DEFINE ('_UDDEIM_RSS_NOMESSAGES', 'Sem mensagens');
DEFINE ('_UDDEIM_RSS_NONEWMESSAGES', 'Sem mensagens novas');
DEFINE ('_UDDEADM_ENABLERSS_HEAD', 'Ativar RSS');
DEFINE ('_UDDEADM_ENABLERSS_EXP', 'Quando esta opção é ativada, as mensagens podem ser recebidas via fonte RSS. Os usuários verão a URL necessária em seus perfis.');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_3', '...define o padrão para RSS, iGoogle, ajuda, separador');
DEFINE ('_UDDEADM_DELETEM_DELETING', 'Deletando mensagens:');
DEFINE ('_UDDEADM_DELETEM_FROMUSER', 'Deletando mensagens do usuário ');
DEFINE ('_UDDEADM_DELETEM_MSGSSENT', '- mensagens enviadas: ');
DEFINE ('_UDDEADM_DELETEM_MSGSRECV', '- mensagens recebidas: ');
DEFINE ('_UDDEIM_PMNAV_THISISARESPONSE', 'Esta é uma resposta para:');
DEFINE ('_UDDEIM_PMNAV_THEREARERESPONSES', 'Respostas para este:');
DEFINE ('_UDDEIM_PMNAV_DELETED', 'Mensagem indisponível');
DEFINE ('_UDDEIM_PMNAV_EXISTS', 'pular para a mensagem');
DEFINE ('_UDDEIM_PMNAV_COPY2ME', '(Copiar)');
DEFINE ('_UDDEADM_PMNAV_HEAD', 'Permitir navegação');
DEFINE ('_UDDEADM_PMNAV_EXP', 'Exibe uma barra de navegação que permite a navegação através de um tópico.');
...
DEFINE ('_UDDEADM_MAINTENANCE_HEAD1', 'Enviando lembretes para (Lembrete: %s dias):');
DEFINE ('_UDDEADM_MAINTENANCE_HEAD2', 'Em %s dias enviar lembretes para:');
DEFINE ('_UDDEADM_MAINTENANCE_NO', 'Não:');
DEFINE ('_UDDEADM_MAINTENANCE_USERID', 'ID de Usuário:');
DEFINE ('_UDDEADM_MAINTENANCE_TONAME', 'Nome:');
DEFINE ('_UDDEADM_MAINTENANCE_MID', 'ID da Mensagem:');
DEFINE ('_UDDEADM_MAINTENANCE_WRITTEN', 'Escrito:');
DEFINE ('_UDDEADM_MAINTENANCE_TIMER', 'Cronômetro:');
...
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_OUTBOX', ' sua Caixa de Saída');
...
DEFINE ('_UDDEIM_ADDCCINFO', 'linha C/C:');
...
DEFINE ('_UDDEIM_COULDNOTRECALLPUBLIC', 'Respostas à usuários não registradros não podem ser recolhidas.');
...
DEFINE ('_UDDEADM_VERSIONCHECK_EXP', 'Isto contata o site do desenvolvedor para obter informações sobre a versão atual do uddeIM.');
...
DEFINE ('_UDDEADM_POPUP_EXP','Mostra um popup na chegada de uma nova mensagem (mod_uddeim é necessário)');
...
DEFINE ('_UDDEIM_RECALLEDMESSAGE_INFO', 'Esta mensagem foi recolhida. Agora você pode editá-la e reenviá-la.');
DEFINE ('_UDDEIM_COULDNOTRECALL', 'Esta mensagem não pode ser recolhida (provavelmente porque foi lida ou apagada.)');
...
DEFINE ('_UDDEIM_OUTBOX_WARNING', 'Sua Caixa de Saída contém todas as mensagens que você enviou. Você pode recolher uma mensagem que ainda não foi lida pelo destinatário. Uma vez recolhida, a mensagem não será lida pelo destinatário. ');
DEFINE ('_UDDEIM_RECALL', 'Recolher');
DEFINE ('_UDDEIM_RECALLTHISMESSAGE', 'Recolher esta mensagem');
...
DEFINE ('_UDDEIM_SENDCOPYTOME', 'cópia p/ mim');
	// as in 'send a "copy to me"' or cc: me

DEFINE ('_UDDEIM_SENDCOPYTOARCHIVE', 'copiar p/ arquivo');
DEFINE ('_UDDEIM_TRASHORIGINAL', 'original p/ lixeira');

DEFINE ('_UDDEIM_MESSAGEDOWNLOAD', 'Download da Mensagem');
DEFINE ('_UDDEIM_EXPORT_MAILED', 'E-mail com mensagens exportadas');
DEFINE ('_UDDEIM_EXPORT_NOW', 'e-mail de confirmação p/ mim');
	// as in "send the messages checked above by E-Mail to me"

DEFINE ('_UDDEIM_EXPORT_MAIL_INTRO', 'Este e-mail contém sua mensagem privada.');
...
DEFINE ('_UDDEADM_SHOWCONNEX_EXP', 'Use <i>sim</i> se você tem o CB/CBE/JS instalado e quer apresentar ao usuário os nomes das conexões dele durante a composição de uma nova mensagem.');
