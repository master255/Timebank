...
DEFINE ('_UDDEADM_CAPTCHATYPE_EXP', 'Welke captcha service wil je gebriuken: De ingebouwede service of reCaptcha (see <a href="http://recaptcha.net" target="_new">reCaptcha</a> Voor meer informatie)?');
