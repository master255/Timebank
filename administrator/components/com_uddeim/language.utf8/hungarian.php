...
DEFINE ('_UDDEADM_CAPTCHA_INTERNAL', 'Belső');
...
DEFINE ('_UDDEADM_CRYPT4', 'Erős védelmi kódolás');
DEFINE ('_UDDEADM_ALLOWTOALL2_HEAD', 'Rendszer üzenetek küldése');
DEFINE ('_UDDEADM_ALLOWTOALL2_EXP', 'uddeIM rendszer üzeneteket is tud küldeni. Ezek az üzenetek akár a weboldal összes felhasználójának is kiküldhetők. Ésszel használjuk...');
DEFINE ('_UDDEADM_ALLOWTOALL2_0', 'kikapcsolva');
DEFINE ('_UDDEADM_ALLOWTOALL2_1', 'csak adminoknak');
DEFINE ('_UDDEADM_ALLOWTOALL2_2', 'adminoknak és kezelőknek (managers)');
...
DEFINE ('_UDDEADM_MAXATTACHMENTS_EXP', 'Egy üzenetben elküldendő fájlok maximális száma.');
...
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_EXP', 'Az automatikus törlések jelentős szerverterhelést okozhatnak. Ha azt választjuk, hogy <b>csak az adminisztrátorok</b>, az automatikus törlés az adminisztrátor postaládájának ellenőrzésekor lesz végrehajtva. Abban az esetben válasszuk ezt az opciót, ha az adminisztrátor gyakran ellenőrzi a postaládáját. Ritka adminisztrátori jelenlét esetén válasszuk a <b>bármelyik felhasználó</b> lehetőséget.');
DEFINE ('_UDDEADM_FILEMAINTENANCE_PRUNE', 'Fájlok ritkítása');
DEFINE ('_UDDEADM_FILEMAINTENANCEDEL_HEAD', 'Fájlok törlése');
DEFINE ('_UDDEADM_FILEMAINTENANCEDEL_EXP', 'A törölt fájlok adatbázisból történő eltávolítása. Ez ugyanaz, mint a \'Fájlok ritkítása\' a rendszer fülön.');
...
DEFINE ('_UDDEADM_SHOWMENUCOUNT_EXP', ' <b>Igen</b> választása esetén a menüben megjelenik egy számláló. Fontos: Ez a művelet számos adatbázis lekérdezéssel jár, gyenge szerveren nem javasolt a használata!');
DEFINE ('_UDDEADM_CONFIG_FTPLAYER', 'Beállítás (elérés FTP-vel):');
DEFINE ('_UDDEADM_ENCODEHEADER_HEAD', 'Üzenet fejlécének kódolása');
DEFINE ('_UDDEADM_ENCODEHEADER_EXP', 'Állítsuk <b>igen</b>-re, ha az üzenetek fejléc-részénél (mint pl. a tárgy mező) rfc 2047 kódolást szeretnénk használni. Hasznos lehet, ha probléma merült fel a speciális karakterek megjelenítésével.');
DEFINE ('_UDDEIM_UP', 'növekvő rendezés');
DEFINE ('_UDDEIM_DOWN', 'csökkenő rendezés');
...
DEFINE ('_UDDEIM_NOMESSAGES2_FR_FILTERED', '<b>Ettől a felhasználótól nincsen üzenet a %s -ban.</b>');
DEFINE ('_UDDEIM_NOMESSAGES2_TO_FILTERED', '<b>Ennek a felhasználónak nincsen üzenet a %s -ban.</b>');
DEFINE ('_UDDEIM_NOMESSAGES2_UNFR_FILTERED', '<b>Ettől a felhasználótól nincsen új üzeneted a %s -ban.</b>');
...
DEFINE ('_UDDEADM_CBBANNED_EXP', 'Bekapcsolása eseténe az uddeIM letiltja a CB-ről bannolt felhasználókat. A többi felhasználó sem tud nekik üzenetet küldeni.');
...
DEFINE ('_UDDEADM_REPORTSPAM_EXP', 'Bekapcsolása esetén megjelenik egy \'Üzenet bejelentése\' link, amivel a SPAM-nak vélt üzenetek jelezhetők az adminisztrátornak.');
...
DEFINE ('_UDDEADM_SPAMCONTROL_FROM', 'Küldő');
...
DEFINE ('_UDDEADM_ADMIN_FILTER', 'Szűrő');
DEFINE ('_UDDEADM_ADMIN_DISPLAY', 'Megjelenítve #');
DEFINE ('_UDDEADM_TRASHORIGINALSENT_HEAD', 'Elküldött üzenet a kukába');
DEFINE ('_UDDEADM_TRASHORIGINALSENT_EXP', 'Használatakor a \'Küldés\' gomb mellett kiválaszthatjuk, hogy az üzenet elküldéskor törlődjön is.');
DEFINE ('_UDDEIM_TRASHORIGINALSENT', 'üzenet törlődjön');
...
DEFINE ('_UDDEADM_MAINTENANCEFIX_EXP', "Az uddeIM két XML fájlt használ, hogy telepíthető legyen Joomla 1.0 és 1.5x rendszerekre. Joomla 1.5 esetében az egyik XML fájl nem szükséges, sőt emiatt a telepítő kezelő kompatibilitási hibát is jelez. Eltávolíthatjuk ezt a fájlt, így a hiba megszűnik.");
DEFINE ('_UDDEADM_MAINTENANCE_FIX', "JAVÍTÁS");
DEFINE ('_UDDEADM_MAINTENANCE_XML1', "Joomla 1.0 és Joomla 1.5 uddeIM XML telepítőfájlok megvannak.<br />");
DEFINE ('_UDDEADM_MAINTENANCE_XML2', "Ez szükséges a Joomla 1.0 és Joomla 1.5 rendszerekre való telepítéshez.<br />");
DEFINE ('_UDDEADM_MAINTENANCE_XML3', "Mivel telepítés után már nincs rájuk szükség, a Joomla 1.0 XML fájl nyugodtan törölhető a Joomla 1.5 rendszeren.<br />");
DEFINE ('_UDDEADM_MAINTENANCE_XML4', "Az alábbit fogjuk elvégezni:<br />");
DEFINE ('_UDDEADM_MAINTENANCE_FXML1', "Felesleges XML telepítőfájl eltávolítása:<br />");
DEFINE ('_UDDEADM_MAINTENANCE_FXML2', "Nem található XML telepítőfájl!<br />");
DEFINE ('_UDDEADM_SHOWMENUICONS1_HEAD', 'Menü felület megjelenése');
DEFINE ('_UDDEADM_SHOWMENUICONS1_EXP', 'Itt adhatjuk meg, hogy a menü szüveges vagy ikonos megjelenésű legyen.');
...
DEFINE ('_UDDEADM_IMPORT_HELP', 'Fontos: Az üzeneteket egyszerre teljes egészében vagy részekre bontva is lehet importálni. Olyankor érdemes részletekre bontva importálni az üzenetket, ha egyébként az üzenetek nagy száma miatt az egyszerre történő importálás nem sikerül.');
...
DEFINE ('_UDDEADM_RESTRALLUSERS_EXP', 'Korlátozni lehet az "Összes felhasználó" listájának az elérését. Alaphelyzetben az "Összes felhasználó" listázása mindenkinek elérhető (<i>nincsen korlátozva</i>).');
...
DEFINE ('_UDDEIM_HELP_OUTBOX', 'A <b>Kimenő mappa</b> örzi azokat az üzeneteket, amiket elküldtünk.');
DEFINE ('_UDDEIM_HELP_TRASHCAN', 'A <b>Kuka</b> tárolja az összes törölt üzenetet. Az üzenetek ugyanis nem törlődnek azonnal véglegese, egy bizonyos ideig itt tárolódnak. Ameddig az üzenet a kukában van, bármikor visszaállítható.');
...
DEFINE ('_UDDEIM_HELP_USERLISTS', 'A <b>Címzett lista</b> lehetővé teszi, hogy a címzetteket listákban tároljuk. Ezeknek a listáknak a segítságável könnyen küldhetünk egyszerre több címzettnek üzenetet. Ahelyett, hogy egyenként kellene összeválogatnunk a címzetteket, kiválaszthatjuk az adott <i>#címzettlistánkat</i>.');
DEFINE ('_UDDEIM_HELP_SETTINGS', 'A <b>Beállítások</b>ban találjuk az összes felhasználói beállítási lehetőségeket.');
...
DEFINE ('_UDDEIM_HELP_ARCHIVEMSG', 'Az üzenet archíválása. Az archívált üzenetek nem törlődnek automatikusan, akkor sem ha be van állítva a postaládában lévő üzenetek tárolásának a határideje.');
DEFINE ('_UDDEIM_HELP_UNARCHIVEMSG', 'Archivált üzenet visszaállítása. Az üzenet visszakerül a postaládába.');
DEFINE ('_UDDEIM_HELP_RECALL', 'Üzenet visszahívása. Az elküldött üzenetek visszahívhatók, ha a címzett még nem olvasta őket.');
...
DEFINE ('_UDDEIM_HELP_MISC', 'Itt találunk néhágy beállítási lehetőséget');
...
DEFINE ('_UDDEADM_SEPARATOR_P0', 'vessző (alap)');
DEFINE ('_UDDEADM_SEPARATOR_P1', 'pontosvessző');
...
DEFINE ('_UDDEADM_MOOTOOLS_NONE11', 'a MooTools ne töltődjön be (1.1 van használatban)');
DEFINE ('_UDDEADM_MOOTOOLS_NONE12', 'a MooTools ne töltődjön be (1.2 van használatban)');
DEFINE ('_UDDEIM_RSS_INTRO1', 'A postaláda RSS csatornaként (0.91) is elérhető.');
DEFINE ('_UDDEIM_RSS_INTRO1B', 'Az elérés URL-je:');
DEFINE ('_UDDEIM_RSS_INTRO2', '!!! Ne adjuk át ezt az URL-t másoknak, mert a így postafiókunk mások által is elérhetővé válik!!!');
...
DEFINE ('_UDDEADM_ENABLERSS_EXP', 'Amennyiben ezt az opciót engedélyezzük, az üzeneteink RSS csatornaként is elérhetők lesznek a számunkra. A szükséges elérési URL a felhasználói adatlapon szerepel.');
...
DEFINE ('_UDDEIM_PMNAV_DELETED', 'Üzenet nem elérhető');
...
DEFINE ('_UDDEADM_MAINTENANCE_HEAD1', 'Emlékeztető küldése (Nefelejtsel: %s nap):');
DEFINE ('_UDDEADM_MAINTENANCE_HEAD2', '%s nap múlva emlékeztető küldése:');
...
DEFINE ('_UDDEADM_MAINTENANCE_TIMER', 'Időzítés:');
...
DEFINE ('_UDDEIM_FILTEREDMESSAGE', 'üzenet megszűrve');
DEFINE ('_UDDEIM_FILTEREDMESSAGES', 'üzenetek megszűrve');
DEFINE ('_UDDEIM_FILTER', 'Szűrő:');
DEFINE ('_UDDEIM_FILTER_TITLE_INBOX', 'Csak ettől a felhasználótól érkezetteket mutassa');
...
DEFINE ('_UDDEIM_FILTER_SUBMIT', 'Szűrő');
DEFINE ('_UDDEIM_FILTER_ALL', '- összes -');
DEFINE ('_UDDEIM_FILTER_PUBLIC', '- publikus felhasználók -');
DEFINE ('_UDDEADM_FILTER_HEAD', 'Szűrő engedélyezése');
DEFINE ('_UDDEADM_FILTER_EXP', 'Használata esetén a beérkezett és elküldött üzenetek listája felhaszálók szerint szürhető.');
...
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_FROM', ' ettől a felhasználótól');
...
DEFINE ('_UDDEIM_TODP_TITLE_CC', 'Egy vagy több címzett (vesszővel elválasztva)');
DEFINE ('_UDDEIM_ADDCCINFO_TITLE', 'Használatakor a sorban az üzenet összes címzettje megjelenik.');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_2', '...alapértelmezetté tétele az automatikus válaszolónak, automatikus továbbítónak, postaládának, szűrőnek');
...
DEFINE ('_UDDEIM_AUTORESPONDER_EXP', 'Az automatikus válaszoló az összes beérkező üzenetre választ küld.');
DEFINE ('_UDDEIM_AUTORESPONDER_DEFAULT', "Jelenleg sajnos nem vagyok elérhető.\nAmint tudok válaszolok az üzeneteimre.");
...
DEFINE ('_UDDEADM_AUTOFORWARD_EXP', 'Használatával a beérkező üzenetek egy másik felhasználó postaládájába továbbítódnak.');
...
DEFINE ('_UDDEADM_REVIEWUPDATE', 'Fontos: Ha az uddeIM-et egy korábbi verzióról frissítjük, feltétlenül olvassuk el a README fájlt! Előfordulhat ugyanis, hogy adatbázis táblákat vagy mezőket kell felvennünk vagy módosítanunk!');
...
"Hello %you%,\n\n%user% a következő privát üzenetet küldte a %site% szájtról.\n__________________\n%pmessage%");
...
DEFINE ('_UDDEADM_VERSIONCHECK_EXP', 'Felkapcsolódik az uddeIM fejlesztői weboldalára, a jelenlegi legfrissebb verzió ellenörzéséért.');
...
DEFINE ('_UDDEIM_MESSAGENOACCESS', 'ez az üzenet nem jeleníthető meg. <br />Lehetséges okok:<ul><li>Nincsen jogod elolvasni ezt az üzenetet</li><li>Az üzenetet törölték</li></ul>');
...
DEFINE ('_UDDEADM_EMAILWITHMESSAGE_EXP', 'Ha <i>nem</i>-re állítjuk, az email csak értesít minket új üzenet érkezéséről, de maga az üzenet nem fog szerepelni benne.');
