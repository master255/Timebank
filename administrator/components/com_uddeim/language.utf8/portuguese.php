...
DEFINE ('_UDDEADM_CAPTCHATYPE_EXP', 'Que serviço captcha deseja usar: O serviço interno ou o reCaptcha (ver <a href="http://recaptcha.net" target="_new">reCaptcha</a> para mais informação)?');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_6', '...definir o serviço padrão captcha');
DEFINE ('_UDDEADM_AUP', 'AlphaUserPoints');
DEFINE ('_UDDEADM_CHECKFILESFOLDER', 'Mover <i>\uddeimfiles</i> para <i>\images\uddeimfiles</i>. Ver documentação!');
...
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_EXP', 'Eliminações automáticas provocam sobrecarga do servidor. Se definir <b>apenas por administradores</b> as eliminações automáticas são solicitadas quando um administrador verificar a sua caixa de entrada. Escolha esta opção se um administrador verifica as suas mensagens regularmente. Sites pequenos ou raramente administrados podem escolher  <b>por qualquer utilizador</b>.');
...
DEFINE ('_UDDEADM_SHOWMENUCOUNT_EXP', 'Quando definido <b>sim</b>, a barra de menus contém contadores de mensagens. Note: Esta opção requere várias pesquisas adicionais na base de dados, por isso não a use em sistemas fracos.');
...
DEFINE ('_UDDEADM_ENCODEHEADER_EXP', 'Configurado <b>sim</b>, quando os cabeçalhos das mensagens (como o assunto) deve ser codificado em rfc 2047. Útil para resolver problemas com caracteres especiais.');
...
DEFINE ('_UDDEADM_ENABLESORT_EXP', 'Configurado <b>sim</b>, e o utilizador poderá ordenar as recebidas, enviadas e arquivo(origina carga adicional no servidor de base de dados).');
...
DEFINE ('_UDDEIM_NOMESSAGES2_FR_FILTERED', '<b>Não tem mensagens deste utilizador na sua%s.</b>');
DEFINE ('_UDDEIM_NOMESSAGES2_TO_FILTERED', '<b>Não tem mensagens para este utilizador na sua%s.</b>');
DEFINE ('_UDDEIM_NOMESSAGES2_UNFR_FILTERED', '<b>Não tem mensagens por ler deste utilizador na sua%s.</b>');
DEFINE ('_UDDEIM_NOMESSAGES2_UNTO_FILTERED', '<b>Não tem mensagens por ler para este utilizador na sua%s.</b>');
...
DEFINE ('_UDDEADM_MAINTENANCE_XML2', "É necessário para instalar pacotes em Joomla 1.0 e Joomla 1.5.<br />");
DEFINE ('_UDDEADM_MAINTENANCE_XML3', "Como não é necessário após a instalação ser concluída, o instalador Joomla 1,0 pode ser removido em sistemas Joomla 1.5.<br />");
DEFINE ('_UDDEADM_MAINTENANCE_XML4', "Terá efeito nos pacotes seguintes:<br />");
DEFINE ('_UDDEADM_MAINTENANCE_FXML1', "Os seguintes instaladores de XML, desnecessários para os seguintes pacotes uddeIM,  serão removidos:<br />");
DEFINE ('_UDDEADM_MAINTENANCE_FXML2', "Não foram encontrados instaladores desnecessários para os pacotes uddeIM!<br />");
...
DEFINE ('_UDDEADM_RESTRALLUSERS_EXP', 'Pode restringir o acesso a "Todos os utilizadores" da lista. Geralmente, a lista "Todos os utilizadores" está disponível para todos (<i>Sem restrição</i>).');
...
DEFINE ('_UDDEIM_HELP_INBOX', 'A <b>Recebidas</b> contém todas as mensagens recebidas.');
DEFINE ('_UDDEIM_HELP_OUTBOX', 'A <b>Enviadas</b> mantém uma cópia de cada mensagem que enviaste. Pode voltar a ela em qualquer momento e ver o que enviou.');
DEFINE ('_UDDEIM_HELP_TRASHCAN', 'O <b>Lixo</b> mantém todas as mensagens apagadas. As mensagens não são imediatamente apagadas e são mantidas durante um certo período de tempo. Enquanto a mensagem é armazenada no lixo, pode ser restaurada.');
DEFINE ('_UDDEIM_HELP_ARCHIVE', 'O <b>Arquivo</b> mantém todas as mensagens arquivadas a partir das recebidas. Apenas mensagens recebidas podem ser arquivadas. Quando for necessário arquivar uma mensagem enviada, verifique se seleccionou <i>cópia para mim </i> antes de enviar.');
DEFINE ('_UDDEIM_HELP_USERLISTS', '<b>Contactos</b> permite manter listas de contactos (também conhecidas como listas de distribuição). Estas listas permitem enviar PMs para vários destinatários. Em vez de adicionar vários destinatários, pode simplesmente carregar <i>#momedalista</i>.');
DEFINE ('_UDDEIM_HELP_SETTINGS', '<b>Definições</b> inclui todas as opções configuráveis pelo utilizador..');
DEFINE ('_UDDEIM_HELP_COMPOSE', '<b>Escrever</b> permite criar uma nova mensagem privada.');
...
DEFINE ('_UDDEIM_HELP_UNFLAGGED', 'Mensagem <i>Normal</i> (pode modificar-se o estado).');
...
DEFINE ('_UDDEADM_SHOWIGOOGLE_EXP', 'Quando activado um botão <i>Adicionar ao iGoogle</ i> para o gadget iGoogle é exibido nas preferências do utilizador.');
...
DEFINE ('_UDDEADM_EMN_SENDERMAIL_WARNING', '<br /><b>Note:<br />Ao utilizar mosMail, deve configurar um endereço de email válido! Para</b>');
...
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED', '<b>Não tem%s mensagens%s na sua%s.</b>');	// see next  six lines
...
DEFINE ('_UDDEADM_MOOTOOLS_EXP', 'Especifica como uddeIM carrega as  MooTools (MooTools é necessário para Autocompletar): <i>Nenhuma</i> é útil quando o teu modelo carrega MooTools, <i>Auto</i> é o padrão recomendado, quando usando J1.0 também pode forçar-se o carregamento das MooTools 1.1 ou 1.2.');
...
DEFINE ('_UDDEADM_THUMBLISTS_EXP', 'Definir para <i>sim</i> para exibir miniaturas de utilizador na vista de lista de mensagem (recebidas, enviadas, etc');
...
DEFINE ('_UDDEADM_NOTRASHACCESS_EXP', 'Pode restringir o acesso ao lixo. Normalmente o lixo está disponível para todos (<i>nenhuma restrição</i>). Pode restringir-se o acesso a utilizadores especiais ou apenas a administradores, para os grupos com menor acesso direitos não poderem reciclar uma mensagem.');
...
DEFINE ('_UDDEADM_LANGUAGECHARSET_EXP', 'Normalmente <b>padrão</b> (ISO-8859-1) é a definição correta para Joomla 1.0 e <b>UTF-8</b> para Joomla 1.5.');
...
DEFINE ('_UDDEADM_DELETEREADAFTERNOTE_EXP', 'Mostrar o aviso <i>"As mensagens lidas serão eliminadas após n dias"</i> nas recebidas');
DEFINE ('_UDDEADM_DELETEUNREADAFTERNOTE_HEAD', 'Mostrar aviso nas recebidas para mensagens por ler');
DEFINE ('_UDDEADM_DELETEUNREADAFTERNOTE_EXP', 'Mostrar o aviso <i>"As mensagens por ler serão apagadas após n dias"</i> nas recebidas');
DEFINE ('_UDDEADM_DELETESENTAFTERNOTE_HEAD', 'Mostrar aviso para as mensagens enviadas ');
DEFINE ('_UDDEADM_DELETESENTAFTERNOTE_EXP', 'Mostrar o aviso <i>"As mensagens enviadas serão apagadas após n dias"</i> nas enviadas');
DEFINE ('_UDDEADM_DELETETRASHAFTERNOTE_HEAD', 'Mostrar aviso para mensagens no lixo');
DEFINE ('_UDDEADM_DELETETRASHAFTERNOTE_EXP', 'Mostrar aviso <i>"Mensagens apagadas serão removidas após n dias" no lixo</i>');
DEFINE ('_UDDEADM_DELETESENTAFTER_HEAD', 'Mensagens enviadas continuarão por');
DEFINE ('_UDDEADM_DELETESENTAFTER_EXP', 'Digite o número de dias até que as mensagens <b>enviadas</b> serão automaticamente eliminadas.');
DEFINE ('_UDDEIM_SEND_TOALLSPECIAL', 'enviar para todos os utilizadores especiais ');
DEFINE ('_UDDEIM_SYSGM_WILLSENDTOALLSPECIAL', 'Mensagem para <b>todos utilizadores especiais</b>');
...
DEFINE ('_UDDEADM_SHOWACTIONICONS_EXP', 'Quando definido para <b>sim</b>, serão exibidas ligações com um ícone de acção. '); 
...
DEFINE ('_UDDEADM_SHOWBOTTOMICONS_EXP', 'Quando definido <b>sim</b>, serão exibidas ligações em baixo com um ícone. '); 
...
DEFINE ('_UDDEADM_MAINTENANCE_EXP', "Quando um utilizador da base de dados é eliminado, as uas mensagens normalmente são mantidas na base de dados. Esta função verifica se é necessário enviar para o lixo mensagens órfãs. <br />Também verifica se a base de dados tem alguns erros que serão corrigidos."); 
DEFINE ('_UDDEADM_MAINTENANCE_MC1', "Verificando ... <br /> "); 
DEFINE ('_UDDEADM_MAINTENANCE_MC2', "<i>#nnn (Username): [recebidas|recebidas lixo|enviadas|enviadas lixo]</i><br />"); 
DEFINE ('_UDDEADM_MAINTENANCE_MC3', "<i>recebidas: mensagens armazenadas nas recebidas</i><br />"); 
DEFINE ('_UDDEADM_MAINTENANCE_MC4', "<i>recebidas lixo: mensagens recebidas pelos utilizadores no lixo, mas ainda nas enviadas de alguém </ i> <br />"); 
DEFINE ('_UDDEADM_MAINTENANCE_MC5', "<i>enviadas: mensagens armazenadas nas enviadas dos utilizadores </i><br />"); 
DEFINE ('_UDDEADM_MAINTENANCE_MC6', "<i>enviadas lixo: mensagens enviadas pelos utilizadores, mas ainda nas enviadas de alguém</i><br />"); 
DEFINE ('_UDDEADM_MAINTENANCE_MT1', "Enviando para o lixo...<br />"); 
...
DEFINE ('_UDDEADM_MAINTENANCE_NOTHINGTODO', '<b>Nada a fazer</b><br />'); 
DEFINE ('_UDDEADM_MAINTENANCE_JOBTODO', '<b>Manutenção necessária</b><br />');
...
DEFINE ('_UDDEIM_MESSAGENOACCESS', 'Esta mensagem não pode ser exibida. <br />Possíveis razões:<ul><li>Não tem permissão para ler esta mensagem. </li><li>A mensagem foi eliminada.</li></ul>'); 
DEFINE ('_UDDEIM_YOUMOVEDTOTRASH', '<b>Mensagem movida para o lixo.</b>'); 
...
DEFINE ('_UDDEIM_VIOLATION', '<b>Violação de acesso! </b> Não tem permissão para executar esta acção!');
...
DEFINE ('_UDDEADM_DELETEREADAFTER_EXP', 'Digite o número de dias até que as mensagens <b>lidas</b> sejam eliminadas automaticamente a partir das enviadas. Se não quiser apagar as mensagens automaticamente, digite um valor muito elevado (por exemplo, 36524 dias são equivalentes a um século). Mas lembre-se que a base de dados pode encher-se rapidamente se guardar todas as mensagens.'); 
DEFINE ('_UDDEADM_DELETEUNREADAFTER_EXP', 'Digite o número de dias até que as mensagens <b>não lidas pelo seu destinatário</b> sejam eliminadas.'); 
...
DEFINE ('_UDDEADM_ADMINIGNITIONONLY_EXP', 'Supressões automaticas provocam uma sobrecarga do servidor. Se optar  <b>por administradores apenas</b> as supressões automáticas são solicitadas quando um administrador verifica as suas recebidas. Escolha esta opção se um administrador pode verificar regularmente as recebidas. Em sites pouco ou raramente administrados, escolha <b>por qualquer utilizador</b>.'); 
...
DEFINE ('_UDDEADM_ALREADYIMPORTED', '<span style="color: red;">Já importaste as mensagens do antigo SPM para uddeIM.</Span>'); 
...
DEFINE ('_UDDEADM_BLOCKALERT_EXP', 'Se estiver definido <b>sim</b>, um utilizador bloqueado irá ser informado de que a mensagem não foi enviada porque o destinatário o bloqueou. Se definir <b>não</b>, o utilizador bloqueado não recebe qualquer notificação de que a mensagem não foi enviada.'); 
...
DEFINE ('_UDDEADM_SHOWCBLINK_EXP', 'Quando definido <b>sim</b>, todos os nomes de utilizadores que aparecem no uddeIM serão exibidos como ligações para os seus perfis no CB.'); 
DEFINE ('_UDDEADM_SHOWCBPIC_HEAD', 'Mostrar miniaturas CB'); 
DEFINE ('_UDDEADM_SHOWCBPIC_EXP', 'Quando definido para <b>sim</b>, a miniatura do utilizador armazenada no CB será exibida quando ler uma mensagem.'); 
DEFINE ('_UDDEADM_SHOWONLINE_HEAD', 'Mostrar o estado online'); 
DEFINE ('_UDDEADM_SHOWONLINE_EXP', 'Quando definido  <b>sim</b>, uddeIM exibe cada nome de utilizador com um pequeno ícone que informa se este utilizador está online ou offline.'); 
DEFINE ('_UDDEADM_ALLOWEMAILNOTIFY_HEAD', 'Permitir e-mail de notificação'); 
DEFINE ('_UDDEADM_ALLOWEMAILNOTIFY_EXP', 'Quando definido <b>sim</b>, os utilizadores podem escolher se querem receber um e-mail de cada vez que uma nova mensagem chega às recebidas.'); 
DEFINE ('_UDDEADM_EMAILWITHMESSAGE_HEAD', 'E-mail contém mensagem'); 
DEFINE ('_UDDEADM_EMAILWITHMESSAGE_EXP', 'Quando definido para <b>não</b>, este e-mail irá conter apenas informações sobre quando e por quem a mensagem foi enviada, mas não a própria mensagem.'); 
...
DEFINE ('_UDDEADM_LONGWAITINGDAYS_EXP', 'Se o recurso do lembrete (acima) é configurado <b>sim</b>, defina aqui após quantos dias o e-mail de notificação sobre mensagens não lidas será enviado.'); 
...
DEFINE ('_UDDEADM_SYSM_USERNAME_EXP', 'uddeIM suporta mensagens do sistema. Estas não têm remetente e os utilizadores não podem responder-lhes. Insira aqui o nome de utilizador padrão para o sistema de mensagens (por exemplo <b>Suporte</b> ou <b>Ajuda</b> ou <b>Líder da comunidade</b>).'); 
...
DEFINE ('_UDDEADM_EMN_SENDERNAME_EXP', 'Digite o remetente do qual são enviadas as notificações (por exemplo <b>nome do site</b> ou <b>Serviço de Mensagens</b>)'); 
...
DEFINE ('_UDDEIM_SYSGM_WILLSENDTOALL', 'Mensagem para <b>todos os utilizadores</b>'); 
DEFINE ('_UDDEIM_SYSGM_WILLSENDTOALLADMINS', 'Mensagem para <b>todos os administradores</b>'); 
DEFINE ('_UDDEIM_SYSGM_WILLSENDTOALLLOGGED', 'Mensagem para <b>todos os utilizadores online no momento</b>'); 
DEFINE ('_UDDEIM_SYSGM_WILLDISABLEREPLY', 'Os destinatários não poderão responder a esta mensagem.'); 
DEFINE ('_UDDEIM_SYSGM_WILLSENDAS_1', 'A mensagem será enviada com <b>'); 
DEFINE ('_UDDEIM_SYSGM_WILLSENDAS_2', '</b> como nome de utilizador'); 
...
DEFINE ('_UDDEIM_SYSGM_CHECKLINK', '<b>Verificar a ligação (clicando nela) antes de prosseguir!</b>'); 
DEFINE ('_UDDEIM_SYSGM_SHORTHELP', 'Uso de <b>apenas em mensagens de sistema</b>:<br /> [b]<b>negrito </b>[/b] [i]<em>itálico</em>[/i]<br />[url=http://www.squalquerurl.com]qualquer url[/url] ou [url]http://www.qualquerurl.com[/url] são ligações'); 
...
DEFINE ('_UDDEIM_ARC_SAVED_NONE', '<b>Ainda não tem qualquer mensagem no arquivo.</b>'); 
DEFINE ('_UDDEIM_ARC_SAVED_NONE_2', '<b>Não tem mensagens no arquivo.</b>'); 
...
DEFINE ('_UDDEADM_SHOWCONNEX_EXP', 'Use <b>sim</b> se tem o CB/CBE/JS instalado e pretende visualizar as ligações do utilizador na página de composição de nova mensagem.');
...
DEFINE ('_UDDEADM_ALLOWBB_EXP', 'Use <b>Apenas formatos de letra</b> para permitir o uso de etiquetas BB para negrito, itálico, sublinhado, côr e tamanho da letra. Quando definida para <b>sim</b>, os utilizadores podem usar <b>todas</b> as etiquetas BB suportada (e.g. ligações e imagens).');
DEFINE ('_UDDEADM_ALLOWSMILE_HEAD', 'Permitir Emoticons');
DEFINE ('_UDDEADM_ALLOWSMILE_EXP', 'Quando definido <b>sim</b>, os códigos de emoticon como :-) são subsituídos pela imagem de emoticon na exibição da mensagem.');
DEFINE ('_UDDEADM_DISPLAY', 'Mostrar');
DEFINE ('_UDDEADM_SHOWMENUICONS_HEAD', 'Mostrar ícones no menu');
DEFINE ('_UDDEADM_SHOWMENUICONS_EXP', 'Quando definido <b>sim</b>, as ligações do menu serão exibidas usando ícones.');
...
DEFINE ('_UDDEADM_SHOWABOUT_EXP', 'Definir <b>sim</b> para mostrar uma ligação para os créditos e licença do software uddeIM. Esta ligação será colocada ao fundo do output uddeIM.');
...
DEFINE ('_UDDEADM_GETPICLINK_EXP', 'Defina <b>sim</b> se desejar exibir miniaturas CB nas listas de mensagens (recebidas, enviadas, etc.)');
...
DEFINE ('_UDDEIM_BLOCKSYSTEM_EXP', 'Pode impedir utilizadores de lhe enviarem mensagens, bloqueando-os. Escolha <b>Bloquear utilizador</b> quando estiver a ler uma mensagem do respectivo utilizador.'); // block user is the same as _UDDEIM_BLOCKNOW
