...
// (v.2.2/2.3/2.4)  by Alex Khoroshevsky, at www.aleksius.com. 30 September 2011.
// *******************************************************************
DEFINE ('_UDDEADM_TRANSLATORS_CREDITS', 'Перевели: Dmitriy Kindeev, Eugene Sivokon, Alexander Smirnov и Alex Khoroshevsky. Большинство новых исправлений и правок для обеспечения взаимодействия uddeIM и Community Builder внёс Community Builder');	// Empty for English and German language files, enter your credits line here, e.g. 'Translation by <a href="http://domain.com" target="_new">John Doe</a>'
