...
DEFINE ('_UDDEADM_RECAPTCHAPRV_EXP', 'Ако желите да користите reCaptcha, унесите свој приватни кључ овде.');
DEFINE ('_UDDEADM_RECAPTCHAPUB_HEAD', 'reCaptcha јавни кључ');
DEFINE ('_UDDEADM_RECAPTCHAPUB_EXP', 'Ако желите да користите reCaptcha, унесите свој јавни кључ овде.');
DEFINE ('_UDDEADM_CAPTCHA_INTERNAL', 'Уграђен');
DEFINE ('_UDDEADM_CAPTCHA_RECAPTCHA', 'reCaptcha');
DEFINE ('_UDDEADM_CAPTCHATYPE_HEAD', 'Captcha сервис');
DEFINE ('_UDDEADM_CAPTCHATYPE_EXP', 'Који captcha сервис желите да користите: Уграђени сервис или reCaptcha (погледајте <a href="http://recaptcha.net" target="_new">reCaptcha</a> за више информација)?');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_6', '...постављено подразумевано за captcha сервис');
DEFINE ('_UDDEADM_AUP', 'AlphaUserPoints');
DEFINE ('_UDDEADM_CHECKFILESFOLDER', 'Преместите <i>\uddeimfiles</i> у <i>\images\uddeimfiles</i>. Проверите документацију!');
DEFINE ('_UDDEADM_CRYPT4', 'Јако шифровање');
DEFINE ('_UDDEADM_ALLOWTOALL2_HEAD', 'Дозволи слање системских порука');
DEFINE ('_UDDEADM_ALLOWTOALL2_EXP', 'uddeIM подржава системске поруке. Оне се шаљу свим корисницима на систему. Користите их умерено.');
DEFINE ('_UDDEADM_ALLOWTOALL2_0', 'искључено');
DEFINE ('_UDDEADM_ALLOWTOALL2_1', 'само администратори');
DEFINE ('_UDDEADM_ALLOWTOALL2_2', 'администратори и управници');

// New: 1.9
DEFINE ('_UDDEIM_FILEUPLOAD_FAILED', 'слање датотеке није успело');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_5', '...постављено подразумевано за приложене датотеке');
DEFINE ('_UDDEADM_ENABLEATTACHMENT_HEAD', 'Укључи приложене датотеке');
DEFINE ('_UDDEADM_ENABLEATTACHMENT_EXP', 'Ово омогућава слање датотека као прилога свим регистрованим корисницима или само администраторима.');
...
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_HEAD', 'Брисање датотека покреће');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_YES', 'само администратор');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_NO', 'било који корисник');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_MANUALLY', 'се ручно');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_EXP', 'Аутоматско брисање ствара велико оптерећење сервера. Ако изаберете <b>само администратор</b>, аутоматско брисање се покреће када администратор проверава своје пријемно сандуче. Изаберите ову опцију ако администратор редовно проверава своје пријемно сандуче. Мали сајтови или они који се ретко администрирају могу да изаберу <b>било који корисник</b>.');
DEFINE ('_UDDEADM_FILEMAINTENANCE_PRUNE', 'Прочисти датотеке сада');
DEFINE ('_UDDEADM_FILEMAINTENANCEDEL_HEAD', 'Покрени брисање датотека');
DEFINE ('_UDDEADM_FILEMAINTENANCEDEL_EXP', 'Уклања обрисане датотеке из базе података. Ово је исто што и „Прочисти датотеке сада“ на системском језичку.');
DEFINE ('_UDDEADM_FILEMAINTENANCEDEL_ERASE', 'ОБРИШИ');
DEFINE ('_UDDEIM_ATTACHMENTS', 'Прилози (макс. %u бајтова по датотеци):');
DEFINE ('_UDDEADM_MAINTENANCE_F1', 'Напуштени прилози ускладиштени у систему датотека: ');
DEFINE ('_UDDEADM_MAINTENANCE_F2', 'Бришем напуштене датотеке');
DEFINE ('_UDDEADM_BACKUP_DONE', 'Копирање подешавања је завршено.');
DEFINE ('_UDDEADM_RESTORE_DONE', 'Враћање подешавања је завршено.');
DEFINE ('_UDDEADM_PRUNE_DONE', 'Чишћење порука је завршено.');
DEFINE ('_UDDEADM_FILEPRUNE_DONE', 'Чишћење приложених датотека је завршено.');
DEFINE ('_UDDEADM_FOLDERCREATE_ERROR', 'Грешка при прављењу фасцикле: ');
DEFINE ('_UDDEADM_ATTINSTALL_WRITEFAILED', 'Грешка при прављењу датотеке: ');
DEFINE ('_UDDEADM_ATTINSTALL_IGNORE', 'Можете занемарити ову грешку ако не поседујете првокласни додатак за приложене датотеке (видите ЧПП).');
DEFINE ('_UDDEADM_ATTACHMENTGROUPS_HEAD', 'Дозвољене групе');
DEFINE ('_UDDEADM_ATTACHMENTGROUPS_EXP', 'Групе којима је дозвољено да шаљу приложене датотеке.');
DEFINE ('_UDDEIM_SELECT', 'Изабери');
DEFINE ('_UDDEIM_ATTACHMENT', 'Прилог');
DEFINE ('_UDDEADM_SHOWLISTATTACHMENT_HEAD', 'Прикажи иконе прилога');
DEFINE ('_UDDEADM_SHOWLISTATTACHMENT_EXP', 'Приказује иконе прилога у списковима порука (пријемно сандуче, отпремно сандуче, архива).');
DEFINE ('_UDDEIM_HELP_ATTACHMENT', 'Порука садржи приложену датотеку.');
DEFINE ('_UDDEADM_MAINTENANCE_COUNTFILES', 'Референце датотека у бази података:');
DEFINE ('_UDDEADM_MAINTENANCE_COUNTFILESDISTINCT', 'Ускладиштене приложене датотеке:');
DEFINE ('_UDDEADM_SHOWMENUCOUNT_HEAD', 'Прикажи бројаче');
DEFINE ('_UDDEADM_SHOWMENUCOUNT_EXP', 'Када је постављено на <b>да</b>, трака менија садржи бројаче порука. Напомена: Ово ће захтевати неколико додатних упита над базом података тако да немојте користити на слабијим системима.');
DEFINE ('_UDDEADM_CONFIG_FTPLAYER', 'Подешавање (приступ преко FTP слоја):');
DEFINE ('_UDDEADM_ENCODEHEADER_HEAD', 'Кодирај заглавља порука');
DEFINE ('_UDDEADM_ENCODEHEADER_EXP', 'Поставите на <b>да</b> када заглавља порука (као тема) треба да буду rfc 2047 кодирана. Корисно када имате проблеме са специјалним знацима.');
DEFINE ('_UDDEIM_UP', 'растући поредак');
DEFINE ('_UDDEIM_DOWN', 'опадајући поредак');
DEFINE ('_UDDEIM_UPDOWN', 'поређај');
DEFINE ('_UDDEADM_ENABLESORT_HEAD', 'Укључи ређање');
DEFINE ('_UDDEADM_ENABLESORT_EXP', 'Поставите на <b>да</b> када кориснику треба омогућити да поређа пријемно сандуче, отпремно сандуче и архиву (ствара додатно оптерећење сервера базе података).');
...
DEFINE ('_UDDEIM_NOMESSAGES2_FR_FILTERED', '<b>Немате порука од овог корисника у%s.</b>');
DEFINE ('_UDDEIM_NOMESSAGES2_TO_FILTERED', '<b>Немате порука за овог корисника у%s.</b>');
DEFINE ('_UDDEIM_NOMESSAGES2_UNFR_FILTERED', '<b>Немате непрочитаних порука од овог корисника у%s.</b>');
DEFINE ('_UDDEIM_NOMESSAGES2_UNTO_FILTERED', '<b>Немате непрочитаних порука за овог корисника у%s.</b>');

// New: 1.7
DEFINE ('_UDDEADM_EMAILSTOPPED', '„Заустављање е-поште“ је укључено.');
DEFINE ('_UDDEIM_ACCOUNTLOCKED', 'Приступ вашем поштанском сандучету је закључан. Обратите се администратору сајта.');
DEFINE ('_UDDEADM_USERSET_LOCKED', 'Закључано');
DEFINE ('_UDDEADM_USERSET_SELLOCKED', '- Закључано -');
DEFINE ('_UDDEADM_CBBANNED_HEAD', 'Провери за забрањене CB кориснике');
DEFINE ('_UDDEADM_CBBANNED_EXP', 'Када је активирано, uddeIM проверава да ли је корисник забрањен у CB-у и не дозвољава му приступ uddeIM-у. Други корисници такође неће моћи да шаљу поруке забрањеном кориснику.');
DEFINE ('_UDDEIM_YOUAREBANNED', 'Ви сте забрањени. Обратите се администратору или модератору.');
DEFINE ('_UDDEIM_USERBANNED', 'Корисник је забрањен');
DEFINE ('_UDDEADM_JOOBB', 'Joo!BB');
DEFINE ('_UDDEPLUGIN_SEARCHSECTION', 'Приватне поруке');
DEFINE ('_UDDEPLUGIN_MESSAGES', 'Приватне поруке');
DEFINE ('_UDDEADM_MAINTENANCEDEL_HEAD', 'Активирај брисање порука');
// note "This  is the same as _UDDEADM_MAINTENANCE_PRUNE on the system tab."
DEFINE ('_UDDEADM_MAINTENANCEDEL_EXP', 'Уклања обрисане поруке из базе података. Ово је исто што и „Прочисти поруке сада“ на системском језичку.');
DEFINE ('_UDDEADM_MAINTENANCEDEL_ERASE', 'ОБРИШИ');
DEFINE ('_UDDEADM_REPORTSPAM_HEAD', 'Линк за пријаву поруке');
...
DEFINE ('_UDDEADM_SPAMCONTROL_NOTEDEL', 'Обрисати ову поруку из базе података?');
DEFINE ('_UDDEADM_SPAMCONTROL_NOTEREMOVE', 'Уклонити ову пријаву?');
DEFINE ('_UDDEADM_SPAMCONTROL_SHOWHIDE', 'Прикажи/сакриј');
DEFINE ('_UDDEADM_SPAMCONTROL_EDIT', 'Контролни центар пријављивања');
DEFINE ('_UDDEADM_SPAMCONTROL_FROM', 'Од');
DEFINE ('_UDDEADM_SPAMCONTROL_TO', 'За');
DEFINE ('_UDDEADM_SPAMCONTROL_TEXT', 'Порука');
DEFINE ('_UDDEADM_SPAMCONTROL_DELETE', 'Обриши');
DEFINE ('_UDDEADM_SPAMCONTROL_REMOVE', 'Уклони');
DEFINE ('_UDDEADM_SPAMCONTROL_DATE', 'Датум');
DEFINE ('_UDDEADM_SPAMCONTROL_REPORTED', 'Пријављена');
DEFINE ('_UDDEIM_SPAMCONTROL_REPORT', 'Пријавите поруку');
DEFINE ('_UDDEIM_SPAMCONTROL_MARKED', 'Порука је пријављена');
DEFINE ('_UDDEIM_SPAMCONTROL_UNREPORT', 'Опозови ову пријаву');
DEFINE ('_UDDEADM_JOMSOCIAL', 'JomSocial');
DEFINE ('_UDDEADM_KUNENA', 'Kunena');
DEFINE ('_UDDEADM_ADMIN_FILTER', 'Филтер');
DEFINE ('_UDDEADM_ADMIN_DISPLAY', 'Приказ #');
DEFINE ('_UDDEADM_TRASHORIGINALSENT_HEAD', 'Бацање послате поруке');
DEFINE ('_UDDEADM_TRASHORIGINALSENT_EXP', 'Када је ово активирано, поред дугмета „Пошаљи“ ће се појавити кућица са ознаком „баци поруку“ која није подразумевано штиклирана. Корисници могу да штиклирају кућицу ако желе да баце поруку одмах након њеног слања.');
DEFINE ('_UDDEIM_TRASHORIGINALSENT', 'баци поруку');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_4', '...постављено подразумевано за брисање послате поруке, спам пријаву, забрањене CB кориснике');
DEFINE ('_UDDEADM_VERSIONCHECK_IMPORTANT', 'Важни линкови:');
DEFINE ('_UDDEADM_VERSIONCHECK_HOTFIX', 'Важна исправка');
DEFINE ('_UDDEADM_VERSIONCHECK_NONE', 'Нема');
DEFINE ('_UDDEADM_MAINTENANCEFIX_HEAD', "Одржавање усаглашености");
DEFINE ('_UDDEADM_MAINTENANCEFIX_EXP', "uddeIM користи две XML датотеке како би осигурао да пакети могу бити инсталирани на Joomla 1.0 и 1.5. На Joomla 1.5 једна XML датотека није неопходна па ово узрокује да менаџер проширењима приказује упозорење о неусаглашености (што је погрешно). Ово уклања непотребне датотеке, тако да се упозорење више не приказује.");
DEFINE ('_UDDEADM_MAINTENANCE_FIX', "ИСПРАВКА");
DEFINE ('_UDDEADM_MAINTENANCE_XML1', "Постоје Joomla 1.0 и Joomla 1.5 XML инсталатери за uddeIM пакете.<br />");
DEFINE ('_UDDEADM_MAINTENANCE_XML2', "Ово је неопходно због инсталације пакета и на Joomla 1.0 и на Joomla 1.5.<br />");
DEFINE ('_UDDEADM_MAINTENANCE_XML3', "Пошто није неопходан након завршетка инсталације, Joomla 1.0 инсталатер се може уклонити са Joomla 1.5 система.<br />");
DEFINE ('_UDDEADM_MAINTENANCE_XML4', "Ово ће бити извршено за следеће пакете:<br />");
DEFINE ('_UDDEADM_MAINTENANCE_FXML1', "Непотребни XML инсталатери за следеће uddeIM пакете ће бити уклоњени:<br />");
DEFINE ('_UDDEADM_MAINTENANCE_FXML2', "Непотребни XML инсталатери за uddeIM пакете нису пронађени!<br />");
DEFINE ('_UDDEADM_SHOWMENUICONS1_HEAD', 'Изглед траке менија');
DEFINE ('_UDDEADM_SHOWMENUICONS1_EXP', 'Овде можете подесити да ли се трака менија приказује са иконама и/или текстом.');
DEFINE ('_UDDEIM_MENUICONS_P1', 'Иконе и текст');
DEFINE ('_UDDEIM_MENUICONS_P2', 'Само иконе');
...
// New: 1.6
DEFINE ('_UDDEIM_NOLISTSELECTED', 'Није изабран списак корисника!');
DEFINE ('_UDDEADM_NOPREMIUM', 'Првокласни додатак није инсталиран');
DEFINE ('_UDDEIM_LISTGLOBAL_CREATOR', 'Творац:');
DEFINE ('_UDDEIM_LISTGLOBAL_ENTRIES', 'Ставке');
DEFINE ('_UDDEIM_LISTGLOBAL_TYPE', 'Врста');
DEFINE ('_UDDEIM_LISTGLOBAL_NORMAL', 'Обичан');
DEFINE ('_UDDEIM_LISTGLOBAL_GLOBAL', 'Глобални');
DEFINE ('_UDDEIM_LISTGLOBAL_RESTRICTED', 'Ограничен');
DEFINE ('_UDDEIM_LISTGLOBAL_P0', 'Обичан списак контаката');
DEFINE ('_UDDEIM_LISTGLOBAL_P1', 'Глобални списак контаката');
DEFINE ('_UDDEIM_LISTGLOBAL_P2', 'Ограничен списак контаката (само чланови списка могу приступити списку)');
DEFINE ('_UDDEIM_TOOLBAR_USERSETTINGS', 'Корисничке поставке');
DEFINE ('_UDDEIM_TOOLBAR_REMOVESETTINGS', 'Уклони поставке');
DEFINE ('_UDDEIM_TOOLBAR_CREATESETTINGS', 'Направи поставке');
DEFINE ('_UDDEIM_TOOLBAR_SAVE', 'Сачувај');
DEFINE ('_UDDEIM_TOOLBAR_BACK', 'Назад');
DEFINE ('_UDDEIM_TOOLBAR_TRASHMSGS', 'Баци поруке у смеће');
DEFINE ('_UDDEIM_CBPLUG_CONT', '[настави]');
DEFINE ('_UDDEIM_CBPLUG_UNBLOCKNOW', '[деблокирај]');
DEFINE ('_UDDEIM_CBPLUG_DOBLOCK', 'Блокирај корисника');
DEFINE ('_UDDEIM_CBPLUG_DOUNBLOCK', 'Деблокирај корисника');
DEFINE ('_UDDEIM_CBPLUG_BLOCKINGCFG', 'Блокирање');
DEFINE ('_UDDEIM_CBPLUG_BLOCKED', 'Блокирали сте овог корисника.');
DEFINE ('_UDDEIM_CBPLUG_UNBLOCKED', 'Овај корисник вас може контактирати.');
DEFINE ('_UDDEIM_CBPLUG_NOWBLOCKED', 'Овај корисник је сада блокиран.');
DEFINE ('_UDDEIM_CBPLUG_NOWUNBLOCKED', 'Овај корисник више није блокиран.');
DEFINE ('_UDDEADM_PARTIALIMPORTDONE', 'Делимичан увоз порука из старог PMS-а је завршен. Немојте увозити овај део поново јер ће тиме поруке бити поново увезене и појавиће се двапут.');
DEFINE ('_UDDEADM_IMPORT_HELP', 'Напомена: Поруке ће бе бити увезене све одједном или у деловима. Увоз у деловима може бити неопходан када се увоз прекине због превеликог броја порука за увоз.');
DEFINE ('_UDDEADM_IMPORT_PARTIAL', 'Делимични увоз:');
DEFINE ('_UDDEADM_UPDATEYOURDB', 'Важно: Нисте ажурирали базу података! Погледајте README како бисте исправно ажурирали uddeIM!');
DEFINE ('_UDDEADM_RESTRALLUSERS_HEAD', 'Ограничи приступ за списак „Сви корисници“');
DEFINE ('_UDDEADM_RESTRALLUSERS_EXP', 'Можете ограничити приступ списку „Сви корисници“. Обично је списак „Сви корисници“ доступан за све (<i>без ограничења</i>).');
DEFINE ('_UDDEADM_RESTRALLUSERS_0', 'без ограничења');
DEFINE ('_UDDEADM_RESTRALLUSERS_1', 'посебни корисници');
DEFINE ('_UDDEADM_RESTRALLUSERS_2', 'само администратори');
DEFINE ('_UDDEIM_MESSAGE_UNARCHIVED', 'Порука је деархивирана.');
DEFINE ('_UDDEADM_AUTOFORWARD_SPECIAL', 'посебни корисници');
DEFINE ('_UDDEIM_HELP', 'Помоћ');
DEFINE ('_UDDEIM_HELP_HEADLINE1', 'uddeIM помоћ');
DEFINE ('_UDDEIM_HELP_HEADLINE2', 'Кратак преглед свих функција');
DEFINE ('_UDDEIM_HELP_INBOX', '<b>Пријемно сандуче</b> садржи све ваше примљене поруке, свака е-порука коју примите се налази овде.');
DEFINE ('_UDDEIM_HELP_OUTBOX', '<b>Отпремно сандуче</b> чува копију сваке поруке коју пошаљете, и можете им се вратити било када да бисте погледали шта сте послали.');
DEFINE ('_UDDEIM_HELP_TRASHCAN', '<b>Канта за смеће</b> садржи све обрисане поруке. Поруке се не бришу одмах и задржавају се неко одређено време. Докле год је порука смештена у канти за смеће, моћи ћете да је повратите.');
DEFINE ('_UDDEIM_HELP_ARCHIVE', '<b>Архива</b> садржи све ваше архивиране поруке из пријемног сандучета. Можете архивирати поруке само из вашег пријемног сандучета. Ако морате да архивирате поруку коју сте сами написали, побрините се да при слању изаберете <i>копија мени</i>.');
DEFINE ('_UDDEIM_HELP_USERLISTS', '<b>Контакти</b> омогућава одржавање спискова контаката (такође познатих као дистрибуциони спискови). Ови спискови омогућују слање ПП-а вишеструким примаоцима. Уместо додавања вишеструких прималаца, можете једноставно унети <i>#имесписка</i>.');
DEFINE ('_UDDEIM_HELP_SETTINGS', '<b>Подешавања</b> садрже све опције које корисник може подесити.');
DEFINE ('_UDDEIM_HELP_COMPOSE', '<b>Напиши</b> омогућава писање нове приватне поруке.');
DEFINE ('_UDDEIM_HELP_IREAD', 'Порука је прочитана (можете мењати статус).');
DEFINE ('_UDDEIM_HELP_IUNREAD', 'Порука је још увек непрочитана (можете мењати статус).');
DEFINE ('_UDDEIM_HELP_OREAD', 'Порука је прочитана.');
DEFINE ('_UDDEIM_HELP_OUNREAD', 'Порука је још увек непрочитана. Непрочитане поруке се могу опозвати.');
DEFINE ('_UDDEIM_HELP_TREAD', 'Порука је прочитана.');
DEFINE ('_UDDEIM_HELP_TUNREAD', 'Порука је још увек непрочитана.');
DEFINE ('_UDDEIM_HELP_FLAGGED', 'Порука је означена, нпр. када је порука важна (можете мењати статус).');
DEFINE ('_UDDEIM_HELP_UNFLAGGED', '<i>Обична</i> порука (можете мењати статус).');
DEFINE ('_UDDEIM_HELP_ONLINE', 'Корисник је тренутно на вези.');
DEFINE ('_UDDEIM_HELP_OFFLINE', 'Корисник тренутно није на вези.');
DEFINE ('_UDDEIM_HELP_DELETE', 'Брисање поруке (премештање поруке у канту за смеће).');
DEFINE ('_UDDEIM_HELP_FORWARD', 'Прослеђивање поруке другом примаоцу.');
DEFINE ('_UDDEIM_HELP_ARCHIVEMSG', 'Архивирање поруке. Архивиране поруке неће бити самостално обрисане када је администратор подесио временско ограничење за поруке сачуване у пријемном сандучету.');
DEFINE ('_UDDEIM_HELP_UNARCHIVEMSG', 'Деархивирање поруке. Порука ће бити пребачена натраг у пријемно сандуче.');
DEFINE ('_UDDEIM_HELP_RECALL', 'Опозив поруке. Послате поруке могу бити опозване ако их прималац још увек није прочитао.');
DEFINE ('_UDDEIM_HELP_RECYCLE', 'Рециклирање поруке (премештање поруке из канте за смеће натраг у пријемно или отпремно сандуче).');
DEFINE ('_UDDEIM_HELP_NOTIFY', 'Подешавање обавештења е-поштом када стигне нова порука.');
DEFINE ('_UDDEIM_HELP_AUTORESPONDER', 'Када су укључени аутоматски одговори на сваку примљену поруку ће бити одмах одговорено.');
DEFINE ('_UDDEIM_HELP_AUTOFORWARD', 'Нове поруке могу самостално бити прослеђене другом кориснику.');
DEFINE ('_UDDEIM_HELP_BLOCKING', 'Можете блокирати кориснике. Ови корисници вам не могу слати приватне поруке.');
DEFINE ('_UDDEIM_HELP_MISC', 'Овде можете пронаћи још неке поставке подешавања');
DEFINE ('_UDDEIM_HELP_FEED', 'Можете приступити свом пријемном сандучету користећи RSS извор.');
DEFINE ('_UDDEADM_SEPARATOR_HEAD', 'Граничник');
DEFINE ('_UDDEADM_SEPARATOR_EXP', 'Одаберите граничник који ће се користити за вишеструке примаоце (подразумевано је „,“).');
DEFINE ('_UDDEADM_SEPARATOR_P0', 'запета (подразумевано)');
DEFINE ('_UDDEADM_SEPARATOR_P1', 'тачка запета');
DEFINE ('_UDDEADM_RSSLIMIT_HEAD', 'RSS ставке');
DEFINE ('_UDDEADM_RSSLIMIT_EXP', 'Ограничи број враћених RSS ставки (0 за неограничено).');
DEFINE ('_UDDEADM_SHOWHELP_HEAD', 'Прикажи дугме за помоћ');
DEFINE ('_UDDEADM_SHOWHELP_EXP', 'Када је укључено, биће приказано дугме за помоћ.');
DEFINE ('_UDDEADM_SHOWIGOOGLE_HEAD', 'Прикажи дугме за iGoogle виџет');
DEFINE ('_UDDEADM_SHOWIGOOGLE_EXP', 'Када је укључено, у корисничким поставкама ће бити приказано дугме <i>Додај у iGoogle</i> за uddeIM iGoogle виџет.');
DEFINE ('_UDDEADM_MOOTOOLS_NONE11', 'не учитавај MooTools (користи се 1.1)');
DEFINE ('_UDDEADM_MOOTOOLS_NONE12', 'не учитавај MooTools (користи се 1.2)');
DEFINE ('_UDDEIM_RSS_INTRO1', 'Можете приступити свом пријемном сандучету користећи RSS извор (0.91).');
DEFINE ('_UDDEIM_RSS_INTRO1B', 'Приступни УРЛ је:');
DEFINE ('_UDDEIM_RSS_INTRO2', 'Немојте давати овај УРЛ другим корисницима јер он дозвољава приступ вашем пријемном сандучету.');
DEFINE ('_UDDEIM_RSS_FEED', 'Извор RSS порука');
DEFINE ('_UDDEIM_RSS_NOOBJECT', 'Нема објекта...');
DEFINE ('_UDDEIM_RSS_USERBLOCKED', 'Корисник је блокиран...');
DEFINE ('_UDDEIM_RSS_NOTALLOWED', 'Приступ није дозвољен...');
DEFINE ('_UDDEIM_RSS_WRONGPASSWORD', 'Погрешно корисничко име или лозинка...');
DEFINE ('_UDDEIM_RSS_NOMESSAGES', 'Нема порука');
DEFINE ('_UDDEIM_RSS_NONEWMESSAGES', 'Нема нових порука');
DEFINE ('_UDDEADM_ENABLERSS_HEAD', 'Укључи RSS');
DEFINE ('_UDDEADM_ENABLERSS_EXP', 'Када је ова опција укључена, поруке ће бити примане са RSS извора. Корисници могу пронаћи неопходан УРЛ у свом профилу.');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_3', '...постављено подразумевано за RSS, iGoogle, помоћ, граничник');
DEFINE ('_UDDEADM_DELETEM_DELETING', 'Брисање порука:');
DEFINE ('_UDDEADM_DELETEM_FROMUSER', 'Брисање порука од корисника ');
DEFINE ('_UDDEADM_DELETEM_MSGSSENT', '- послате поруке: ');
DEFINE ('_UDDEADM_DELETEM_MSGSRECV', '- примљене поруке: ');
DEFINE ('_UDDEIM_PMNAV_THISISARESPONSE', 'Ово је одговор на:');
DEFINE ('_UDDEIM_PMNAV_THEREARERESPONSES', 'Одговори на ово:');
DEFINE ('_UDDEIM_PMNAV_DELETED', 'порука није доступна');
DEFINE ('_UDDEIM_PMNAV_EXISTS', 'скочи на поруку');
DEFINE ('_UDDEIM_PMNAV_COPY2ME', '(копија)');
DEFINE ('_UDDEADM_PMNAV_HEAD', 'Дозволи навигацију');
DEFINE ('_UDDEADM_PMNAV_EXP', 'Приказује траку за навигацију која дозвољава навигацију кроз тему.');
DEFINE ('_UDDEADM_MAINTENANCE_ALLDAYS', 'Поруке:');
DEFINE ('_UDDEADM_MAINTENANCE_7DAYS', 'Поруке у 7 дана:');
DEFINE ('_UDDEADM_MAINTENANCE_30DAYS', 'Поруке у 30 дана:');
DEFINE ('_UDDEADM_MAINTENANCE_365DAYS', 'Поруке у 365 дана:');
DEFINE ('_UDDEADM_MAINTENANCE_HEAD1', 'Слање подсетника за (незаборавак: %s дана):');
DEFINE ('_UDDEADM_MAINTENANCE_HEAD2', 'За %s дана се шаљу подсетници за:');
DEFINE ('_UDDEADM_MAINTENANCE_NO', 'Бр.:');
DEFINE ('_UDDEADM_MAINTENANCE_USERID', 'ИД корисника:');
DEFINE ('_UDDEADM_MAINTENANCE_TONAME', 'Име:');
DEFINE ('_UDDEADM_MAINTENANCE_MID', 'ИД поруке:');
DEFINE ('_UDDEADM_MAINTENANCE_WRITTEN', 'Написано:');
DEFINE ('_UDDEADM_MAINTENANCE_TIMER', 'Тајмер:');

// New: 1.5
DEFINE ('_UDDEMODULE_ALLDAYS', ' порука');
DEFINE ('_UDDEMODULE_7DAYS', ' порука у последњих 7 дана');
DEFINE ('_UDDEMODULE_30DAYS', ' порука у последњих 30 дана');
DEFINE ('_UDDEMODULE_365DAYS', ' порука у последњих 365 дана');
DEFINE ('_UDDEADM_EMN_SENDERMAIL_WARNING', '<br /><b>Напомена:<br />Када користите mosMail, морате да подесите исправну адресу е-поште!</b>');
DEFINE ('_UDDEIM_FILTEREDMESSAGE', 'порука је филтрирана');
DEFINE ('_UDDEIM_FILTEREDMESSAGES', 'порука је филтрирано');
DEFINE ('_UDDEIM_FILTER', 'Филтер:');
DEFINE ('_UDDEIM_FILTER_TITLE_INBOX', 'Прикажи само од овог корисника');
DEFINE ('_UDDEIM_FILTER_TITLE_OUTBOX', 'Прикажи само за овог корисника');
DEFINE ('_UDDEIM_FILTER_UNREAD_ONLY', 'само непрочитане');
DEFINE ('_UDDEIM_FILTER_SUBMIT', 'Филтрирај');
DEFINE ('_UDDEIM_FILTER_ALL', '- све -');
DEFINE ('_UDDEIM_FILTER_PUBLIC', '- јавне кориснике -');
DEFINE ('_UDDEADM_FILTER_HEAD', 'Укључи филтер');
DEFINE ('_UDDEADM_FILTER_EXP', 'Ако је укључен, корисници могу да филтрирају своје пријемне/отпремне сандучиће ради приказивања само једног примаоца или пошиљаоца.');
DEFINE ('_UDDEADM_FILTER_P0', 'искључен');
DEFINE ('_UDDEADM_FILTER_P1', 'изнад списка порука');
DEFINE ('_UDDEADM_FILTER_P2', 'испод списка порука');
DEFINE ('_UDDEADM_FILTER_P3', 'изнад и испод списка порука');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED', '<b>Немате%s порука%s у%s.</b>');	// see next  six lines
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_UNREAD', ' непрочитаних');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_FROM', ' од овог корисника');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_TO', ' за овог корисника');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_INBOX', ' пријемном сандучету');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_OUTBOX', ' отпремном сандучету');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_ARCHIVE', ' архиви');
DEFINE ('_UDDEIM_TODP_TITLE', 'Прималац');
DEFINE ('_UDDEIM_TODP_TITLE_CC', 'Један или више прималаца (раздвојених зарезом)');
DEFINE ('_UDDEIM_ADDCCINFO_TITLE', 'Када је штиклирано, ред који садржи све примаоце ће бити додат поруци.');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_2', '...постављено подразумевано за ауто одговоре, ауто прослеђивање, пријемно сандуче, филтер');
DEFINE ('_UDDEADM_AUTORESPONDER_HEAD', 'Укључи аутоматске одговоре');
DEFINE ('_UDDEADM_AUTORESPONDER_EXP', 'Када су укључени аутоматски одговори корисник може укључити обавештења о аутоматским одговорима у личним корисничким поставкама.');
DEFINE ('_UDDEIM_EMN_AUTORESPONDER', 'Укључи аутоматске одговоре');
DEFINE ('_UDDEIM_AUTORESPONDER', 'Аутоматски одговори');
DEFINE ('_UDDEIM_AUTORESPONDER_EXP', 'Када су укључени аутоматски одговори на сваку примљену поруку ће бити одмах одговорено.');
DEFINE ('_UDDEIM_AUTORESPONDER_DEFAULT', "Жао ми је, тренутно нисам на располагању.\nОбрадићу своје пријемно сандуче првом следећом приликом.");
DEFINE ('_UDDEADM_USERSET_AUTOR', 'Ауто одг.');
DEFINE ('_UDDEADM_USERSET_SELAUTOR', '- Ауто одг. -');
DEFINE ('_UDDEIM_USERBLOCKED', 'Корисник је блокиран.');
DEFINE ('_UDDEADM_AUTOFORWARD_HEAD', 'Укључи аутоматско прослеђивање');
DEFINE ('_UDDEADM_AUTOFORWARD_EXP', 'Када је укључено аутоматско прослеђивање корисник може аутоматски прослеђивати нове поруке неком другом кориснику.');
DEFINE ('_UDDEIM_EMN_AUTOFORWARD', 'Укључи аутоматско прослеђивање');
DEFINE ('_UDDEADM_USERSET_AUTOF', 'Ауто просл.');
DEFINE ('_UDDEADM_USERSET_SELAUTOF', '- Ауто просл. -');
DEFINE ('_UDDEIM_AUTOFORWARD', 'Аутоматско прослеђивање');
DEFINE ('_UDDEIM_AUTOFORWARD_EXP', 'Нове поруке ће аутоматски бити прослеђене другом кориснику.');
DEFINE ('_UDDEIM_THISISAFORWARD', 'Аутоматски прослеђена порука која је првобитно била послата за ');
DEFINE ('_UDDEADM_COLSROWS_HEAD', 'Оквир поруке (колона/редова)');
DEFINE ('_UDDEADM_COLSROWS_EXP', 'Ово одређује број колона и редова у оквиру поруке (подразумеване вредности су 60/10).');
DEFINE ('_UDDEADM_WIDTH_HEAD', 'Оквир поруке (ширина)');
DEFINE ('_UDDEADM_WIDTH_EXP', 'Ово одређује ширину оквира поруке у пикселима (подразумевано је 0). Ако је ова вредност 0, користиће се ширина наведена у CSS стилу.');
...
DEFINE ('_UDDEADM_MOOTOOLS_EXP', 'Ово одређује како uddeIM учитава MooTools (MooTools је неопходан за Autocompleter): <i>немој</i> је корисно када шаблон учитава MooTools, <i>ауто</i> се препоручује подразумевано, када користите J1.0 такође можете приморати учитавање MooTools 1.1 или 1.2.');
...
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_1', '...постављено подразумевано за MooTools');
...
DEFINE ('_UDDEADM_SHOWLINK_EXP', 'Сва корисничка имена која се појављују у uddeIM-у ће бити приказана као везе до њихових корисничких профила у одабраном систему.');
DEFINE ('_UDDEADM_SHOWPIC_HEAD', 'Прикажи сличице');
DEFINE ('_UDDEADM_SHOWPIC_EXP', 'Сличица преузета из одабраног система корисника ће бити приказана при читању поруке.');
...
DEFINE ('_UDDEADM_USERSET_PUBLIC', 'Јавно суч.');
DEFINE ('_UDDEADM_USERSET_SELPUBLIC', '- Јавно суч. -');
...
DEFINE ('_UDDEADM_DELETESENTAFTER_HEAD', 'Послате поруке се чувају');
...
DEFINE ('_UDDEADM_USERSET_SELUSERNAME', '- Корисничко име -');
DEFINE ('_UDDEADM_USERSET_SELNAME', '- Име -');
...
DEFINE ('_UDDEADM_USERSET_SELENTRY', '- Ставка -');
DEFINE ('_UDDEADM_USERSET_SELNOTIFICATION', '- Обавештење -');
DEFINE ('_UDDEADM_USERSET_SELPOPUP', '- Искачући прозор -');
...
DEFINE ('_UDDEADM_SHOWGROUPS_EXP', 'Прикажи Joomla групе у системском списку порука.');
...
DEFINE ('_UDDEIM_PASSWORD', 'Неопходна је лозинка');
...
DEFINE ('_UDDEADM_POPUP_EXP','Прикажи искачуће обавештење када стигне нова порука (неопходан је mod_uddeim)');
...
DEFINE ('_UDDEADM_CONLISTBOX', 'Падајући списак веза');
...
DEFINE ('_UDDEIM_NOMESSAGES_INBOX', 'Немате порука у пријемном сандучету.');

DEFINE ('_UDDEIM_NOMESSAGES_OUTBOX', 'Немате порука у отпремном сандучету.');
DEFINE ('_UDDEIM_NOMESSAGES_TRASHCAN', 'Немате порука у канти за смеће.');
...
DEFINE ('_UDDEADM_DELETEREADAFTER_HEAD', 'Прочитане поруке се чувају');
DEFINE ('_UDDEADM_DELETEUNREADAFTER_HEAD', 'Непрочитане поруке се чувају');
DEFINE ('_UDDEADM_DELETETRASHAFTER_HEAD', 'Поруке се чувају у смећу');
...
DEFINE ('_UDDEADM_ADMINIGNITIONONLY_MANUALLY', 'се ручно');
...
DEFINE ('_UDDEADM_DELETIONS', 'Брисање');
...
DEFINE ('_UDDEIM_SYSGM_SHORTHELP', 'Употреба <b>само у системским порукама</b>:<br /> [b]<b>подебљано</b>[/b] [i]<em>курзив</em>[/i]<br />[url=http://www.nekiurl.com]неки урл[/url] или [url]http://www.nekiurl.com[/url] су везе');
...
DEFINE ('_UDDEIM_EXPORT_NOW', 'пошаљи е-пошту');
...
DEFINE ('_UDDEADM_SHOWCONNEX_HEAD', 'Прикажи везе');
DEFINE ('_UDDEADM_SHOWCONNEX_EXP', 'Употребите <b>да</b> уколико имате инсталиран CB/CBE/JS и желите да прикажете имена корисникових веза на страници за писање нове поруке.');
...
"Здраво %you%,\n\n%user% вам је послао/ла следећу приватну поруку на %site%.\n__________________\n%pmessage%");
DEFINE ('_UDDEIM_EMN_BODY_NOMESSAGE',
"Здраво %you%,\n\n%user% вам је послао/ла приватну поруку на %site%. Молимо вас да се пријавите да бисте је прочитали!\n\n%livesite%");
