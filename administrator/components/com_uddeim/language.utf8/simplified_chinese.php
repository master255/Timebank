...
// *******************************************************************
DEFINE ('_UDDEADM_TRANSLATORS_CREDITS', 'Translated by Baijianpeng and Eric Cheng');	// Enter your credits line here, e.g. 'Translation by <a href="http://domain.com" target="_new">John Doe</a>'
...
// New: 1.9
DEFINE ('_UDDEIM_FILEUPLOAD_FAILED', '文件上传失败');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_5', '...附件功能初始化为默认设置');
DEFINE ('_UDDEADM_ENABLEATTACHMENT_HEAD', '启用附件功能');
DEFINE ('_UDDEADM_ENABLEATTACHMENT_EXP', '启用此功能时将允许所有注册用户或者仅限管理员在发送消息时附带文件.');
DEFINE ('_UDDEADM_MAXSIZEATTACHMENT_HEAD', '附件文件最大容量');
DEFINE ('_UDDEADM_MAXSIZEATTACHMENT_EXP', '设置附件中文件的最大容量,如2Mb.');
DEFINE ('_UDDEIM_FILESIZE_EXCEEDED', '文件大小超过限制');
DEFINE ('_UDDEADM_BYTES', 'Bytes');
DEFINE ('_UDDEADM_MAXATTACHMENTS_HEAD', '允许文件数');
DEFINE ('_UDDEADM_MAXATTACHMENTS_EXP', '设置单条消息中可以包含的文件数量.');
DEFINE ('_UDDEIM_DOWNLOAD', '下载至本地');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_HEAD', '删除文件请求已提交.');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_YES', '仅限管理员查看时');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_NO', '任何用户查看时');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_MANUALLY', '手动');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_EXP', '文件自动删除功能将加重服务器负担. 当设置为 <b>仅限管理员</b> 时，在管理员查看收件箱时将自动启动文件删除功能. 如果有管理员经常查看收件箱时请设置为<b>仅限管理员</b>. 如果管理员很少查看收件箱，请设置为 <b>任何用户查看时</b>.');
DEFINE ('_UDDEADM_FILEMAINTENANCE_PRUNE', '清理文件');
DEFINE ('_UDDEADM_FILEMAINTENANCEDEL_HEAD', '清理已删除文件信息');
DEFINE ('_UDDEADM_FILEMAINTENANCEDEL_EXP', '从数据库中清理已删除文件信息. 此功能与系统页面中的 \'Prune files now\' on the system tab.');
DEFINE ('_UDDEADM_FILEMAINTENANCEDEL_ERASE', '清除');
DEFINE ('_UDDEIM_ATTACHMENTS', '附件 (每个文件尺寸最大. %u bytes):');
DEFINE ('_UDDEADM_MAINTENANCE_F1', '文件系统中存储的零散无主文件: ');
DEFINE ('_UDDEADM_MAINTENANCE_F2', '删除零散无主文件');
DEFINE ('_UDDEADM_BACKUP_DONE', '设置备份完成.');
DEFINE ('_UDDEADM_RESTORE_DONE', '设置恢复完成.');
DEFINE ('_UDDEADM_PRUNE_DONE', '消息清理已完成.');
DEFINE ('_UDDEADM_FILEPRUNE_DONE', '文件清理完成.');
DEFINE ('_UDDEADM_FOLDERCREATE_ERROR', '创建文件夹失败: ');
DEFINE ('_UDDEADM_ATTINSTALL_WRITEFAILED', '创建文件失败: ');
DEFINE ('_UDDEADM_ATTINSTALL_IGNORE', '如果在显示此错误时，您尚未安装uddeIM附件增强插件，请忽略此错误提示.');
DEFINE ('_UDDEADM_ATTACHMENTGROUPS_HEAD', '可发送附件的用户组');
DEFINE ('_UDDEADM_ATTACHMENTGROUPS_EXP', '设置可以发送附件的用户组.');
DEFINE ('_UDDEIM_SELECT', '选择');
DEFINE ('_UDDEIM_ATTACHMENT', '附件');
DEFINE ('_UDDEADM_SHOWLISTATTACHMENT_HEAD', '显示附件图标');
DEFINE ('_UDDEADM_SHOWLISTATTACHMENT_EXP', '在消息列表中显示附件图标(收件箱, 发件箱, 存档).');
DEFINE ('_UDDEIM_HELP_ATTACHMENT', '此消息包含一个附件.');
DEFINE ('_UDDEADM_MAINTENANCE_COUNTFILES', '数据库中已存储文件信息:');
DEFINE ('_UDDEADM_MAINTENANCE_COUNTFILESDISTINCT', '文件附件已存储:');
DEFINE ('_UDDEADM_SHOWMENUCOUNT_HEAD', '显示计数器');
DEFINE ('_UDDEADM_SHOWMENUCOUNT_EXP', '设置为<b>是</b>时, 菜单栏内将显示一个消息计数器. 注意: 开启此功能时将加重数据库服务器允许负担.');
DEFINE ('_UDDEADM_CONFIG_FTPLAYER', 'FTP相关设置:');
DEFINE ('_UDDEADM_ENCODEHEADER_HEAD', 'Email头信息编码');
DEFINE ('_UDDEADM_ENCODEHEADER_EXP', '设置为<b>是</b>时, Email头信息(如标题)将被编码为rfc 2047.当发送Email出现乱码时请尝试使用此功能.');
DEFINE ('_UDDEIM_UP', '升序排列');
DEFINE ('_UDDEIM_DOWN', '降序排列');
DEFINE ('_UDDEIM_UPDOWN', '排序');
DEFINE ('_UDDEADM_ENABLESORT_HEAD', '启用排序功能');
DEFINE ('_UDDEADM_ENABLESORT_EXP', '设置为<b>是</b>时, 用户将可以在收件箱、发件箱和存档文件夹中对消息进行排序(此功能将会加重数据库服务器允许负担).');
...
DEFINE ('_UDDEIM_NOMESSAGES2_FR_FILTERED', '<b>在您的%s中未找到来自该用户的消息.</b>');
DEFINE ('_UDDEIM_NOMESSAGES2_TO_FILTERED', '<b>在您的%s中未找到发送至该用户的消息.</b>');
DEFINE ('_UDDEIM_NOMESSAGES2_UNFR_FILTERED', '<b>您的%s中尚无来自该用户的未读消息..</b>');
DEFINE ('_UDDEIM_NOMESSAGES2_UNTO_FILTERED', '<b>您的%s中尚无发送至该用户的未读消息.</b>');

// New: 1.7
DEFINE ('_UDDEADM_EMAILSTOPPED', '\'禁用发送 Email 功能\' 已开启.');
DEFINE ('_UDDEIM_ACCOUNTLOCKED', '您暂时无法访问您的收件箱.请联系站点管理员.');
DEFINE ('_UDDEADM_USERSET_LOCKED', '锁定中');
DEFINE ('_UDDEADM_USERSET_SELLOCKED', '- 锁定中 -');
DEFINE ('_UDDEADM_CBBANNED_HEAD', '检查CB中已封禁用户');
DEFINE ('_UDDEADM_CBBANNED_EXP', '当此功能启用时,uddeIM将检查用户在CB中是否已被封禁,并阻止被封禁用户访问uddeIM. 此外,其他用户也将无法向被封禁用户发送消息.');
DEFINE ('_UDDEIM_YOUAREBANNED', '您的帐号已经被管理员禁用.请联系站点管理员或者工作人员.');
DEFINE ('_UDDEIM_USERBANNED', '用户已被封禁');
DEFINE ('_UDDEADM_JOOBB', 'Joo!BB');
DEFINE ('_UDDEPLUGIN_SEARCHSECTION', '私人消息');
DEFINE ('_UDDEPLUGIN_MESSAGES', '私人消息');
DEFINE ('_UDDEADM_MAINTENANCEDEL_HEAD', '启动消息清理');
// note "This  is the same as _UDDEADM_MAINTENANCE_PRUNE on the system tab."
DEFINE ('_UDDEADM_MAINTENANCEDEL_EXP', '此功能将从数据库中清理已删除的消息. 此功能和系统设置中的 \'立即清理消息\' 功能一致.');
DEFINE ('_UDDEADM_MAINTENANCEDEL_ERASE', '清理');
DEFINE ('_UDDEADM_REPORTSPAM_HEAD', '举报消息链接');
DEFINE ('_UDDEADM_REPORTSPAM_EXP', '当启用此功能时,将显示一个 \'举报消息\' 链接,提供给用户向管理员举报垃圾信息的功能.');
DEFINE ('_UDDEIM_TOOLBAR_REMOVESPAM', '删除消息');
DEFINE ('_UDDEIM_TOOLBAR_REMOVEREPORT', '删除举报');
DEFINE ('_UDDEIM_TOOLBAR_SPAMCONTROL', '举报管理');
DEFINE ('_UDDEADM_INFORMATION', '详细信息');
DEFINE ('_UDDEADM_SPAMCONTROL_STAT', '举报消息:');
DEFINE ('_UDDEADM_SPAMCONTROL_TRASHED', '回收');
DEFINE ('_UDDEADM_SPAMCONTROL_NOTEDEL', '从数据库中删除此条消息?');
DEFINE ('_UDDEADM_SPAMCONTROL_NOTEREMOVE', '删除此举报信息?');
DEFINE ('_UDDEADM_SPAMCONTROL_SHOWHIDE', '显示/隐藏');
DEFINE ('_UDDEADM_SPAMCONTROL_EDIT', '举报控制中心');
DEFINE ('_UDDEADM_SPAMCONTROL_FROM', '来自');
DEFINE ('_UDDEADM_SPAMCONTROL_TO', '至');
DEFINE ('_UDDEADM_SPAMCONTROL_TEXT', '消息');
DEFINE ('_UDDEADM_SPAMCONTROL_DELETE', '删除');
DEFINE ('_UDDEADM_SPAMCONTROL_REMOVE', '移除');
DEFINE ('_UDDEADM_SPAMCONTROL_DATE', '日期');
DEFINE ('_UDDEADM_SPAMCONTROL_REPORTED', '已举报');
DEFINE ('_UDDEIM_SPAMCONTROL_REPORT', '举报消息');
DEFINE ('_UDDEIM_SPAMCONTROL_MARKED', '此信息已被举报');
DEFINE ('_UDDEIM_SPAMCONTROL_UNREPORT', '举报反馈信息');
DEFINE ('_UDDEADM_JOMSOCIAL', 'JomSocial');
DEFINE ('_UDDEADM_KUNENA', 'Kunena');
DEFINE ('_UDDEADM_ADMIN_FILTER', '过滤器');
DEFINE ('_UDDEADM_ADMIN_DISPLAY', '显示 #');
DEFINE ('_UDDEADM_TRASHORIGINALSENT_HEAD', '清空已发送信息');
DEFINE ('_UDDEADM_TRASHORIGINALSENT_EXP', '启用此功能时将在\'发送\' 按钮旁显示一个\'清空已发送信息\'的复选框,默认情况下该复选框是未选中的.如果用户需要在发送完毕后立刻清除掉这条已发送信息,只需选中该复选框即可.');
DEFINE ('_UDDEIM_TRASHORIGINALSENT', '清空消息');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_4', '...清理已发送信息、举报垃圾信息、检查CB封禁状态的默认设置');
DEFINE ('_UDDEADM_VERSIONCHECK_IMPORTANT', '导入链接:');
DEFINE ('_UDDEADM_VERSIONCHECK_HOTFIX', '补丁');
DEFINE ('_UDDEADM_VERSIONCHECK_NONE', 'None');
DEFINE ('_UDDEADM_MAINTENANCEFIX_HEAD', "兼容性维护");
DEFINE ('_UDDEADM_MAINTENANCEFIX_EXP', "为了保证在 Joomla 1.0.x 和 1.5 平台中均可以顺利使用,uddeIM使用了两个不同的XML安装文件.因此在Joomla 1.5的安装过程中,多余的Joomla 1.0.x 安装XML文件可能会导致安装程序显示一个错误的兼容性提示.此功能将移除了这些不必要的安装XML文件,同时错误也将不会再显示.");
DEFINE ('_UDDEADM_MAINTENANCE_FIX', "修复");
DEFINE ('_UDDEADM_MAINTENANCE_XML1', "uddeIM 安装包内包含了针对 Joomla 1.0 和 Joomla 1.5 的XML 安装文件.<br />");
DEFINE ('_UDDEADM_MAINTENANCE_XML2', "这是为了同时支持 Joomla 1.0 和 Joomla 1.5 而设置的.<br />");
DEFINE ('_UDDEADM_MAINTENANCE_XML3', "Joomla 1.5系统中安装完成后,uddeIM 将会自动删除针对 Joomla 1.0 的安装文件.<br />");
DEFINE ('_UDDEADM_MAINTENANCE_XML4', "整个过程中将执行下列操作:<br />");
DEFINE ('_UDDEADM_MAINTENANCE_FXML1', "移除uddeIM 安装包里多余的 XML 安装文件:<br />");
DEFINE ('_UDDEADM_MAINTENANCE_FXML2', "未找到多余的 uddeIM 安装XML文件!<br />");
DEFINE ('_UDDEADM_SHOWMENUICONS1_HEAD', '菜单栏显示设置');
DEFINE ('_UDDEADM_SHOWMENUICONS1_EXP', '设置在菜单栏中每项的显示形式,例如是否包含文字或者图标.');
DEFINE ('_UDDEIM_MENUICONS_P1', '同时显示文字和图标');
DEFINE ('_UDDEIM_MENUICONS_P2', '仅显示图标');
DEFINE ('_UDDEIM_MENUICONS_P0', '仅显示文字');
DEFINE ('_UDDEIM_LISTSLIMIT_2', '列表中可显示的最大收件人数:');
DEFINE ('_UDDEADM_ADDEMAIL_ADMIN', '管理员可选择');
DEFINE ('_UDDEAIM_ADDEMAIL_SELECT', '通知邮件中包含消息内容');
DEFINE ('_UDDEAIM_ADDEMAIL_TITLE', '在通知邮件中包含完整消息内容.');

// New: 1.6
DEFINE ('_UDDEIM_NOLISTSELECTED', '未选择用户列表!');
DEFINE ('_UDDEADM_NOPREMIUM', '尚未安装增强插件');
DEFINE ('_UDDEIM_LISTGLOBAL_CREATOR', '创建人:');
DEFINE ('_UDDEIM_LISTGLOBAL_ENTRIES', '列表人数');
DEFINE ('_UDDEIM_LISTGLOBAL_TYPE', '类型');
DEFINE ('_UDDEIM_LISTGLOBAL_NORMAL', '普通');
DEFINE ('_UDDEIM_LISTGLOBAL_GLOBAL', '公开');
DEFINE ('_UDDEIM_LISTGLOBAL_RESTRICTED', '特殊');
DEFINE ('_UDDEIM_LISTGLOBAL_P0', '普通联系人列表');
DEFINE ('_UDDEIM_LISTGLOBAL_P1', '公开联系人列表');
DEFINE ('_UDDEIM_LISTGLOBAL_P2', '特殊联系人列表(仅限列表成员可以查看该列表)');
DEFINE ('_UDDEIM_TOOLBAR_USERSETTINGS', '个人设置');
DEFINE ('_UDDEIM_TOOLBAR_REMOVESETTINGS', '删除设置');
DEFINE ('_UDDEIM_TOOLBAR_CREATESETTINGS', '新建设置');
DEFINE ('_UDDEIM_TOOLBAR_SAVE', '保存');
DEFINE ('_UDDEIM_TOOLBAR_BACK', '返回');
DEFINE ('_UDDEIM_TOOLBAR_TRASHMSGS', '删除消息');
DEFINE ('_UDDEIM_CBPLUG_CONT', '[下一步]');
DEFINE ('_UDDEIM_CBPLUG_UNBLOCKNOW', '[从忽略列表中移除]');
DEFINE ('_UDDEIM_CBPLUG_DOBLOCK', '将该会员添加至忽略列表');
DEFINE ('_UDDEIM_CBPLUG_DOUNBLOCK', '将该会员从忽略列表中移除');
DEFINE ('_UDDEIM_CBPLUG_BLOCKINGCFG', '忽略状态');
DEFINE ('_UDDEIM_CBPLUG_BLOCKED', '当前状态下此会员不能向您发送站内消息');
DEFINE ('_UDDEIM_CBPLUG_UNBLOCKED', '当前状态下此会员可向您发送站内消息.');
DEFINE ('_UDDEIM_CBPLUG_NOWBLOCKED', '此会员已在您的忽略列表中.');
DEFINE ('_UDDEIM_CBPLUG_NOWUNBLOCKED', '此会员不在您的忽略列表中.');
DEFINE ('_UDDEADM_PARTIALIMPORTDONE', '从其他PMS系统导入消息已完成.请勿从该系统再次导入消息,避免出现多条重复消息.');
DEFINE ('_UDDEADM_IMPORT_HELP', '注意: 消息导入过程可分一次或者多次完成.如果需要导入的信息过多的时候,请通过多次导入这些消息.');
DEFINE ('_UDDEADM_IMPORT_PARTIAL', '多次分块导入:');
DEFINE ('_UDDEADM_UPDATEYOURDB', '注意: 正在使用中的数据库结构仍创建自旧版本的uddeIM.请参考README文件,对数据库相关数据表进行修改!');
DEFINE ('_UDDEADM_RESTRALLUSERS_HEAD', '"全部会员" 链接访问权限');
DEFINE ('_UDDEADM_RESTRALLUSERS_EXP', '设置可以访问"全部会员" 链接的会员和会员组,默认设置中允许所有会员访问该链接(<i>允许所有会员访问</i>).');
DEFINE ('_UDDEADM_RESTRALLUSERS_0', '允许所有会员访问');
DEFINE ('_UDDEADM_RESTRALLUSERS_1', '仅允许特殊会员访问');
DEFINE ('_UDDEADM_RESTRALLUSERS_2', '仅允许管理员访问');
DEFINE ('_UDDEIM_MESSAGE_UNARCHIVED', '消息存档已取消.');
DEFINE ('_UDDEADM_AUTOFORWARD_SPECIAL', '特殊会员');
DEFINE ('_UDDEIM_HELP', '帮助');
DEFINE ('_UDDEIM_HELP_HEADLINE1', 'uddeIM 帮助');
DEFINE ('_UDDEIM_HELP_HEADLINE2', '功能介绍');
DEFINE ('_UDDEIM_HELP_INBOX', '<b>收件箱</b> 用以保存所有接收到消息.');
DEFINE ('_UDDEIM_HELP_OUTBOX', '<b>发件箱</b> 用以存储所有发送出去的消息.');
DEFINE ('_UDDEIM_HELP_TRASHCAN', '<b>回收站</b> 用以存储所有已删除的消息.通常情况下这些被删除的消息将被保留在回收站中一段时间，以方便用户随时找回误删除的消息.');
DEFINE ('_UDDEIM_HELP_ARCHIVE', '<b>存档</b> 用以保存所有需要存档的重要消息.您可以在收件箱中使用存档功能将收到的重要消息放到存档中，或者在发送消息时勾选"给自己发送消息副本"然后在收件箱中将该消息副本存档.');
DEFINE ('_UDDEIM_HELP_USERLISTS', '<b>联系人列表</b> 用以存储常用的联系人列表. 这些列表通常用来存储不同分组的联系人.在发送消息时可以在收件人地址中直接填写<b>#列表名</b> 从而实现向该列表中的所有联系人发送消息.');
DEFINE ('_UDDEIM_HELP_SETTINGS', '<b>个人设定</b> 用以保存所有的个人设定信息..');
DEFINE ('_UDDEIM_HELP_COMPOSE', '<b>新建消息</b> 用以创建一条新的消息.');
DEFINE ('_UDDEIM_HELP_IREAD', '此消息已读 (可标记为未读).');
DEFINE ('_UDDEIM_HELP_IUNREAD', '此消息未读 (可标记为已读).');
DEFINE ('_UDDEIM_HELP_OREAD', '此消息已读.');
DEFINE ('_UDDEIM_HELP_OUNREAD', '此消息尚未阅读. 未读消息可被发件人撤回.');
DEFINE ('_UDDEIM_HELP_TREAD', '此消息已读.');
DEFINE ('_UDDEIM_HELP_TUNREAD', '此消息尚未阅读.');
DEFINE ('_UDDEIM_HELP_FLAGGED', '消息已被标记(通常使用标记功能标识该信息为重要信息).');
DEFINE ('_UDDEIM_HELP_UNFLAGGED', '<i>普通</i> 消息 (可标记为重要消息).');
DEFINE ('_UDDEIM_HELP_ONLINE', '该会员在线中.');
DEFINE ('_UDDEIM_HELP_OFFLINE', '该会员暂时不在线.');
DEFINE ('_UDDEIM_HELP_DELETE', '删除消息 (将消息移送至回收站).');
DEFINE ('_UDDEIM_HELP_FORWARD', '回复消息至其他收件人.');
DEFINE ('_UDDEIM_HELP_ARCHIVEMSG', '存档消息.当设置消息存放时限时，系统不会删除超过存放时限的已存档消息.');
DEFINE ('_UDDEIM_HELP_UNARCHIVEMSG', '取消消息存档. 取消消息的存档状态时将被自动转移至收件箱.');
DEFINE ('_UDDEIM_HELP_RECALL', '撤回消息. 当收件人尚未阅读消息时,发件人可以撤回该消息.');
DEFINE ('_UDDEIM_HELP_RECYCLE', '恢复消息.从回收站中恢复已删除消息，恢复消息时会自动将该消息转移至收件箱或者发件箱.');
DEFINE ('_UDDEIM_HELP_NOTIFY', '配置收到新消息时通知邮件的设定.');
DEFINE ('_UDDEIM_HELP_AUTORESPONDER', '启用自动回复时,默认的消息将被自动回复至收件人.');
DEFINE ('_UDDEIM_HELP_AUTOFORWARD', '设置消息自动转发时,收到新消息时会自动转发至其他用户.');
DEFINE ('_UDDEIM_HELP_BLOCKING', '您可以添加多个会员至忽略列表.列表内的会员将无法向您发送站内消息.');
DEFINE ('_UDDEIM_HELP_MISC', '点击此处可以查看更多设置');
DEFINE ('_UDDEIM_HELP_FEED', '您可以通过RSS源访问收件箱.');
DEFINE ('_UDDEADM_SEPARATOR_HEAD', '分隔符');
DEFINE ('_UDDEADM_SEPARATOR_EXP', '设置用以分隔不同收件人的分隔符号,(默认使用半角逗号",").');
DEFINE ('_UDDEADM_SEPARATOR_P0', '半角逗号 (默认)');
DEFINE ('_UDDEADM_SEPARATOR_P1', '分号');
DEFINE ('_UDDEADM_RSSLIMIT_HEAD', 'RSS 条目');
DEFINE ('_UDDEADM_RSSLIMIT_EXP', '设置通过RSS显示的消息条数(0为不限制).');
DEFINE ('_UDDEADM_SHOWHELP_HEAD', '显示帮助按钮');
DEFINE ('_UDDEADM_SHOWHELP_EXP', '设置是否显示帮助按钮.');
DEFINE ('_UDDEADM_SHOWIGOOGLE_HEAD', '显示 iGoogle gadget 按钮');
DEFINE ('_UDDEADM_SHOWIGOOGLE_EXP', '启用此功能时,将显示一个 <i>添加至 iGoogle</i> 按钮.通过该按钮可以将uddeIM中的RSS信息添加至用户iGoogle页面中的Rss读取gadget中.');
DEFINE ('_UDDEADM_MOOTOOLS_NONE11', '不加载 Mootools (使用Mootools 1.1时)');
DEFINE ('_UDDEADM_MOOTOOLS_NONE12', '不加载 Mootools (使用Mootools 1.2时)');
DEFINE ('_UDDEIM_RSS_INTRO1', '您可以通过RSS访问收件箱 (0.91).');
DEFINE ('_UDDEIM_RSS_INTRO1B', '访问地址是:');
DEFINE ('_UDDEIM_RSS_INTRO2', '由于通过该地址可以直接阅读您收件箱内的消息，请妥善保管该地址.');
DEFINE ('_UDDEIM_RSS_FEED', '站内消息 RSS 地址');
DEFINE ('_UDDEIM_RSS_NOOBJECT', '未找到任何条目...');
DEFINE ('_UDDEIM_RSS_USERBLOCKED', '该用户已被封禁...');
DEFINE ('_UDDEIM_RSS_NOTALLOWED', '您无权使用该功能...');
DEFINE ('_UDDEIM_RSS_WRONGPASSWORD', '用户名或者密码错误...');
DEFINE ('_UDDEIM_RSS_NOMESSAGES', '尚未收到消息');
DEFINE ('_UDDEIM_RSS_NONEWMESSAGES', '暂未收到新消息');
DEFINE ('_UDDEADM_ENABLERSS_HEAD', '启用RSS');
DEFINE ('_UDDEADM_ENABLERSS_EXP', '当启用该功能时,会员可以通过RSS访问自己的收件箱.同时会员可在个人设置页面查看该RSS地址.');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_3', '...重置RSS, iGoogle, 帮助, 分隔符为默认设置');
DEFINE ('_UDDEADM_DELETEM_DELETING', '删除消息:');
DEFINE ('_UDDEADM_DELETEM_FROMUSER', '删除来自该用户的消息: ');
DEFINE ('_UDDEADM_DELETEM_MSGSSENT', '- 已发送: ');
DEFINE ('_UDDEADM_DELETEM_MSGSRECV', '- 已收到: ');
DEFINE ('_UDDEIM_PMNAV_THISISARESPONSE', '此消息回复自:');
DEFINE ('_UDDEIM_PMNAV_THEREARERESPONSES', '回复此消息:');
DEFINE ('_UDDEIM_PMNAV_DELETED', '消息已删除');
DEFINE ('_UDDEIM_PMNAV_EXISTS', '查看消息');
DEFINE ('_UDDEIM_PMNAV_COPY2ME', '(复制)');
DEFINE ('_UDDEADM_PMNAV_HEAD', '启用导航栏');
DEFINE ('_UDDEADM_PMNAV_EXP', '设置是否在消息浏览页面显示一个导航栏.');
DEFINE ('_UDDEADM_MAINTENANCE_ALLDAYS', '消息:');
DEFINE ('_UDDEADM_MAINTENANCE_7DAYS', '最近7天收到的消息:');
DEFINE ('_UDDEADM_MAINTENANCE_30DAYS', '最近30天收到的消息:');
DEFINE ('_UDDEADM_MAINTENANCE_365DAYS', '最近一年收到的消息:');
DEFINE ('_UDDEADM_MAINTENANCE_HEAD1', '发送消息提醒(提醒期限: %s 天):');
DEFINE ('_UDDEADM_MAINTENANCE_HEAD2', '%s天内发送消息提醒至:');
DEFINE ('_UDDEADM_MAINTENANCE_NO', 'No:');
DEFINE ('_UDDEADM_MAINTENANCE_USERID', '会员 ID:');
DEFINE ('_UDDEADM_MAINTENANCE_TONAME', '姓名:');
DEFINE ('_UDDEADM_MAINTENANCE_MID', '消息 ID:');
DEFINE ('_UDDEADM_MAINTENANCE_WRITTEN', '发件人:');
DEFINE ('_UDDEADM_MAINTENANCE_TIMER', '发送时间:');

// New: 1.5
DEFINE ('_UDDEMODULE_ALLDAYS', ' 条站内消息');
DEFINE ('_UDDEMODULE_7DAYS', ' 条最近一周收到的消息');
DEFINE ('_UDDEMODULE_30DAYS', ' 条最近一月收到的消息');
DEFINE ('_UDDEMODULE_365DAYS', ' 条最近一年收到的消息');
...
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_OUTBOX', ' 发件箱');
...
DEFINE ('_UDDEIM_LISTSDESC', '列表信息');
DEFINE ('_UDDEIM_LISTSNAME', '名称');
DEFINE ('_UDDEIM_LISTSNAMEWO', '列表名称 (请勿包含空格)');
DEFINE ('_UDDEIM_EDITLINK', '编辑');
DEFINE ('_UDDEIM_LISTS', '联系人列表');
...
DEFINE ('_UDDEIM_STOPPEDEMAIL', '已禁用发送 Email 功能.');
...
DEFINE ('_UDDEADM_POPUP_EXP','设置当收到新消息时是否显示一个弹出页面');
...
DEFINE ('_UDDEADM_MAINTENANCE_CHECK', '检查冗余信息');
...
DEFINE ('_UDDEADM_MAINTENANCE_NOTHINGTODO', '<b>不执行任何操作</b><br />');
...
DEFINE ('_UDDEIM_NOMESSAGES_INBOX', '您的收件箱中没有消息。');

DEFINE ('_UDDEIM_NOMESSAGES_OUTBOX', '您的发件箱中没有消息.');
DEFINE ('_UDDEIM_NOMESSAGES_TRASHCAN', '您的回收站中没有消息.');
...
DEFINE ('_UDDEIM_THISISACOPY', '发送消息副本至： ');
DEFINE ('_UDDEIM_SENDCOPYTOME', '给自己发送消息副本');
...
DEFINE ('_UDDEADM_SHOWCONNEX_HEAD', '显示 好友');
DEFINE ('_UDDEADM_SHOWCONNEX_EXP', '如果已安装了 CB/CBE/JS 且需要在消息撰写页面上显示好友名单，请设置为 <b>是</b>.');
...
作者:         Stephan Slabihoud<br />
语言文件:     simplified_chinese.php<br />
版权:         Stephan Slabihoud<br />
