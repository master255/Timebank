...
// Translator: http://www.whichworkstation.com  dr.which@gmail.com
// *******************************************************************
DEFINE ('_UDDEADM_TRANSLATORS_CREDITS', 'Translated by dr.which@gmail.com');	// Enter your credits line here, e.g. 'Translation by <a href="http://domain.com" target="_new">John Doe</a>'
...
// New: 2.0
DEFINE ('_UDDEADM_RECAPTCHAPRV_HEAD', 'reCaptcha 私密金鑰');
DEFINE ('_UDDEADM_RECAPTCHAPRV_EXP', '當您要使用reCaptcha, 在此輸入您的私密金鑰.');
DEFINE ('_UDDEADM_RECAPTCHAPUB_HEAD', 'reCaptcha 公開金鑰');
DEFINE ('_UDDEADM_RECAPTCHAPUB_EXP', '當您要使用reCaptcha, 在此輸入您的公開金鑰.');
DEFINE ('_UDDEADM_CAPTCHA_INTERNAL', '內部的');
DEFINE ('_UDDEADM_CAPTCHA_RECAPTCHA', 'reCaptcha');
DEFINE ('_UDDEADM_CAPTCHATYPE_HEAD', 'Captcha 服務');
DEFINE ('_UDDEADM_CAPTCHATYPE_EXP', '您想要使用哪種 captcha 服務: 內設的服務或是reCaptcha (瀏覽 <a href="http://recaptcha.net" target="_new">reCaptcha</a> 以獲得更多資訊)?');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_6', '...captcha 服務設為預設');
DEFINE ('_UDDEADM_AUP', 'AlphaUserPoints');
DEFINE ('_UDDEADM_CHECKFILESFOLDER', '請移動 <i>\uddeimfiles</i> 至 <i>\images\uddeimfiles</i>. 請查閱文件!');
DEFINE ('_UDDEADM_CRYPT4', '增強加密');
DEFINE ('_UDDEADM_ALLOWTOALL2_HEAD', '允許寄出系統訊息');
DEFINE ('_UDDEADM_ALLOWTOALL2_EXP', 'uddeIM 支援系統訊息. 會寄給所有在您系統的使用者. 請謹慎使用.');
DEFINE ('_UDDEADM_ALLOWTOALL2_0', '停用');
DEFINE ('_UDDEADM_ALLOWTOALL2_1', '只限系統管理員');
DEFINE ('_UDDEADM_ALLOWTOALL2_2', '系統管理員及管理員');

// New: 1.9
DEFINE ('_UDDEIM_FILEUPLOAD_FAILED', '檔案上傳失敗');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_5', '...給檔案附件設定預設');
DEFINE ('_UDDEADM_ENABLEATTACHMENT_HEAD', '啟用檔案附件');
DEFINE ('_UDDEADM_ENABLEATTACHMENT_EXP', '啟用寄出檔案附件給所有註冊使用者或是只限管理員.');
DEFINE ('_UDDEADM_MAXSIZEATTACHMENT_HEAD', 'Max. 檔案大小');
DEFINE ('_UDDEADM_MAXSIZEATTACHMENT_EXP', '允許的檔案附件最大檔案大小.');
DEFINE ('_UDDEIM_FILESIZE_EXCEEDED', '已達最大檔案大小');
DEFINE ('_UDDEADM_BYTES', '位元組');
DEFINE ('_UDDEADM_MAXATTACHMENTS_HEAD', 'Max. 附件');
DEFINE ('_UDDEADM_MAXATTACHMENTS_EXP', '每件訊息最多可有的附件數量.');
DEFINE ('_UDDEIM_DOWNLOAD', '下載');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_HEAD', '已叫用檔案刪除');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_YES', '只由管理員');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_NO', '由任何使用者');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_MANUALLY', '手動地');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_EXP', '自動刪除造成伺服器重度負載. 如果您選擇 <b>只限管理員</b> 自動刪除只在管理員檢查他的收件匣時執行. 選擇此選項如果有管理員規律的檢查收件匣. 小型或是較少管理的網站可以選擇 <b>由任一使用者</b>.');
DEFINE ('_UDDEADM_FILEMAINTENANCE_PRUNE', '立刻清除檔案');
DEFINE ('_UDDEADM_FILEMAINTENANCEDEL_HEAD', '叫用檔案清除');
DEFINE ('_UDDEADM_FILEMAINTENANCEDEL_EXP', '從資料庫移除已刪除的檔案. 這跟系統標籤的 \'立刻清除檔案\' 是一樣的.');
DEFINE ('_UDDEADM_FILEMAINTENANCEDEL_ERASE', '清除');
DEFINE ('_UDDEIM_ATTACHMENTS', '附件 (每個檔案 max. %u 位元組):');
DEFINE ('_UDDEADM_MAINTENANCE_F1', '儲存在檔案系統裏的孤兒附件: ');
DEFINE ('_UDDEADM_MAINTENANCE_F2', '孤兒檔案刪除中');
DEFINE ('_UDDEADM_BACKUP_DONE', '備份組態已完成.');
DEFINE ('_UDDEADM_RESTORE_DONE', '還原組態已完成.');
DEFINE ('_UDDEADM_PRUNE_DONE', '訊息清除已完成.');
DEFINE ('_UDDEADM_FILEPRUNE_DONE', '檔案附件清除已完成.');
DEFINE ('_UDDEADM_FOLDERCREATE_ERROR', '建立資料夾錯誤: ');
DEFINE ('_UDDEADM_ATTINSTALL_WRITEFAILED', '建立檔案錯誤: ');
DEFINE ('_UDDEADM_ATTINSTALL_IGNORE', '您可以忽略此錯誤當您未擁有檔案附件白金外掛 (見 FAQ).');
DEFINE ('_UDDEADM_ATTACHMENTGROUPS_HEAD', '允許的群組');
DEFINE ('_UDDEADM_ATTACHMENTGROUPS_EXP', '可允許寄出檔案附件的群組.');
DEFINE ('_UDDEIM_SELECT', '選擇');
DEFINE ('_UDDEIM_ATTACHMENT', '附件');
DEFINE ('_UDDEADM_SHOWLISTATTACHMENT_HEAD', '顯示附件圖示');
DEFINE ('_UDDEADM_SHOWLISTATTACHMENT_EXP', '在訊息清單裏顯示附件圖示 (收件匣, 寄件匣, 保存匣).');
DEFINE ('_UDDEIM_HELP_ATTACHMENT', '此訊息包含一個檔案附件.');
DEFINE ('_UDDEADM_MAINTENANCE_COUNTFILES', '檔案參考在資料庫:');
DEFINE ('_UDDEADM_MAINTENANCE_COUNTFILESDISTINCT', '檔案附件已儲存:');
DEFINE ('_UDDEADM_SHOWMENUCOUNT_HEAD', '顯示計數器');
DEFINE ('_UDDEADM_SHOWMENUCOUNT_EXP', '當設為是 <b>是</b>, 功能表列會包含訊息計數器. 注意: 此將需要一些額外的資料庫查詢所以不要在太弱的系統上使用.');
DEFINE ('_UDDEADM_CONFIG_FTPLAYER', '組態 (用 FTP 存取):');
DEFINE ('_UDDEADM_ENCODEHEADER_HEAD', '郵件標題編碼');
DEFINE ('_UDDEADM_ENCODEHEADER_EXP', '設為 <b>是</b>, 當郵件標題 (例如主旨) 必須為 rfc 2047 編碼. 當您用特殊字元有問題時會很有用.');
DEFINE ('_UDDEIM_UP', '遞增排序');
DEFINE ('_UDDEIM_DOWN', '遞減排序');
DEFINE ('_UDDEIM_UPDOWN', '排序');
DEFINE ('_UDDEADM_ENABLESORT_HEAD', '啟用排序');
DEFINE ('_UDDEADM_ENABLESORT_EXP', '設為 <b>是</b>, 讓使用者可以排序收件匣, 寄件匣及保存匣 (會造成伺服器額外的負載).');
...
DEFINE ('_UDDEIM_NOMESSAGES2_FR_FILTERED', '<b>您沒有從此使用者來的訊息在您的%s裏.</b>');
DEFINE ('_UDDEIM_NOMESSAGES2_TO_FILTERED', '<b>您沒有要給此用者的訊息在您的%s裏.</b>');
DEFINE ('_UDDEIM_NOMESSAGES2_UNFR_FILTERED', '<b>您沒有從此使用者來的未讀訊息在您的%s裏.</b>');
DEFINE ('_UDDEIM_NOMESSAGES2_UNTO_FILTERED', '<b>您沒有要給此使用者的未讀訊息在您的%s裏.</b>');

// New: 1.7
DEFINE ('_UDDEADM_EMAILSTOPPED', '\'Email 禁用\' 已啟用.');
DEFINE ('_UDDEIM_ACCOUNTLOCKED', '您信箱已被上鎖無法存取. 請聯絡網站管理員.');
DEFINE ('_UDDEADM_USERSET_LOCKED', '已上鎖');
DEFINE ('_UDDEADM_USERSET_SELLOCKED', '- 已上鎖 -');
DEFINE ('_UDDEADM_CBBANNED_HEAD', '檢查被 CB 禁止的使用者');
DEFINE ('_UDDEADM_CBBANNED_EXP', '當啟動 uddeIM 會檢查使用者是否被 CB 禁止並且不允許存取 uddeIM. 同時其他使用者也無法寄出訊息給禁止的使用者.');
DEFINE ('_UDDEIM_YOUAREBANNED', '您已被禁止. 請聯絡管理員或是版主.');
DEFINE ('_UDDEIM_USERBANNED', '使用者已被禁止');
DEFINE ('_UDDEADM_JOOBB', 'Joo!BB');
DEFINE ('_UDDEPLUGIN_SEARCHSECTION', '私人傳訊');
DEFINE ('_UDDEPLUGIN_MESSAGES', '私人訊息');
DEFINE ('_UDDEADM_MAINTENANCEDEL_HEAD', '叫用訊息清除');
// note "This  is the same as _UDDEADM_MAINTENANCE_PRUNE on the system tab."
DEFINE ('_UDDEADM_MAINTENANCEDEL_EXP', '從資料庫移除已被刪除的訊息. 這跟系統標籤上的 \'立即除去訊息\' 是相同的.');
DEFINE ('_UDDEADM_MAINTENANCEDEL_ERASE', '清除');
DEFINE ('_UDDEADM_REPORTSPAM_HEAD', '回報訊息連結');
DEFINE ('_UDDEADM_REPORTSPAM_EXP', '當被啟用會顯示一個 \'回報訊息\' 連結以允許使用者回報訊息垃圾給管理員.');
DEFINE ('_UDDEIM_TOOLBAR_REMOVESPAM', '刪除訊息');
DEFINE ('_UDDEIM_TOOLBAR_REMOVEREPORT', '移除報告');
DEFINE ('_UDDEIM_TOOLBAR_SPAMCONTROL', '回報控制');
DEFINE ('_UDDEADM_INFORMATION', '資訊');
DEFINE ('_UDDEADM_SPAMCONTROL_STAT', '回報的訊息:');
DEFINE ('_UDDEADM_SPAMCONTROL_TRASHED', '刪除的');
DEFINE ('_UDDEADM_SPAMCONTROL_NOTEDEL', '從資料庫刪除訊息?');
DEFINE ('_UDDEADM_SPAMCONTROL_NOTEREMOVE', '移除此報告?');
DEFINE ('_UDDEADM_SPAMCONTROL_SHOWHIDE', '顯示/隱藏');
DEFINE ('_UDDEADM_SPAMCONTROL_EDIT', '報告控制中心');
DEFINE ('_UDDEADM_SPAMCONTROL_FROM', '從');
DEFINE ('_UDDEADM_SPAMCONTROL_TO', '至');
DEFINE ('_UDDEADM_SPAMCONTROL_TEXT', '訊息');
DEFINE ('_UDDEADM_SPAMCONTROL_DELETE', '刪除');
DEFINE ('_UDDEADM_SPAMCONTROL_REMOVE', '移除');
DEFINE ('_UDDEADM_SPAMCONTROL_DATE', '日期');
DEFINE ('_UDDEADM_SPAMCONTROL_REPORTED', '已回報');
DEFINE ('_UDDEIM_SPAMCONTROL_REPORT', '回報訊息');
DEFINE ('_UDDEIM_SPAMCONTROL_MARKED', '訊息已回報');
DEFINE ('_UDDEIM_SPAMCONTROL_UNREPORT', '回收此報告');
DEFINE ('_UDDEADM_JOMSOCIAL', 'JomSocial');
DEFINE ('_UDDEADM_KUNENA', 'Kunena');
DEFINE ('_UDDEADM_ADMIN_FILTER', '過濾');
DEFINE ('_UDDEADM_ADMIN_DISPLAY', '顯示 #');
DEFINE ('_UDDEADM_TRASHORIGINALSENT_HEAD', '刪除已寄出訊息');
DEFINE ('_UDDEADM_TRASHORIGINALSENT_EXP', '當被啟用將會放一個預設未選的 \'刪除訊息\' 核取方塊在 \'寄出\' 按鈕之後. 使用者可以點選方塊如果要在寄出訊息之後馬上刪除訊息.');
DEFINE ('_UDDEIM_TRASHORIGINALSENT', '刪除訊息');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_4', '...設定預設給刪除已寄訊息, 回報訊息垃圾, CB 禁止使用者');
DEFINE ('_UDDEADM_VERSIONCHECK_IMPORTANT', '重要連結:');
DEFINE ('_UDDEADM_VERSIONCHECK_HOTFIX', '修補程序');
DEFINE ('_UDDEADM_VERSIONCHECK_NONE', '無');
DEFINE ('_UDDEADM_MAINTENANCEFIX_HEAD', "兼容性維持");
DEFINE ('_UDDEADM_MAINTENANCEFIX_EXP', "uddeIM 使用兩個 XML 檔案來保證套裝軟體可以在 Joomla 1.0 及 1.5 上安裝. 在 Joomla 1.5 上其中一個 XML 檔案是不需要的並且會讓擴充管理員顯示不相容的警告 (它錯了). 這會移除不需要的檔案, 所以警告就不會再顯示了.");
DEFINE ('_UDDEADM_MAINTENANCE_FIX', "修復");
DEFINE ('_UDDEADM_MAINTENANCE_XML1', "Joomla 1.0 及 Joomla 1.5 的 uddeIM套裝程式 XML 安裝程式存在.<br />");
DEFINE ('_UDDEADM_MAINTENANCE_XML2', "安裝套裝軟體在 Joomla 1.0 及 Joomla 1.5 上這是必需的.<br />");
DEFINE ('_UDDEADM_MAINTENANCE_XML3', "雖然在安裝完成之後這就不是必需的了, Joomla 1.0 安裝程式可以在 Joomla 1.5 系統裡移除.<br />");
DEFINE ('_UDDEADM_MAINTENANCE_XML4', "在以下的步驟將會完成:<br />");
DEFINE ('_UDDEADM_MAINTENANCE_FXML1', "以下不需要的 uddeIM 套裝 XML 安裝程式將會被移除:<br />");
DEFINE ('_UDDEADM_MAINTENANCE_FXML2', "未找到不需要的 uddeIM 套裝 XML 安裝程式!<br />");
DEFINE ('_UDDEADM_SHOWMENUICONS1_HEAD', '選單列外觀');
DEFINE ('_UDDEADM_SHOWMENUICONS1_EXP', '這裡您可以配置選單列要顯示 圖示及/或文字.');
DEFINE ('_UDDEIM_MENUICONS_P1', '圖示及文字');
DEFINE ('_UDDEIM_MENUICONS_P2', '只限圖示');
DEFINE ('_UDDEIM_MENUICONS_P0', '只限文字');
DEFINE ('_UDDEIM_LISTSLIMIT_2', '收件人清單上的最多數目:');
DEFINE ('_UDDEADM_ADDEMAIL_ADMIN', '管理員可以選擇');
DEFINE ('_UDDEAIM_ADDEMAIL_SELECT', '用訊息提醒');
DEFINE ('_UDDEAIM_ADDEMAIL_TITLE', '包括完整訊息在 email 提醒內.');

// New: 1.6
DEFINE ('_UDDEIM_NOLISTSELECTED', '未選擇使用者清單!');
DEFINE ('_UDDEADM_NOPREMIUM', '未安裝 白金外掛');
DEFINE ('_UDDEIM_LISTGLOBAL_CREATOR', '建立者:');
DEFINE ('_UDDEIM_LISTGLOBAL_ENTRIES', '項目');
DEFINE ('_UDDEIM_LISTGLOBAL_TYPE', '類型');
DEFINE ('_UDDEIM_LISTGLOBAL_NORMAL', '標準');
DEFINE ('_UDDEIM_LISTGLOBAL_GLOBAL', '全部');
DEFINE ('_UDDEIM_LISTGLOBAL_RESTRICTED', '受限的');
DEFINE ('_UDDEIM_LISTGLOBAL_P0', '標準的聯絡清單');
DEFINE ('_UDDEIM_LISTGLOBAL_P1', '全部的聯絡清單');
DEFINE ('_UDDEIM_LISTGLOBAL_P2', '受限的聯絡清單 (只限清單上的會員可以存取)');
DEFINE ('_UDDEIM_TOOLBAR_USERSETTINGS', '使用者設定');
DEFINE ('_UDDEIM_TOOLBAR_REMOVESETTINGS', '移除設定');
DEFINE ('_UDDEIM_TOOLBAR_CREATESETTINGS', '建立設定');
DEFINE ('_UDDEIM_TOOLBAR_SAVE', '儲存');
DEFINE ('_UDDEIM_TOOLBAR_BACK', '上一頁');
DEFINE ('_UDDEIM_TOOLBAR_TRASHMSGS', '刪除訊息');
DEFINE ('_UDDEIM_CBPLUG_CONT', '[繼續]');
DEFINE ('_UDDEIM_CBPLUG_UNBLOCKNOW', '[解封鎖]');
DEFINE ('_UDDEIM_CBPLUG_DOBLOCK', '封鎖使用者');
DEFINE ('_UDDEIM_CBPLUG_DOUNBLOCK', '解封鎖使用者');
DEFINE ('_UDDEIM_CBPLUG_BLOCKINGCFG', '封鎖中');
DEFINE ('_UDDEIM_CBPLUG_BLOCKED', '您已封鎖此使用者.');
DEFINE ('_UDDEIM_CBPLUG_UNBLOCKED', '此使用者可以聯絡您.');
DEFINE ('_UDDEIM_CBPLUG_NOWBLOCKED', '使用者現已被封鎖.');
DEFINE ('_UDDEIM_CBPLUG_NOWUNBLOCKED', '使用者已不再被封鎖.');
DEFINE ('_UDDEADM_PARTIALIMPORTDONE', '從舊的PMS分批匯入訊息已完成. 不要再次分批匯入不然會再次匯入訊息並且重複顯示.');
DEFINE ('_UDDEADM_IMPORT_HELP', '注意: 訊息可以一次匯入或是分批匯入. 當因為匯入太多訊息導致匯入失敗時分批匯入是需要的.');
DEFINE ('_UDDEADM_IMPORT_PARTIAL', '分批匯入:');
DEFINE ('_UDDEADM_UPDATEYOURDB', '重要: 您尚未更新您的資料庫! 請閱讀 README 裏的如何正確更新 uddeIM!');
DEFINE ('_UDDEADM_RESTRALLUSERS_HEAD', '限制 "所有使用者" 存取');
DEFINE ('_UDDEADM_RESTRALLUSERS_EXP', '您可以限制 "所有使用者" 清單的存取. 通常 "所有使用者" 清單是所有人都可用的 (<i>無限制</i>).');
DEFINE ('_UDDEADM_RESTRALLUSERS_0', '無限制');
DEFINE ('_UDDEADM_RESTRALLUSERS_1', '特定使用者');
DEFINE ('_UDDEADM_RESTRALLUSERS_2', '只限管理員');
DEFINE ('_UDDEIM_MESSAGE_UNARCHIVED', '訊息未保存.');
DEFINE ('_UDDEADM_AUTOFORWARD_SPECIAL', '特定使用者');
DEFINE ('_UDDEIM_HELP', '說明');
DEFINE ('_UDDEIM_HELP_HEADLINE1', 'uddeIM 說明');
DEFINE ('_UDDEIM_HELP_HEADLINE2', '所有功能的簡短概覽');
DEFINE ('_UDDEIM_HELP_INBOX', ' <b>收件匣</b> 存放您所有的內送訊息, 您所收到的每封訊息都在這裡.');
DEFINE ('_UDDEIM_HELP_OUTBOX', ' <b>寄件匣</b> 保留您所寄出每封訊息的備份, 您可以隨時回來看您所寄出的.');
DEFINE ('_UDDEIM_HELP_TRASHCAN', ' <b>垃圾桶</b> 保留所有刪除的訊息. 訊息未馬上被刪除並且保留一段時間. 只要訊息還在垃圾桶裡, 您都可以恢復它.');
DEFINE ('_UDDEIM_HELP_ARCHIVE', ' <b>保存匣</b> 保留您收件匣的訊息存檔. 您只能從您的收件匣存檔訊息. 當您需要保存您自己所寫的訊息, 當寄出時確認您已選<i>複製給我</i>.');
DEFINE ('_UDDEIM_HELP_USERLISTS', '<b>聯絡</b> 允許維護聯絡清單 (也就是所謂的分類清單). 此清單允許寄私人訊息給多位收件者. 用來替代增加多位收件者, 您只要簡單輸入 <i>#清單名稱</i>.');
DEFINE ('_UDDEIM_HELP_SETTINGS', '<b>設定</b> 包含所有可配置的使用者設定..');
DEFINE ('_UDDEIM_HELP_COMPOSE', '<b>撰寫</b> 允許建立一個新的私人訊息.');
DEFINE ('_UDDEIM_HELP_IREAD', '訊息已閱讀 (您可以切換狀態).');
DEFINE ('_UDDEIM_HELP_IUNREAD', '訊息尚未閱讀 (您可以切換狀態).');
DEFINE ('_UDDEIM_HELP_OREAD', '訊息已被閱讀.');
DEFINE ('_UDDEIM_HELP_OUNREAD', '訊息還是尚未閱讀. 尚未閱讀訊息可以被回收.');
DEFINE ('_UDDEIM_HELP_TREAD', '訊息已被閱讀.');
DEFINE ('_UDDEIM_HELP_TUNREAD', '訊息還是尚未閱讀.');
DEFINE ('_UDDEIM_HELP_FLAGGED', '訊息已被標示, e.g. 當它是重要的訊息 (您可以切換狀態).');
DEFINE ('_UDDEIM_HELP_UNFLAGGED', '<i>標準</i> 訊息 (您可以切換狀態).');
DEFINE ('_UDDEIM_HELP_ONLINE', '使用者目前在線上.');
DEFINE ('_UDDEIM_HELP_OFFLINE', '使用者目前不在線上.');
DEFINE ('_UDDEIM_HELP_DELETE', '刪除訊息 (移動訊息至垃圾桶).');
DEFINE ('_UDDEIM_HELP_FORWARD', '轉寄訊息至另一個收件者.');
DEFINE ('_UDDEIM_HELP_ARCHIVEMSG', '保存訊息. 保存的訊息將不會被自動刪除就算管理員設定了收件匣訊息的保留期限.');
DEFINE ('_UDDEIM_HELP_UNARCHIVEMSG', '取消訊息存檔. 訊息將移回收件匣.');
DEFINE ('_UDDEIM_HELP_RECALL', '召回訊息. 已寄出的訊息當還尚未被收件者閱讀之前都可以召回.');
DEFINE ('_UDDEIM_HELP_RECYCLE', '回收訊息 (從垃圾桶移動訊息至收件匣或是寄件匣).');
DEFINE ('_UDDEIM_HELP_NOTIFY', '當收到新訊息時寄出提醒 email 的組態.');
DEFINE ('_UDDEIM_HELP_AUTORESPONDER', '當啟用自動回覆時每封收到的訊息都將馬上回覆.');
DEFINE ('_UDDEIM_HELP_AUTOFORWARD', '新訊息可以自動轉寄給另一位收件者.');
DEFINE ('_UDDEIM_HELP_BLOCKING', '您可以封鎖使用者. 這些使用者無法寄私人訊息給您.');
DEFINE ('_UDDEIM_HELP_MISC', '這裡您可以找到更多的配置設定');
DEFINE ('_UDDEIM_HELP_FEED', '您可以使用 RSS feed 來存取收件匣.');
DEFINE ('_UDDEADM_SEPARATOR_HEAD', '分隔符號');
DEFINE ('_UDDEADM_SEPARATOR_EXP', '選擇分隔多位收件者之間的符號 (預設為 ",").');
DEFINE ('_UDDEADM_SEPARATOR_P0', '逗點 (預設)');
DEFINE ('_UDDEADM_SEPARATOR_P1', '分號');
DEFINE ('_UDDEADM_RSSLIMIT_HEAD', 'RSS 項目');
DEFINE ('_UDDEADM_RSSLIMIT_EXP', '限制回傳的 RSS 項目數目 (0 為無限制).');
DEFINE ('_UDDEADM_SHOWHELP_HEAD', '顯示說明按鈕');
DEFINE ('_UDDEADM_SHOWHELP_EXP', '啟用後將顯示說明按鈕.');
DEFINE ('_UDDEADM_SHOWIGOOGLE_HEAD', '顯示 iGoogle 小工具按鈕');
DEFINE ('_UDDEADM_SHOWIGOOGLE_EXP', '啟用後將在使用者偏好顯示一個 uddeIM iGoogle 小工具的<i>新增至 iGoogle</i>按鈕.');
DEFINE ('_UDDEADM_MOOTOOLS_NONE11', '不要載入 MooTools (1.1 已使用)');
DEFINE ('_UDDEADM_MOOTOOLS_NONE12', '不要載入 MooTools (1.2 已使用)');
DEFINE ('_UDDEIM_RSS_INTRO1', '您可以使用 RSS feed 來存取您的收件匣 (0.91). 存取 URL 為:');
DEFINE ('_UDDEIM_RSS_INTRO1B', 'The access URL is:');
DEFINE ('_UDDEIM_RSS_INTRO2', '不要給其他使用者此 URL 因為它允許存取您的收件匣.');
DEFINE ('_UDDEIM_RSS_FEED', 'RSS 訊息 Feed');
DEFINE ('_UDDEIM_RSS_NOOBJECT', '無物件錯誤...');
DEFINE ('_UDDEIM_RSS_USERBLOCKED', '使用者封鎖了...');
DEFINE ('_UDDEIM_RSS_NOTALLOWED', '不允許存取...');
DEFINE ('_UDDEIM_RSS_WRONGPASSWORD', '使用者名稱或密碼錯誤...');
DEFINE ('_UDDEIM_RSS_NOMESSAGES', '無訊息');
DEFINE ('_UDDEIM_RSS_NONEWMESSAGES', '無新訊息');
DEFINE ('_UDDEADM_ENABLERSS_HEAD', '啟用 RSS');
DEFINE ('_UDDEADM_ENABLERSS_EXP', '當啟用此選項, 訊息可以經由 RSS feed 接收. 使用者可以在個人資料找到必要的 URL.');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_3', '...設為預設給 RSS, iGoogle 及 說明');
DEFINE ('_UDDEADM_DELETEM_DELETING', '刪除訊息:');
DEFINE ('_UDDEADM_DELETEM_FROMUSER', '從使用者刪除訊息 ');
DEFINE ('_UDDEADM_DELETEM_MSGSSENT', '- 寄出訊息: ');
DEFINE ('_UDDEADM_DELETEM_MSGSRECV', '- 收到訊息: ');
DEFINE ('_UDDEIM_PMNAV_THISISARESPONSE', '這是一份回覆至:');
DEFINE ('_UDDEIM_PMNAV_THEREARERESPONSES', '回覆到此:');
DEFINE ('_UDDEIM_PMNAV_DELETED', '訊息不可用');
DEFINE ('_UDDEIM_PMNAV_EXISTS', '跳轉至訊息');
DEFINE ('_UDDEIM_PMNAV_COPY2ME', '(複製)');
DEFINE ('_UDDEADM_PMNAV_HEAD', '允許巡覽');
DEFINE ('_UDDEADM_PMNAV_EXP', '顯示巡覽工具列以允許經由討論串巡覽.');
DEFINE ('_UDDEADM_MAINTENANCE_ALLDAYS', '訊息:');
DEFINE ('_UDDEADM_MAINTENANCE_7DAYS', '7 天內訊息:');
DEFINE ('_UDDEADM_MAINTENANCE_30DAYS', '30 天內訊息:');
DEFINE ('_UDDEADM_MAINTENANCE_365DAYS', '365 天內訊息:');
DEFINE ('_UDDEADM_MAINTENANCE_HEAD1', '寄出提醒至 (勿忘我: %s 天):');
DEFINE ('_UDDEADM_MAINTENANCE_HEAD2', ' %s 天內寄出提醒至:');
DEFINE ('_UDDEADM_MAINTENANCE_NO', '無:');
DEFINE ('_UDDEADM_MAINTENANCE_USERID', '使用者 ID:');
DEFINE ('_UDDEADM_MAINTENANCE_TONAME', '名字:');
DEFINE ('_UDDEADM_MAINTENANCE_MID', '訊息 ID:');
DEFINE ('_UDDEADM_MAINTENANCE_WRITTEN', '寫作:');
DEFINE ('_UDDEADM_MAINTENANCE_TIMER', '計時器:');

// New: 1.5
DEFINE ('_UDDEMODULE_ALLDAYS', ' 個訊息');
DEFINE ('_UDDEMODULE_7DAYS', ' 個訊息在最近七天內');
DEFINE ('_UDDEMODULE_30DAYS', ' 個訊息在最近三十天內');
DEFINE ('_UDDEMODULE_365DAYS', ' 個訊息在最近一年');
DEFINE ('_UDDEADM_EMN_SENDERMAIL_WARNING', '<br /><b>注意:<br />當您使用 mosMail, 您必須設定一個有效的 email地址!</b>');
DEFINE ('_UDDEIM_FILTEREDMESSAGE', '訊息已篩選');
DEFINE ('_UDDEIM_FILTEREDMESSAGES', '訊息已篩選');
DEFINE ('_UDDEIM_FILTER', '篩選器:');
DEFINE ('_UDDEIM_FILTER_TITLE_INBOX', '只顯示從此使用者寄來的');
DEFINE ('_UDDEIM_FILTER_TITLE_OUTBOX', '只顯示寄至此使用者的');
DEFINE ('_UDDEIM_FILTER_UNREAD_ONLY', '只限未閱讀');
DEFINE ('_UDDEIM_FILTER_SUBMIT', '篩選器');
DEFINE ('_UDDEIM_FILTER_ALL', '- 全部 -');
DEFINE ('_UDDEIM_FILTER_PUBLIC', '- 公用使用者 -');
DEFINE ('_UDDEADM_FILTER_HEAD', '啟用篩選器');
DEFINE ('_UDDEADM_FILTER_EXP', '如果啟用使用者可以篩選他們的 收件/寄件匣 用以顯示相同一位收件者或是寄件者的訊息.');
DEFINE ('_UDDEADM_FILTER_P0', '已停用');
DEFINE ('_UDDEADM_FILTER_P1', '訊息清單以上');
DEFINE ('_UDDEADM_FILTER_P2', '訊息清單以下');
DEFINE ('_UDDEADM_FILTER_P3', '清單以上及以下');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED', '<b>您有 %s 個訊息在您的 %s.</b>');	// see next also six lines
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_UNREAD', ' 未讀');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_FROM', ' 由此使用者');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_TO', ' 到此使用者');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_INBOX', ' 收件匣');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_OUBOX', ' 寄件匣');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_ARCHIVE', ' 保存匣');
DEFINE ('_UDDEIM_TODP_TITLE', '收件人');
DEFINE ('_UDDEIM_TODP_TITLE_CC', '一位或更多的收件人 (逗號分開)');
DEFINE ('_UDDEIM_ADDCCINFO_TITLE', '當選取一行包含有所有收件人都將被新增至訊息.');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_2', '...設為預設給 自動回覆, 自動轉寄, 彈出式輸入方塊, 篩選器');
DEFINE ('_UDDEADM_AUTORESPONDER_HEAD', '啟用自動回覆');
DEFINE ('_UDDEADM_AUTORESPONDER_EXP', '當啟用自動回覆使用者可以在個人的使用者設定啟用自動回覆通知.');
DEFINE ('_UDDEIM_EMN_AUTORESPONDER', '啟用自動回覆');
DEFINE ('_UDDEIM_AUTORESPONDER', '自動回覆');
DEFINE ('_UDDEIM_AUTORESPONDER_EXP', '當啟用自動回覆每個收到的訊息都將馬上回覆.');
DEFINE ('_UDDEIM_AUTORESPONDER_DEFAULT', "抱歉, 我目前不在線上.\n我將盡快查看我的信件匣.");
DEFINE ('_UDDEADM_USERSET_AUTOR', '自動回');
DEFINE ('_UDDEADM_USERSET_SELAUTOR', '- 自動回 -');
DEFINE ('_UDDEIM_USERBLOCKED', '使用者已被封鎖.');
DEFINE ('_UDDEADM_AUTOFORWARD_HEAD', '啟用自動轉寄');
DEFINE ('_UDDEADM_AUTOFORWARD_EXP', '當啟用自動轉寄使用者可以自動轉寄新訊息給另一位使用者.');
DEFINE ('_UDDEIM_EMN_AUTOFORWARD', '啟用自動轉寄');
DEFINE ('_UDDEADM_USERSET_AUTOF', '自動轉');
DEFINE ('_UDDEADM_USERSET_SELAUTOF', '- 自動轉 -');
DEFINE ('_UDDEIM_AUTOFORWARD', '自動轉寄');
DEFINE ('_UDDEIM_AUTOFORWARD_EXP', '新訊息可以自動轉寄給另一位使用者.');
DEFINE ('_UDDEIM_THISISAFORWARD', '訊息自動轉寄至 ');
DEFINE ('_UDDEADM_COLSROWS_HEAD', '訊息方塊 (行/列)');
DEFINE ('_UDDEADM_COLSROWS_EXP', '指定訊息方塊的行及列 (預設值 60/10).');
DEFINE ('_UDDEADM_WIDTH_HEAD', '訊息方塊 (寬度)');
DEFINE ('_UDDEADM_WIDTH_EXP', '指定訊息方塊的寬度以像素 (預設為 0). 如果值為 0, 寬度是由 CSS style 來指定.');
DEFINE ('_UDDEADM_CBE', 'CB 加強的');

// New: 1.4
DEFINE ('_UDDEADM_IMPORT_CAPS', '匯入');
...
DEFINE ('_UDDEIM_COULDNOTRECALLPUBLIC', '無法召回給未註冊使用者的回覆.');
...
DEFINE ('_UDDEIM_WRONGCAPTCHA', '錯誤的安全碼');
...
DEFINE ('_UDDEADM_POPUP_EXP','當收到新訊息時彈出視窗');
...
DEFINE ('_UDDEADM_MAINTENANCE_MC2', "<i>#nnn (使用者名稱): [收件匣|已刪的收件匣|寄件匣|已刪的寄件匣]</i><br />");
...
DEFINE ('_UDDEADM_MAINTENANCE_MT3', "刪除使用者的封鎖");
...
DEFINE ('_UDDEIM_RECALLEDMESSAGE_INFO', '此訊息已被召回. 您現在可以編輯並且重寄.');
DEFINE ('_UDDEIM_COULDNOTRECALL', '訊息無法召回 (可能因為已經被閱讀或是抹除了.)');
DEFINE ('_UDDEIM_CANTRESTORE', '訊息回存還原失敗. (可能在垃圾筒太久已在之前被抹除了.)');
...
DEFINE ('_UDDEIM_RECALL', '召回');
DEFINE ('_UDDEIM_RECALLTHISMESSAGE', '召回此訊息');
...
DEFINE ('_UDDEADM_ADMINIGNITIONONLY_HEAD', '已運作刪除');
...
DEFINE ('_UDDEIM_SYSGM_PLEASECONFIRM', '您將寄出以下的訊息. 請再次瀏覽確認或是取消!');
...
DEFINE ('_UDDEIM_SYSGM_SHORTHELP', '使用 <b>只限系統訊息</b>:<br /> [b]<b>粗體</b>[/b] [i]<em>斜體</em>[/i]<br />[url=http://www.someurl.com]some url[/url] 或是 [url]http://www.someurl.com[/url] 為連結');
...
DEFINE ('_UDDEADM_SHOWCONNEX_HEAD', '顯示 連線');
DEFINE ('_UDDEADM_SHOWCONNEX_EXP', '使用 <b>是</b> 如果您有安裝 CB/CBE/JS 並且要在寫新訊息的頁面顯示使用者連線.');
