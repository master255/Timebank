...
// *******************************************************************
// Language file: Traducció al català 
// Translator:     el_libre (catmidia.cat),el_libre@gmail.com i Pablo Querol (aka Seikei), info@joomlacat.org
// *******************************************************************
DEFINE ('_UDDEADM_TRANSLATORS_CREDITS', 'Translated by Pablo Querol');	// Enter your credits line here, e.g. 'Translation by <a href="http://domain.com" target="_new">John Doe</a>'
...
DEFINE ('_UDDEIM_ACCOUNTLOCKED', 'L´accés a la teva bústia de missatges ha estat tancada. Si us plau contacta amb l´administrador de l´espai web.');
...
DEFINE ('_UDDEADM_CBBANNED_EXP', 'Quan s´activa uddeIM comprova si un usuari ha estat prohibit en el CB i no li permet l´accés a uddeIM. A més, altres usuaris no poden enviar missatges a un usuari prohibit.');
...
DEFINE ('_UDDEADM_MAINTENANCEDEL_EXP', 'Elimina els missatges esborrats de la base de dades. Això és el mateix que \'Suprimeix missatges ara\'al sistema de fitxes.');
DEFINE ('_UDDEADM_MAINTENANCEDEL_ERASE', 'ESBORRA');
DEFINE ('_UDDEADM_REPORTSPAM_HEAD', 'Informa sobre missatges enllaçats');
DEFINE ('_UDDEADM_REPORTSPAM_EXP', 'Quan s´activa mostra un \'Informe de missatge \'enllaçat que permet als usuaris informar sobre spam a l´administrador.');
...
DEFINE ('_UDDEADM_INFORMATION', 'Informació');
...
DEFINE ('_UDDEADM_TRASHORIGINALSENT_HEAD', 'Llença a la paperera el missatge un cop enviat');
DEFINE ('_UDDEADM_TRASHORIGINALSENT_EXP', 'Quan s´activa apareixerà una casella situada al costat del botó \'Enviar\' amb el nom de \'Llença a la paperera el missatge un cop enviat\' que no està activada per defecte. Els usuaris poden marcar la casella si volen enviar a la paperera un missatge immediatament després d´enviar-lo.');
DEFINE ('_UDDEIM_TRASHORIGINALSENT', 'Llença el missatge un cop enviat');
...
DEFINE ('_UDDEADM_VERSIONCHECK_IMPORTANT', 'Enllaços importants:');
DEFINE ('_UDDEADM_VERSIONCHECK_HOTFIX', 'Revisió');
DEFINE ('_UDDEADM_VERSIONCHECK_NONE', 'Cap');
DEFINE ('_UDDEADM_MAINTENANCEFIX_HEAD', "Manteniment de compatibilitat");
DEFINE ('_UDDEADM_MAINTENANCEFIX_EXP', "uddeIM utilitza dos arxius XML per garantir els paquets que es poden instal·lar en Joomla 1.0 i 1.5. Joomla 1.5 en un arxiu XML no és necessàri i això fa que el administrador d'extensions per mostrar una advertència d´incompatibilitat (que està malament). Això elimina els arxius innecessaris, per la qual cosa l'advertència no serà ja mostrada.");
...
DEFINE ('_UDDEADM_MAINTENANCE_XML2', "Això és necessari per poder instal·lar paquets en Joomla 1.0 i Joomla 1.5.<br />");
DEFINE ('_UDDEADM_MAINTENANCE_XML3', "Com que no és necessària després de la instal·lació, l'instal·lador de Joomla 1.0 pot ésser eliminat en els sistemes de Joomla 1.5.<br />");
DEFINE ('_UDDEADM_MAINTENANCE_XML4', "Això es farà per als següents paquets:<br />");
DEFINE ('_UDDEADM_MAINTENANCE_FXML1', "Els XML innecessaris per als instal·ladors d´uddeIM següents seran eliminats:<br />");
DEFINE ('_UDDEADM_MAINTENANCE_FXML2', "No són innecessaris els paquets XML instal·ladors per uddeIM trobats!!!<br />");
DEFINE ('_UDDEADM_SHOWMENUICONS1_HEAD', 'Apariència de la barra de menús');
DEFINE ('_UDDEADM_SHOWMENUICONS1_EXP', 'Aquí pots configurar si la barra de menú s´ha de mostrar amb icones i/o text.');
DEFINE ('_UDDEIM_MENUICONS_P1', 'Icones i text');
DEFINE ('_UDDEIM_MENUICONS_P2', 'Només icones');
DEFINE ('_UDDEIM_MENUICONS_P0', 'Només text');
DEFINE ('_UDDEIM_LISTSLIMIT_2', 'Màxim nombre de destinataris en una llista:');
DEFINE ('_UDDEADM_ADDEMAIL_ADMIN', 'Els administrador poden escollir');
DEFINE ('_UDDEAIM_ADDEMAIL_SELECT', 'Notificació amb el missatge');
DEFINE ('_UDDEAIM_ADDEMAIL_TITLE', 'Inclou el missatge complet al correu electrònic de notificació.');
...
DEFINE ('_UDDEIM_LISTGLOBAL_P2', 'Llista de contactes restringida (només els/les membres de la llista hi poden accedir)');
DEFINE ('_UDDEIM_TOOLBAR_USERSETTINGS', 'Configuració d`usuari/a');
DEFINE ('_UDDEIM_TOOLBAR_REMOVESETTINGS', 'Esborra configuració');
DEFINE ('_UDDEIM_TOOLBAR_CREATESETTINGS', 'Crea configuració');
...
DEFINE ('_UDDEIM_CBPLUG_NOWUNBLOCKED', 'L`usuari/a ja no està bloquejat.');
DEFINE ('_UDDEADM_PARTIALIMPORTDONE', 'La importació de missatges privats antics ha estat acabada.No importis aquesta part perquè fent-ho repetiràs els missatges.');
DEFINE ('_UDDEADM_IMPORT_HELP', 'Nota: Els missatges poden ser importats de cop o per parts.Importar en part és requerit en cas que hi hagi tants missatges que la importació automàtica no funcioni.');
DEFINE ('_UDDEADM_IMPORT_PARTIAL', 'Importació parcial:');
...
DEFINE ('_UDDEADM_RESTRALLUSERS_HEAD', 'Restringeix l`accès a "Tots els usuaris"');
DEFINE ('_UDDEADM_RESTRALLUSERS_EXP', 'Pots restringir l`accès a la llista de " Tots els usuaris/es". Normalment la llista de "Tots els usuaris/es" permet accedir a tothom (<i>sense restriccions</i>).');
DEFINE ('_UDDEADM_RESTRALLUSERS_0', 'sense restriccions');
DEFINE ('_UDDEADM_RESTRALLUSERS_1', 'usuaris/es especials');
DEFINE ('_UDDEADM_RESTRALLUSERS_2', 'administrdors/es només');
...
DEFINE ('_UDDEIM_HELP_HEADLINE2', 'Breu revisió de totes les opcions');
DEFINE ('_UDDEIM_HELP_INBOX', 'La <b> Safata d`Entrada </b> té tots els missatges que arriben, cada mail que reps es diposita allà.');
DEFINE ('_UDDEIM_HELP_OUTBOX', 'La <b> Safata de Sortida </b> guarda una còpia de cada missatge que envies, pots tornar-hi en qualsevol moment i veure què has enviat.');
DEFINE ('_UDDEIM_HELP_TRASHCAN', 'La <b> Paperera </b> reté tots els missatges esborrats. Els Missatges no s`esborren immediatament, es guarden per un període de temps. Mentre el missatge estigui a la paperera, el podràs recuperar.' );
DEFINE ('_UDDEIM_HELP_ARCHIVE', 'L`<b>Arxiu </b> té tots els missatges arxivats de la safata d`entrada. Només pots arxivar missatges de la vostra safata d`entrada. Quan necessites arxivar un missatge teu, assegura`t que has seleccionat <i> Copia </i> quan ho fas. ');
DEFINE ('_UDDEIM_HELP_USERLISTS', '<b> Contactes </b> permet gestionar llistes de contactes (també conegudes com les llistes de correu). Aquestes llistes permeten enviar missatges a múltiples destinataris. En lloc d`afegir múltiples destinataris, simplement pots ingressar <i> # nombre_de_la_lista </i>.');
DEFINE ('_UDDEIM_HELP_SETTINGS', '<b> Configuració </b> comprèn totes les opcions configurables per l`usuari/a');
...
DEFINE ('_UDDEIM_HELP_IUNREAD', 'El missatge està encara sense llegir (pots canviar aquest estat ).');
DEFINE ('_UDDEIM_HELP_OREAD', 'El missatge va ser llegit.');
DEFINE ('_UDDEIM_HELP_OUNREAD', 'El missatge està encara sense llegir. Els missatges no llegits poden ser recuperats.');
DEFINE ('_UDDEIM_HELP_TREAD', 'El missatge va ser llegit.');
DEFINE ('_UDDEIM_HELP_TUNREAD', 'El missatge està encara sense llegir.');
...
DEFINE ('_UDDEIM_HELP_ONLINE', 'L`usuari/a està actualment connectat.');
DEFINE ('_UDDEIM_HELP_OFFLINE', 'L`usuari/a està actualment desconnectat.');
...
DEFINE ('_UDDEIM_HELP_ARCHIVEMSG', 'Arxiva un missatge. Els missatges arxivats no seran esborrats automàticament quan l`administrador/a hagi configurat un temps límit per als missatges a la safata d`entrada.');
DEFINE ('_UDDEIM_HELP_UNARCHIVEMSG', 'Desarxivar un missatge. El missatge serà mogut novament a la safata d`entrada.');
DEFINE ('_UDDEIM_HELP_RECALL', 'Restauració d`un missatge. Els missatges enviats poden ser recuperats quan no han estat llegits encara pel destinatari/a.');
...
DEFINE ('_UDDEIM_HELP_NOTIFY', 'Configuració de notificació per e-mail quan t`arriba un nou missatge');
DEFINE ('_UDDEIM_HELP_AUTORESPONDER', 'Quan la resposta automàtica està habilitada, cada missatge rebut és respost automàticament.');
DEFINE ('_UDDEIM_HELP_AUTOFORWARD', 'Els nous missatges poden enviar-se a un altre usuari/a automàticament.');
DEFINE ('_UDDEIM_HELP_BLOCKING', 'Pots bloquejar usuaris/es. Aquests usuaris/es no poden enviar missatges privats.');
DEFINE ('_UDDEIM_HELP_MISC', 'Aquí trobaràs algunes opcions addicionals de configuració');
...
DEFINE ('_UDDEADM_SEPARATOR_EXP', 'El separador utilitzat per a múltiples destinataris (per defecte és ",").');
...
DEFINE ('_UDDEADM_RSSLIMIT_EXP', 'mantenir el nombre d`ítems RSS (0: sense límit ).');
DEFINE ('_UDDEADM_SHOWHELP_HEAD', 'Mostra botó d`ajuda');
DEFINE ('_UDDEADM_SHOWHELP_EXP', 'Quan està habilitada mostra un botó d`ajuda.');
DEFINE ('_UDDEADM_SHOWIGOOGLE_HEAD', 'Mostra el botó d`iGoogle');
DEFINE ('_UDDEADM_SHOWIGOOGLE_EXP', 'Quan està habilitada el botó <i> Afegir a iGoogle </i> del gadget d`uddeIM per iGoogle gadget apareix entre les preferències de l`usuari/a');
...
DEFINE ('_UDDEIM_RSS_INTRO1B', 'L`Adreça URL d`accés és:');
DEFINE ('_UDDEIM_RSS_INTRO2', 'No donis aquesta adreça URL a altres usuaris perquè permet que accedeixin a la teva safata d`entrada.');
...
DEFINE ('_UDDEIM_RSS_NOTALLOWED', 'Accés no permès ...');
...
DEFINE ('_UDDEADM_ENABLERSS_EXP', 'Quan aquesta opció està habilitada, els missatges es poden rebre a través d`una sindicació RSS. Els usuaris/es trobaran l`adreça URL requerida en els seus perfils.');
...
DEFINE ('_UDDEIM_PMNAV_THISISARESPONSE', 'Aquesta és una resposta a:');
DEFINE ('_UDDEIM_PMNAV_THEREARERESPONSES', 'Respostes a això:');
...
DEFINE ('_UDDEADM_PMNAV_HEAD', 'Permetre navegació');
DEFINE ('_UDDEADM_PMNAV_EXP', 'Mostra una barra de navegació que permet navegar a través de les converses.');
...
DEFINE ('_UDDEADM_MAINTENANCE_TIMER', 'Cronòmetre:');

// New: 1.5
DEFINE ('_UDDEMODULE_ALLDAYS', 'missatges');
DEFINE ('_UDDEMODULE_7DAYS', 'missatges en els darrers 7 dies');
DEFINE ('_UDDEMODULE_30DAYS', 'missatges en els últims 30 dies');
DEFINE ('_UDDEMODULE_365DAYS', 'missatges en els darrers 365 dies');
DEFINE ('_UDDEADM_EMN_SENDERMAIL_WARNING', '<br/> <b> Nota: <br/> Quan s`usa mosMail, s`ha de configurar una adreça electrònica vàlida!! </B>');
...
DEFINE ('_UDDEIM_FILTER_UNREAD_ONLY', 'només els missatges no llegits');
DEFINE ('_UDDEIM_FILTER_SUBMIT', 'Filtra');
DEFINE ('_UDDEIM_FILTER_ALL', '- tots -');
DEFINE ('_UDDEIM_FILTER_PUBLIC', '- usuaris/es públics -');
DEFINE ('_UDDEADM_FILTER_HEAD', 'Habilita Filtre');
DEFINE ('_UDDEADM_FILTER_EXP', 'els usuaris habilitats poden filtrar la seva safata per mostrar només un destinatari/a o receptor.');
...
DEFINE ('_UDDEIM_TODP_TITLE_CC', 'Un o més destinataris/es (separats per comes)');
DEFINE ('_UDDEIM_ADDCCINFO_TITLE', 'Quan es marca, s`agrega una línia al missatge amb tots els destinataris.');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_2', '... opcions per defecte de resposta automàtica, auto-enviament, quadre d`entrada, filtre');
DEFINE ('_UDDEADM_AUTORESPONDER_HEAD', 'Habilita resposta automàtica');
DEFINE ('_UDDEADM_AUTORESPONDER_EXP', 'Quan la resposta automàtica està habilitada, a l`usuari/a li apareix l`opció d`habilitar un missatge de resposta automàtica a les seves opcions personals.');
DEFINE ('_UDDEIM_EMN_AUTORESPONDER', 'Habilita resposta automàtica');
DEFINE ('_UDDEIM_AUTORESPONDER', 'Resposta automàtica');
DEFINE ('_UDDEIM_AUTORESPONDER_EXP', 'Quan la resposta automàtica està habilitada cada missatge rebut es respon automàticament.');
DEFINE ('_UDDEIM_AUTORESPONDER_DEFAULT', "Les meves disculpes, però ara no estic disponible. Llegiré els missatges tan aviat com pugui.");
...
DEFINE ('_UDDEADM_AUTOFORWARD_EXP', 'Quan l`auto-enviament està habilitat, l`usuari/a pot enviar els nous missatges a un altre usuari/a automàticament.');
...
DEFINE ('_UDDEIM_AUTOFORWARD_EXP', 'Els nous missatges poden enviar-se a un altre usuari/a automàticament.');
...
DEFINE ('_UDDEADM_COLSROWS_EXP', 'Això especifica les columnes i files del quadre on s`escriuen els missatges (normalment és 60/10 ).');
DEFINE ('_UDDEADM_WIDTH_HEAD', 'Quadre de missatge (ample)');
DEFINE ('_UDDEADM_WIDTH_EXP', 'Això especifica l`amplada del quadre de missatges en píxels (per defecte és 0). Si és 0, l`amplada es pren del full d`estils (CSS ).');
...
DEFINE ('_UDDEADM_MOOTOOLS_EXP', 'Això especifica com uddeIM carrega MooTools (MooTools és requerit per l`Autocompletador): <i>No</i> és útil quan la teva plantilla fa servir MooTools, <i>Auto</i> és el recomanable (igual que a uddeIM 1.2), quan es fa servir J1.0 també pots forçar la càrrega de MooTools 1.1 or 1.2.');
DEFINE ('_UDDEADM_MOOTOOLS_NONE', 'no carreguis MooTools');
DEFINE ('_UDDEADM_MOOTOOLS_AUTO', 'auto');
DEFINE ('_UDDEADM_MOOTOOLS_1', 'forçant la càrrega de 1.1');
DEFINE ('_UDDEADM_MOOTOOLS_2', 'forçant la càrrega de MooTools 1.2');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_1', '...carregant per defecte MooTools');
DEFINE ('_UDDEADM_AGORA', 'Àgora');

// New: 1.2
DEFINE ('_UDDEADM_CRYPT3', 'codificat en Base64');
DEFINE ('_UDDEADM_TIMEZONE_HEAD', 'Ajusta zona temporal');
DEFINE ('_UDDEADM_TIMEZONE_EXP', 'Quan uddeIM mostra l`hora de forma incorrecta pots ajustar la zona horària aquí. Normalment, quan tot és configurat correctament, aquest valor hauria de ser zero. No obstant això hi podria haver casos en que necessitesis canviar aquest valor.');
DEFINE ('_UDDEADM_HOURS', 'hores');
DEFINE ('_UDDEADM_VERSIONCHECK', 'Informació de la Versió:');
DEFINE ('_UDDEADM_STATISTICS', 'Estadístiques:');
DEFINE ('_UDDEADM_STATISTICS_HEAD', 'Veure Estadístiques');
DEFINE ('_UDDEADM_STATISTICS_EXP', 'Això mostra algunes estadístiques com el nombre de missatges enregistrats, etc.');
DEFINE ('_UDDEADM_STATISTICS_CHECK', 'VEURE ESTADÍSTIQUES');
DEFINE ('_UDDEADM_MAINTENANCE_COUNT', 'Missatges enregistrats a la base de dades: ');
DEFINE ('_UDDEADM_MAINTENANCE_COUNT_RECIPIENT', 'Missatges llençats pel destinatari: ');
DEFINE ('_UDDEADM_MAINTENANCE_COUNT_SENDER', 'Missatges llençats per emissor: ');
DEFINE ('_UDDEADM_MAINTENANCE_COUNT_TRASH', 'Missatges destinats a la purga: ');
DEFINE ('_UDDEADM_OVERWRITEITEMID_HEAD', 'Sobreescriure ID de l`Ítem');
DEFINE ('_UDDEADM_OVERWRITEITEMID_EXP', 'Normalment uddeIM prova detectar corregir l`ID de l`Ítem quan no en té. En alguns cassos serà necessari sobreescriure aquest valor, ex. quan tens molts enllaços de menú cap a uddeIM.');
DEFINE ('_UDDEADM_OVERWRITEITEMID_CURRENT', 'ID de l`Ítem Detectada : ');
DEFINE ('_UDDEADM_USEITEMID_HEAD', 'Usa ID de l`Ítem');
DEFINE ('_UDDEADM_USEITEMID_EXP', 'Usa aquesta ID de l`Ítem en comptes de la que es trobi.');
DEFINE ('_UDDEADM_SHOWLINK_HEAD', 'Usa enllaços de perfil');
DEFINE ('_UDDEADM_SHOWLINK_EXP', 'Si actives <i>sí</i> tots els noms d`usuari/a seran enllaços cap al seu perfil.');
DEFINE ('_UDDEADM_SHOWPIC_HEAD', 'Mostra miniatures');
DEFINE ('_UDDEADM_SHOWPIC_EXP', 'Si actives <i>sí</i> la miniatura del perfil es mostrarà en llegir un missatge.');
DEFINE ('_UDDEADM_THUMBLISTS_HEAD', 'Mostra miniatures a les llistes');
DEFINE ('_UDDEADM_THUMBLISTS_EXP', 'Si actives <i>sí</i> es mostraran les miniatures en llistes (safata d`entrada, etc.)');
...
DEFINE ('_UDDEADM_REVIEWUPDATE', 'Important: Quan actualitzis uddeIM , si us plau llegeix l`arxiu README. És probable que hagis d`afegir o alterar alguna taula o camp.');
DEFINE ('_UDDEIM_ADDCCINFO', 'Afegeix la línia CC:');
DEFINE ('_UDDEIM_CC', 'CC:');
DEFINE ('_UDDEADM_TRUNCATE_HEAD', 'Trunca el text entre cometes (citat)');
DEFINE ('_UDDEADM_TRUNCATE_EXP', 'Trunca el text a 2/3 del màxim de la llargada del text si es sobrepassa del límit.');
...
// New: 1.1 fins aquí la traducció de joomlacat.org - - corregida i adaptada a les noves versions per el_libre  - - www.catmidia.cat
DEFINE ('_UDDEADM_NOTRASHACCESS_NOT', 'No es permet l`accés a la paperera.');
DEFINE ('_UDDEADM_NOTRASHACCESS_HEAD', 'Restringeix l`accés a la paperera');
DEFINE ('_UDDEADM_NOTRASHACCESS_EXP', 'Pots restringir l`accés a la paperera. Normalment és accessible per a tothom (<i>sense restriccions</i>). Pots restringir-ne l`accés a usuaris/es especials o només administradors, així grups amb menys privilegis d`accés no podran reciclar un missatge.');
DEFINE ('_UDDEADM_NOTRASHACCESS_0', 'sense restriccions');
DEFINE ('_UDDEADM_NOTRASHACCESS_1', 'usuaris/es especials');
DEFINE ('_UDDEADM_NOTRASHACCESS_2', 'només administradors/es');
DEFINE ('_UDDEADM_PUBHIDEUSERS_HEAD', 'Amaga usuaris/es de la llista d`usuaris/es pública');
DEFINE ('_UDDEADM_PUBHIDEUSERS_EXP', 'Introdueix els IDs dels usuaris/es que haurien d`ocultar-se de la llista pública d`usuaris/es (e.g. 65,66,67).');
...
DEFINE ('_UDDEADM_CSRFPROTECTION_HEAD', 'Protecció CSRF');
DEFINE ('_UDDEADM_CSRFPROTECTION_EXP', 'Això protegeix de tots els formularis contra atacs Cross-Site Request Forgery. Normalment això hauria d`estar habilitat. Desactiveu-ho només quan tingueu problemes estranys.');
DEFINE ('_UDDEIM_CANTREPLYARCHIVE', 'No podeu contestar missatges arxivats.');
DEFINE ('_UDDEIM_COULDNOTRECALLPUBLIC', 'Les rèpliques a usuaris/es no registrats no es poden tornar a cridar.');
DEFINE ('_UDDEADM_PUBREPLYS_HEAD', 'Permet rèpliques');
DEFINE ('_UDDEADM_PUBREPLYS_EXP', 'Permet respostes directes a missatges d`usuaris/es públics.');
DEFINE ('_UDDEIM_EMN_BODY_PUBLICWITHMESSAGE', "Hola %user%,\n\n%you% us ha enviat el següent missatge privat a %site%.\n__________________\n%pmessage%");
...
DEFINE ('_UDDEADM_USERSET_LASTSENT', 'Últim enviat');
...
DEFINE ('_UDDEIM_ERRORINEMAIL', 'Error en l`adreça de correu electrònic');
...
DEFINE ('_UDDEADM_VERSIONCHECK_LATEST', 'Ja teniu la última versió de uddeIM.');
DEFINE ('_UDDEADM_VERSIONCHECK_CURRENT', 'La versió actual és ');
DEFINE ('_UDDEADM_VERSIONCHECK_INFO', 'Informació de l`actualització:');
DEFINE ('_UDDEADM_VERSIONCHECK_HEAD', 'Comprova les actualitzacions');
DEFINE ('_UDDEADM_VERSIONCHECK_EXP', 'Contacta la pàgina del desenvolupador del uddeIM per a rebre informació sobre l`última versió del uddeIM.');
DEFINE ('_UDDEADM_VERSIONCHECK_CHECK', 'COMPROVA ARA');
DEFINE ('_UDDEADM_VERSIONCHECK_ERROR', 'No s`ha pogut rebre informació de la versió.');
DEFINE ('_UDDEIM_NOSUCHLIST', 'No s`ha trobat la llista de contactes!');
DEFINE ('_UDDEIM_LISTSLIMIT_1', 'S`ha excedit el nombre màxim de contactes (max. ');
DEFINE ('_UDDEADM_MAXONLISTS_HEAD', 'Nombre màxim d`entrades');
DEFINE ('_UDDEADM_MAXONLISTS_EXP', 'Nombre màxim d`entrades permeses per llista de contactes');
...
DEFINE ('_UDDEADM_ENABLELISTS_EXP', 'L`uddeIM permet als usuaris/es crear llistes de contactes. Aquestes llistes poden ser utilitzades per a enviar missatges a múltiples usuaris. No us oblideu d`habilitar els múltiples destinataris per a utilitzar aquesta funció.');
...
DEFINE ('_UDDEADM_ENABLELISTS_3', 'només administradors');
...
DEFINE ('_UDDEIM_LISTSDESC', 'Descripció');
...
DEFINE ('_UDDEIM_STATUS_ONLINE', 'en línia');
DEFINE ('_UDDEIM_STATUS_OFFLINE', 'fora de línia');
DEFINE ('_UDDEADM_CBGALLERY_HEAD', 'Mostra imatges del CB');
DEFINE ('_UDDEADM_CBGALLERY_EXP', 'Per defecte l`uddeIM només mostra els avatars que els usuaris/es han pujat. Habilitant això, l`uddeIM també mostrarà les imatges de la galeria del Community Builder.');
DEFINE ('_UDDEADM_UNBLOCKCB_HEAD', 'Desbloqueja connexions del CB');
DEFINE ('_UDDEADM_UNBLOCKCB_EXP', 'Pots enviar missatges a destinataris quan un usuari/a registrat és a la llista de destinataris de les connexions del CB (encara que el destinatari estigui en un grup bloquejat). Aquesta opció és independent del bloqueig individual d`usuaris/es (vegeu les opcions de sota).');
DEFINE ('_UDDEIM_GROUPBLOCKED', 'No podeu enviar missatges a aquest grup.');
DEFINE ('_UDDEIM_ONEUSERBLOCKS', 'El destinatari us està blocant.');
DEFINE ('_UDDEADM_BLOCKGROUPS_HEAD', 'Grups bloquejats (usuaris/es registrats)');
DEFINE ('_UDDEADM_BLOCKGROUPS_EXP', 'Grups als quals els usuaris/es registrats no poden enviar missatges. Només per a usuaris/es registrats; no afecta a usuaris/es especials ni administradors. Aquesta opció és independent del bloqueig individual que cada usuari/a pot configurar (vegeu les opcions de sobre).');
DEFINE ('_UDDEADM_PUBBLOCKGROUPS_HEAD', 'Grups bloquejats (usuaris/es públics)');
DEFINE ('_UDDEADM_PUBBLOCKGROUPS_EXP', 'Grups als quals els usuaris/es públics no poden enviar missatges. Aquesta opció és independent del bloqueig individual que cada usuari/a pot configurar (vegeu les opcions de sobre). Quan bloquegeu un grup, els usuaris/es d`aquest grup no poden veure la opció d`habilitar la portada pública en la seva configuració.');
DEFINE ('_UDDEADM_BLOCKGROUPS_1', 'Usuari/a públic');
DEFINE ('_UDDEADM_BLOCKGROUPS_2', 'Connexió del CB');
...
DEFINE ('_UDDEIM_NOPUBLICMSG', 'L`usuari/a només accepta missatges d`usuaris/es registrats.');
DEFINE ('_UDDEADM_PUBHIDEALLUSERS_HEAD', 'Amaga de la llista pública "tots els usuaris"');
DEFINE ('_UDDEADM_PUBHIDEALLUSERS_EXP', 'Pots amagar alguns grups de la llista pública "tots els usuaris". Avís: només amaga els noms, els usuaris/es encara poden rebre missatges. Els usuaris/es que no habilitin la portada pública mai seran llistats aquí.');
DEFINE ('_UDDEADM_HIDEALLUSERS_HEAD', 'Amaga de la llista "tots els usuaris"');
DEFINE ('_UDDEADM_HIDEALLUSERS_EXP', 'Pots amagar alguns grups de la llista "tots els usuaris". Avís: només amaga els noms, els usuaris/es encara poden rebre missatges.');
DEFINE ('_UDDEADM_HIDEALLUSERS_0', 'cap');
DEFINE ('_UDDEADM_HIDEALLUSERS_1', 'només superadministradors');
DEFINE ('_UDDEADM_HIDEALLUSERS_2', 'només administradors');
DEFINE ('_UDDEADM_HIDEALLUSERS_3', 'usuaris/es especials');
DEFINE ('_UDDEADM_PUBLIC', 'Públic');
DEFINE ('_UDDEADM_PUBMODESHOWALLUSERS_HEAD', 'Comportament de l`enllaç "tots els usuaris"');
DEFINE ('_UDDEADM_PUBMODESHOWALLUSERS_EXP', 'Tria si l`enllaç "tots els usuaris" s`ha d`eliminar en la portada pública, si s`ha de mostrar, o si mostrar sempre tots els usuaris.');
DEFINE ('_UDDEADM_USERSET_PUBLIC', 'Portada pública');
DEFINE ('_UDDEADM_USERSET_SELPUBLIC', '- tria públic -');
DEFINE ('_UDDEIM_OPTIONS_F', 'Permet als usuaris/es públics enviar missatges');
DEFINE ('_UDDEIM_MSGLIMITREACHED', 'S`ha arribat al límit de missatges!');
DEFINE ('_UDDEIM_PUBLICUSER', 'usuari/a públic');
DEFINE ('_UDDEIM_DELETEDUSER', 'usuari/a eliminat');
DEFINE ('_UDDEADM_CAPTCHALEN_HEAD', 'Longitud del captcha');
DEFINE ('_UDDEADM_CAPTCHALEN_EXP', 'Especifica quants caràcters ha d`introduir un usuari/a');
DEFINE ('_UDDEADM_USECAPTCHA_HEAD', 'Protecció Captcha');
...
DEFINE ('_UDDEADM_CAPTCHAF1', 'només usuaris/es públics');
DEFINE ('_UDDEADM_CAPTCHAF2', 'usuaris/es públics i registrats');
DEFINE ('_UDDEADM_CAPTCHAF3', 'usuaris/es públics, registrats i especials');
DEFINE ('_UDDEADM_CAPTCHAF4', 'tots els usuaris/es (incl. administradors)');
DEFINE ('_UDDEADM_PUBFRONTEND_HEAD', 'Habilita portada pública');
DEFINE ('_UDDEADM_PUBFRONTEND_EXP', 'Quan està habilitat els usuaris/es públics poden enviar missatges als usuaris/es registrats (aquests poden especificar a la seva configuració personal si volen utilitzar aquesta funció).');
DEFINE ('_UDDEADM_PUBFRONTENDDEF_HEAD', 'Portada pública per defecte');
DEFINE ('_UDDEADM_PUBFRONTENDDEF_EXP', 'Aquest és el valor per defecte del paràmetre si un usuari/a públic té permís per a enviar missatges a usuaris/es registrats.');
...
DEFINE ('_UDDEADM_DONATE', 'Si us agrada uddeIM o voleu donar suport al desenvolupament si us plau feu una petita donació.');
// New: 1.0rc2
DEFINE ('_UDDEADM_BACKUPRESTORE_DATE', 'Configuració trobada a la base de dades: ');
DEFINE ('_UDDEADM_BACKUPRESTORE_HEAD', 'Copia i restaura la configuració');
DEFINE ('_UDDEADM_BACKUPRESTORE_EXP', 'Pots fer còpia de seguretat de la configuració a la base de dades i restaurar-la quan sigui necessari. Això és útil per a actualitzar l`uddeIM o quan heu de desar una certa configuració per a fer proves.');
DEFINE ('_UDDEADM_BACKUPRESTORE_BACKUP', 'COPIA');
DEFINE ('_UDDEADM_BACKUPRESTORE_RESTORE', 'RESTAURA');
DEFINE ('_UDDEADM_CANCEL', 'Cancel·la');
// New: 1.0rc1
DEFINE ('_UDDEADM_LANGUAGECHARSET_HEAD', 'Codificació del fitxer d`idioma');
DEFINE ('_UDDEADM_LANGUAGECHARSET_EXP', 'Normalment el valor per <strong>defecte</strong> (ISO-8859-1) és correcte per a Joomla! 1.0 i  <strong>UTF-8</strong> per a Joomla! 1.5.');
DEFINE ('_UDDEADM_LANGUAGECHARSET_UTF8', 'UTF-8');
DEFINE ('_UDDEADM_LANGUAGECHARSET_DEFAULT', 'defecte');
DEFINE ('_UDDEIM_READ_INFO_1', 'Els missatges llegits estaran a la bústia d`entrada durant ');
DEFINE ('_UDDEIM_READ_INFO_2', ' dies abans d`ésser esborrats automàticament.');
DEFINE ('_UDDEIM_UNREAD_INFO_1', 'Els missatges NO llegits estaran a la bústia d`entrada durant ');
DEFINE ('_UDDEIM_UNREAD_INFO_2', ' dies abans d`ésser esborrats automàticament.');
DEFINE ('_UDDEIM_SENT_INFO_1', 'Els missatges enviats estaran a la bústia de sortida durant ');
DEFINE ('_UDDEIM_SENT_INFO_2', ' dies abans de ser esborrats automàticament.');
DEFINE ('_UDDEADM_DELETEREADAFTERNOTE_HEAD', 'Mostra avís a la bústia d`entrada per als missatges llegits');
DEFINE ('_UDDEADM_DELETEREADAFTERNOTE_EXP', 'Mostra l`avís "Els missatges llegits seran esborrats després de n dies" a la bústia d`entrada');
DEFINE ('_UDDEADM_DELETEUNREADAFTERNOTE_HEAD', 'Mostra avís a la bústia d`entrada per als missatges no llegits');
DEFINE ('_UDDEADM_DELETEUNREADAFTERNOTE_EXP', 'Mostra l`avís "Els missatges no llegits seran esborrats després de n dies" a la bústia d`entrada');
DEFINE ('_UDDEADM_DELETESENTAFTERNOTE_HEAD', 'Mostra avís a la bústia de sortida per als missatges enviats');
DEFINE ('_UDDEADM_DELETESENTAFTERNOTE_EXP', 'Mostra l`avís "Els missatges enviats seran esborrats després de n dies" a la bústia de sortida');
DEFINE ('_UDDEADM_DELETETRASHAFTERNOTE_HEAD', 'Mostra avís a la paperera per als missatges esborrats');
DEFINE ('_UDDEADM_DELETETRASHAFTERNOTE_EXP', 'Mostra l`avís "Els missatges esborrats seran purgats després de n dies" a la paperera');
DEFINE ('_UDDEADM_DELETESENTAFTER_HEAD', 'Els missatges enviats es conserven (dies)');
DEFINE ('_UDDEADM_DELETESENTAFTER_EXP', 'Introdueix el nombre de dies abans que s`eliminin els missatges <b>enviats</b> de la bústia de sortida.');
...
DEFINE ('_UDDEADM_USERSET_EDITSETTINGS', 'Edita la configuració d`usuari');
...
DEFINE ('_UDDEADM_USERSET_SELNOTIFICATION', '- trieu una notificació -');
...
DEFINE ('_UDDEADM_USERSET_NOTIFICATION', 'Notificació');
DEFINE ('_UDDEADM_USERSET_POPUP', 'Finestra emergent');
DEFINE ('_UDDEADM_USERSET_LASTACCESS', 'Últim accés');
DEFINE ('_UDDEADM_USERSET_NO', 'No');
DEFINE ('_UDDEADM_USERSET_YES', 'Sí');
DEFINE ('_UDDEADM_USERSET_UNKNOWN', 'desconegut');
DEFINE ('_UDDEADM_USERSET_WHENOFFLINEEXCEPT', 'Quan estigui fora de línia (excepte respostes)');
DEFINE ('_UDDEADM_USERSET_ALWAYSEXCEPT', 'Sempre (excepte respostes)');
DEFINE ('_UDDEADM_USERSET_WHENOFFLINE', 'Quan estigui fora de línia');
DEFINE ('_UDDEADM_USERSET_ALWAYS', 'Sempre');
DEFINE ('_UDDEADM_USERSET_NONOTIFICATION', 'Cap notificació');
DEFINE ('_UDDEADM_WELCOMEMSG', "Benvinguts a l`uddeIM!\n\nL`heu instal·lat correctament.\n\nProveu de veure aquest missatge amb diverses plantilles. Pots establir-les al panell de configuració de l`uddeIM.\n\nL`uddeIM és un projecte en desenvolupament. Si trobeu errors o mancances, informeu-ne a l`autor per tal que tots poguem fer un uddeIM millor.\n\nQue el disfruteu!");
DEFINE ('_UDDEADM_UDDEINSTCOMPLETE', 'Instal·lació de l`uddeIM completada.');
DEFINE ('_UDDEADM_REVIEWSETTINGS', 'Si us plau aneu al panell d`administració i comproveu la configuració.');
DEFINE ('_UDDEADM_REVIEWLANG', 'Si esteu utilitzant un joc de caràcters diferent al ISO 8859-1 configureu-ho correctament.');
DEFINE ('_UDDEADM_REVIEWEMAILSTOP', 'Després de la instal·lació, tot el tràfic de correu electrònic de l`uddeIM (notificacions) està deshabilitat, per tal que no s`enviïn missatges mentre feu proves. No us oblideu d`inhabilitar "atura els correus" a la configuració quan acabeu.');
DEFINE ('_UDDEADM_MAXRECIPIENTS_HEAD', 'Destinataris màx.');
DEFINE ('_UDDEADM_MAXRECIPIENTS_EXP', 'Nombre màxim de destinataris que es permeten per missatge (0=sense limitació)');
DEFINE ('_UDDEIM_TOOMANYRECIPIENTS', 'masses destinataris');
DEFINE ('_UDDEIM_STOPPEDEMAIL', 'L`enviament de correus electrònic està deshabilitat.');
DEFINE ('_UDDEADM_SEARCHINSTRING_HEAD', 'Cerca interna de text');
DEFINE ('_UDDEADM_SEARCHINSTRING_EXP', 'Autocompleta cerques dins del text (en comptes de cercar només des del principi)');
DEFINE ('_UDDEADM_MODESHOWALLUSERS_HEAD', 'Comportament de l`enllaç "Tots els usuaris"');
DEFINE ('_UDDEADM_MODESHOWALLUSERS_EXP', 'Tria si l`enllaç "Tots els usuaris" s`ha de mostrar o no, i si sempre s`han de mostrar tots els usuaris.');
DEFINE ('_UDDEADM_MODESHOWALLUSERS_0', 'Amaga l`enllaç "Tots els usuaris"');
DEFINE ('_UDDEADM_MODESHOWALLUSERS_1', 'Mostra l`enllaç "Tots els usuaris"');
DEFINE ('_UDDEADM_MODESHOWALLUSERS_2', 'Mostra sempre tots els usuaris');
DEFINE ('_UDDEADM_CONFIGNOTWRITEABLE', 'No es pot escriure a la configuració:');
DEFINE ('_UDDEADM_CONFIGWRITEABLE', 'Es pot escriure a la configuració:');
...
DEFINE ('_UDDEADM_MAILSYSTEM_EXP', 'Trieu el sistema d`enviament de correu electrònic que l`uddeIM ha de fer servir per a enviar les notificacions.');
...
DEFINE ('_UDDEADM_ALLOWMULTIPLERECIPIENTS_HEAD', 'Permet múltiples destinataris');
DEFINE ('_UDDEADM_ALLOWMULTIPLERECIPIENTS_EXP', 'Permet múltiples destinataris (separats amb comes).');
DEFINE ('_UDDEIM_CHARSLEFT', 'caràcters restants');
DEFINE ('_UDDEADM_SHOWTEXTCOUNTER_HEAD', 'Mostra comptador de text');
DEFINE ('_UDDEADM_SHOWTEXTCOUNTER_EXP', 'Mostra un comptador de text que indica quants caràcters queden.');
DEFINE ('_UDDEIM_CLEAR', 'Neteja');
DEFINE ('_UDDEADM_ALLOWMULTIPLEUSER_HEAD', 'Afegeix els usuaris/es seleccionats als destinataris');
DEFINE ('_UDDEADM_ALLOWMULTIPLEUSER_EXP', 'Això permet seleccionar múltiples destinataris de la llista "Tots els usuaris".');
DEFINE ('_UDDEADM_CBALLOWMULTIPLEUSER_HEAD', 'Afegeix connexions seleccionades als destinataris');
DEFINE ('_UDDEADM_CBALLOWMULTIPLEUSER_EXP', 'Això permet seleccionar múltiples destinataris de la llista "Connexions CB".');
DEFINE ('_UDDEADM_PMSFOUND', 'PMS trobat: ');
DEFINE ('_UDDEIM_ENTERNAME', 'introduïu un nom');
DEFINE ('_UDDEADM_USEAUTOCOMPLETE_HEAD', 'Autocompleta');
DEFINE ('_UDDEADM_USEAUTOCOMPLETE_EXP', 'Completa automàticament els noms dels destinataris.');
DEFINE ('_UDDEADM_OBFUSCATING_HEAD', 'Clau utilitzada per a l`ofuscació');
DEFINE ('_UDDEADM_OBFUSCATING_EXP', 'Introdueix la clau que s`utilitzarà per a ofuscar els missatges. No ho canvieu un cop hagueu habilitat la ofuscació.');
DEFINE ('_UDDEADM_CFGFILE_NOTFOUND', 'S`ha trobat un fitxer de configuració erroni!');
DEFINE ('_UDDEADM_CFGFILE_FOUND', 'Versió trobada:');
DEFINE ('_UDDEADM_CFGFILE_EXPECTED', 'Versió esperada:');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING', 'Convertint la configuració...');
DEFINE ('_UDDEADM_CFGFILE_DONE', 'Fet!');
DEFINE ('_UDDEADM_CFGFILE_WRITEFAILED', 'Error crític: No s`ha pogut escriure al fitxer de configuració');
...
DEFINE ('_UDDEADM_MAINTENANCE_D1', 'Dates d`eliminació incorrectes (entrada/sortida): ');
DEFINE ('_UDDEADM_MAINTENANCE_D2', 'Corregint dates d`eliminació incorrectes');
DEFINE ('_UDDEIM_TODP', 'A: ');
DEFINE ('_UDDEADM_MAINTENANCE_PRUNE', 'Neteja els missatges ara');
DEFINE ('_UDDEADM_SHOWACTIONICONS_HEAD', 'Mostra icones d`acció');
DEFINE ('_UDDEADM_SHOWACTIONICONS_EXP', 'Si trieu <i>Sí</i>, els enllaços d`acció es mostraran amb una icona');
...
DEFINE ('_UDDEADM_SHOWBOTTOMICONS_EXP', 'Si trieu <i>Sí</i>, els enllaços de sota es mostraran amb una icona.');
DEFINE ('_UDDEADM_ANIMATED_HEAD', 'Utilitza emoticones animades');
DEFINE ('_UDDEADM_ANIMATED_EXP', 'Utilitza emoticones animades en comptes de les estàtiques.');
DEFINE ('_UDDEADM_ANIMATEDEX_HEAD', 'Més emoticones animades');
DEFINE ('_UDDEADM_ANIMATEDEX_EXP', 'Mostra més emoticones animades.');
...
DEFINE ('_UDDEIM_ENCRYPTIONTEXT', ' (text d`encriptació)');
DEFINE ('_UDDEIM_DECRYPTIONTEXT', ' (text de desencriptació)');
DEFINE ('_UDDEIM_MORE', 'MÉS ICONES');
// uddeIM Module
...
DEFINE ('_UDDEMODULE_EXPRESSMESSAGE', 'Missatge ràpid');

// New: 0.7+
DEFINE ('_UDDEADM_USEENCRYPTION', 'Utilitza encriptació');
...
DEFINE ('_UDDEADM_NOTIFYDEFAULT_HEAD', 'Defecte per a notificació per correu');
DEFINE ('_UDDEADM_NOTIFYDEFAULT_EXP', 'Valor per defecte de la notificació per correu electrònic (per a usuaris/es que encara no hagin canviat les seves preferències).');
DEFINE ('_UDDEADM_NOTIFYDEF_0', 'Sense notificació');
DEFINE ('_UDDEADM_NOTIFYDEF_1', 'Sempre');
DEFINE ('_UDDEADM_NOTIFYDEF_2', 'Només quan estiguin fora de línia');
DEFINE ('_UDDEADM_SUPPRESSALLUSERS_HEAD', 'Elimina l`enllaç "Tots els usuaris"');
DEFINE ('_UDDEADM_SUPPRESSALLUSERS_EXP', 'Elimina l`enllaç "Tots els usuaris" a la caixa d`escriptura de nous missatges (útil per a quan hi ha molts usuaris/es registrats).');
DEFINE ('_UDDEADM_POPUP_HEAD','Notificació emergent');
DEFINE ('_UDDEADM_POPUP_EXP','Mostra una finestra emergent quan arriba un nou missatge (es necessita mod_uddeim o mod_cblogin apedaçat)');
DEFINE ('_UDDEIM_OPTIONS', 'Més opcions');
DEFINE ('_UDDEIM_OPTIONS_EXP', 'Aquí podeu configurar més opcions.');
DEFINE ('_UDDEIM_OPTIONS_P', 'Mostra´m una finestra emergent quan arribi un missatge');
DEFINE ('_UDDEADM_POPUPDEFAULT_HEAD', 'Notificació emergent per defecte');
DEFINE ('_UDDEADM_POPUPDEFAULT_EXP', 'Habilita la notificació amb finestres emergents per defecte (per a usuaris/es que no han canviat les seves preferències).');
...
DEFINE ('_UDDEADM_MAINTENANCE_EXP', "Quan es purga un usuari/a de la base de dades els seus missatges s'hi solen mantenir. Aquesta funció comprova si és necessari eliminar missatges orfes.<br>També comprova si hi ha alguns altres tipus d`errors.");
...
DEFINE ('_UDDEADM_MAINTENANCE_MC3', "<i>entrada: missatges emmagatzemats a la bústia d`entrada de l`usuari</i><br>");
DEFINE ('_UDDEADM_MAINTENANCE_MC4', "<i>eliminats entrada: missatges eliminats de la bústia d`entrada de l`usuari, però encara a la bústia de sortida d'algú altre</i><br>");
DEFINE ('_UDDEADM_MAINTENANCE_MC5', "<i>sortida: missatges emmagatzemats a la bústia de sortida de l`usuari</i><br>");
DEFINE ('_UDDEADM_MAINTENANCE_MC6', "<i>eliminats sortida: missatges eliminats de la bústia de sortida de l`usuari, però encara a la bústia d`entrada d'algú altre</i><br>");
...
DEFINE ('_UDDEADM_MAINTENANCE_MT2', "elimina totes les preferències de l`usuari");
DEFINE ('_UDDEADM_MAINTENANCE_MT3', "elimina el bloqueig de l`usuari");
DEFINE ('_UDDEADM_MAINTENANCE_MT4', "llença tots els missatges enviats a l`usuari/a , eliminats de la bústia de sortida del remitent i de la bústia d`entrada del destinatari");
DEFINE ('_UDDEADM_MAINTENANCE_MT5', "llença tots els missatges enviats des de l`usuari/a sel·leccionat a la seva bústica de sortida i a la bústia d`entrada del destinatari");
...
DEFINE ('_UDDEIM_TRASHCAN_INFO', 'Els missatges estaran a la paperera durant 24 hores abans de ser esborrats. Només podeu veure les primeres paraules del missatge. Per a llegir el missatge sencer primer heu de restaurar-lo.');
...
DEFINE ('_UDDEIM_CANTRESTORE', 'Restauració del missatge fallida. (Segurament ha estat a la paperera massa temps i ha estat esborrat.)');
DEFINE ('_UDDEIM_COULDNOTRESTORE', 'Restauració del missatge fallida.');
DEFINE ('_UDDEIM_DONTSEND', 'No enviïs');
...
DEFINE ('_UDDEIM_OUTBOX_WARNING', 'La safata de sortida conté tots els missatges que heu enviat i que encara no han estat esborrats. Pots memoritzar un missatge en la safata de sortida si no ha estat llegit, però si ho fas ja no podrà ésser llegit pel destinatari. ');
	// changed in 0.4
...
DEFINE ('_UDDEADM_DELETETRASHAFTER_EXP', 'Introdueix el nombre de dies fins que els missatges a la paperera seran esborrats. Els valors per sota de 1 estan permesos. Exemple: per a esborrar missatges de la paperera després de 3 hores, introduïu 0.125 com a valor.');
...
DEFINE ('_UDDEADM_ICONONLINEPIC_EXP', 'Introdueix la localització de la icona que es mostrarà al costat del nom d`usuari/a quan aquest usuari/a estigui connectat.');
DEFINE ('_UDDEADM_ICONOFFLINEPIC_HEAD', 'Icona: usuari/a desconnectat');
DEFINE ('_UDDEADM_ICONOFFLINEPIC_EXP', 'Introdueix la localització de la icona que es mostrarà al costat del nom d`usuari/a quan aquest usuari/a estigui desconnectat.');
DEFINE ('_UDDEADM_ICONREADPIC_HEAD', 'Icona: missatge llegit');
DEFINE ('_UDDEADM_ICONREADPIC_EXP', 'Introdueix la localització de la icona que es mostrarà pels missatges llegits.');
DEFINE ('_UDDEADM_ICONUNREADPIC_HEAD', 'Icona: missatge no llegit');
DEFINE ('_UDDEADM_ICONUNREADPIC_EXP', 'Introdueix la localització de la icona que es mostrarà pels missatges no llegits.');
DEFINE ('_UDDEADM_MODULENEWMESS_HEAD', 'Mòdul: icona pels nous missatges');
DEFINE ('_UDDEADM_MODULENEWMESS_EXP', 'Aquest paràmetre fa referència al mòdul mod_uddeim_new. Introdueix la localització de la icona que aquest mòdul exhibirà quan hi hagi nous missatges.');
...
DEFINE ('_UDDEADM_NOCB', '<span style="color: red;">No teniu el component Community Builder instal·lat. No podreu fer servir uddeIM.</span><br><br>Us heu de descarregar el <a href="http://www.joomlapolis.com">Community Builder</a> ,aquí trobareu <a href="http://www.catmidia.cat">la traducció al català del CB</a>.');
...
DEFINE ('_UDDEIM_BLOCKS_EXP', 'Aquesta és una llista d`usuaris/es que heu bloquejat. Aquests usuaris/es no poden enviar-vos missatges privats.');
...
DEFINE ('_UDDEIM_BLOCKALERT_EXP_ON', 'Si un usuari/a bloquejat intenta enviar-vos un missatge, ell o ella serà informat/da que està bloquejat/da i que el missatge no s`ha enviat.');
...
DEFINE ('_UDDEADM_BLOCKSYSTEM_EXP', 'Quan està permès, els usuaris/es poden bloquejar altres usuaris. Un usuari/a bloquejat no pot enviar missatge a l`usuari/a que l`ha bloquejat/da. Els/les administradors/res no poden ser bloquejats/des.');
...
DEFINE ('_UDDEADM_BLOCKALERT_EXP', 'Si està marcat com a <i>sí</i>, s`informarà a un usuari/a bloquejat que el seu missatge no s`ha enviat perquè el destinatari l`ha bloquejat. Si està marcat com a <i>no</i>, l`usuari/a bloquejat no rep cap notificació sobre el fet que el seu missatge no s`ha enviat.');
...
DEFINE ('_UDDEADM_SHOWONLINE_EXP', 'Quan està marcat com a <i>sí</i>, uddeIM mostra cada nom d`usuari/a amb una icona petita que informa si l`usuari/a està connectat o desconnectat. Pots escollir les icones en  l`apartat d`administració d`icones.');
DEFINE ('_UDDEADM_ALLOWEMAILNOTIFY_HEAD', 'Permet la notificació per correu');
DEFINE ('_UDDEADM_ALLOWEMAILNOTIFY_EXP', 'Quan està marcat com a <i>sí</i>, cada usuari/a pot escollir si vol rebre un correu electrònic cada cop que un nou missatge arriba a la seva safata d`entrada.');
...
DEFINE ('_UDDEADM_LONGWAITINGEMAIL_EXP', 'Aquesta característica permet enviar - independentment de la configuració de l`usuari/a - un correu a un usuari/a que té un missatge no llegit durant molt de temps a la safata d`entrada (la durada es determina a sota). Aquest paràmetre és independent del de notificació per correu de a dalt. Si mai no voleu enviar cap missatge per correus, heu de desactivar ambdós paràmetres.');
DEFINE ('_UDDEADM_LONGWAITINGDAYS_HEAD', 'Correu "us heu oblidat" enviat després de dia(es)');
...
DEFINE ('_UDDEADM_FIRSTWORDSINBOX_EXP', 'Pots inserir el nombre de caràcters d`un missatge que es mostraran a la safata d`entrada, la de missatges enviats i la paperera.');
DEFINE ('_UDDEADM_MAXLENGTH_HEAD', 'Longitud màxim d`un missatge');
DEFINE ('_UDDEADM_MAXLENGTH_EXP', 'Inseriu aquí la longitud màxima d`un missatge. Si un missatge supera aquest límit, serà tallat automàticament. Fixeu a `0` per a permetre missatges de qualsevol llargada (no recomenat).');
...
DEFINE ('_UDDEADM_SYSM_USERNAME_EXP', 'Amb uddeIM es permeten missatges del sistema. Els missatges del sistema no tenen un remitent visible i els usuaris/es no els poden respondre. Introdueix aquí el nom d`usuari/a per defecte pels missatges del sistema (per exemple <i>Suport</i> o <i>Ajuda tècnica</i> o <i>Administrador de la Comunitat</i>)');
DEFINE ('_UDDEADM_ALLOWTOALL_HEAD', 'Permet als administradors enviar missatges generals');
DEFINE ('_UDDEADM_ALLOWTOALL_EXP', 'Amb uddeIM es permeten missatges generals. S`envien a cada usuari/a del teu sistema. Feu un ús raonable.');
...
DEFINE ('_UDDEADM_EMN_SENDERMAIL_EXP', 'Introdueix l`adreça de correu del remitent de les notificacions per correu (hauria de ser l`adreça principal de la teva pàgina).');
...
DEFINE ('_UDDEADM_MAXARCHIVE_HEAD', 'Màxim de missatges a l`arxiu d`un usuari');
DEFINE ('_UDDEADM_MAXARCHIVE_EXP', 'Decidiu quin és el nombre màxim de missatges que cada usuari/a pot emmagatzemar al seu arxiu (no hi ha límit pels administradors).');
DEFINE ('_UDDEADM_COPYTOME_HEAD', 'Permet còpies per a un mateix');
DEFINE ('_UDDEADM_COPYTOME_EXP', 'Això permetria als usuaris/es rebre còpies dels missatges que envien. Aquestes còpies apareixeran a la safata d`entrada.');
DEFINE ('_UDDEADM_MESSAGES', 'Missatges');
DEFINE ('_UDDEADM_TRASHORIGINAL_HEAD', 'Suggereix enviar a la paperera l`original');
DEFINE ('_UDDEADM_TRASHORIGINAL_EXP', 'Quan està actiu, aquest paràmetre posarà una casella al costat del botó de `Envia` en la resposta a un missatge, anomenada `elimina l`original` i que estaria sel·leccionat per defecte. En aquest cas, el missatge es mourà immediatament de la safata d`entrada a la paperera quan la resposta s`hagi enviat. Gràcies a aquesta funció, el nombre de missatges a la base de dades serà (més) petit. Els usuaris/es sempre podran desmarcar la casella si volen conservar l`original a la safata d`entrada.');
...
DEFINE ('_UDDEADM_CHARSET_HEAD', 'Joc de caràcters utilitzat');
...
DEFINE ('_UDDEADM_EMN_BODY_NOMESSAGE_EXP', 'Aquest és el contingut del correu que els usuaris/es rebran si la opció corresponent està sel·leccionada amunt. El contingut del missatge no estarà en el correu. Manteniu les variables %you%, %user% i %site% intactes. ');		
DEFINE ('_UDDEADM_EMN_BODY_WITHMESSAGE_EXP', 'Aquest és el contingut del correu que els usuaris/es rebran si la opció corresponent està sel·leccionada amunt. Aquest correu inclourà el contingut del missatge. Manteniu les variables %you%, %user%, %pmessage% i %site% intactes. ');		
DEFINE ('_UDDEADM_EMN_FORGETMENOT_EXP', 'Aquest és el contingut del correu  "us heu oblidat" que els usuaris/es rebran si la opció corresponent està sel·leccionada amunt. Manteniu les variables %you% i %site% intactes. ');		
...
DEFINE ('_UDDEADM_EXPORT_FORMAT_EXP', 'Aquest és el format del correu que els usuaris/es rebran quan es descarreguin els seus propis missatges des de l`arxiu. Manteniu les variables %user%, %msgdate% i %msgbody% intactes. ');	
...
DEFINE ('_UDDEADM_INBOXLIMIT_EXP', 'Pots incloure el nombre de missatges a la safata d`entrada en el nombre màxim d`arxius arxivats. En aquest cas, el nombre de missatges a la safata d`entrada i a l`arxiu no han d`excedir, en total, el nombre introduït amunt. Com a alternativa, podeu especificar el límit de la safata d`entrada sense un arxiu. En aquest cas, els usuaris/es no tindran més missatges que el nombre establert amunt en la seva safata d`entrada. Si s`arriba a aquesta xifra, no podran respondre més missatges o redactar-ne de nous fins que no esborrin missatges antics des de la safata d`entrada o des de l`arxiu respectivament. (Encara podran rebre missatges i llegir-los.)');
DEFINE ('_UDDEADM_SHOWINBOXLIMIT_HEAD', 'Mostra el límit d`ús a la safata d`entrada');		
DEFINE ('_UDDEADM_SHOWINBOXLIMIT_EXP', 'Això mostra quans missatges els usuaris/es han emmagatzemat (i quants poden desar) en una línia a sota la safata d`entrada.');
...
DEFINE ('_UDDEADM_ARCHIVETOTRASH_LEAVE_EXP', 'Deixa`ls a l`arxiu (l`usuari/a no podrà accedir-hi i els missatges encara es tindran en compte en els límits de missatges).');		
...
DEFINE ('_UDDEADM_ARCHIVETOTRASH_INBOX_EXP', 'Els missatges es mouran a la safata d`entrada de l`usuari/a respectiu (o a la paperera si són més antics del que es permet tenir a la safata d`entrada).');		
...
DEFINE ('_UDDEIM_WRITE_NORMAL', '[Crea un missatge normal (estàndard)]');
...
%user% us ha enviat el següent missatge privat a la vostra web .
...
DEFINE ('_UDDEIM_ARC_CANSAVEMAX_1', 'Pots emmagatzemar un màxim de ');
...
DEFINE ('_UDDEIM_EXPORT_NOW', 'Correu electrònic enviat a mi');
...
DEFINE ('_UDDEADM_SHOWCONNEX_EXP', 'Escolliu <i>Sí</i> si teniu instal·lat CB/CBE/JS i voleu presentar a l`usuari/a el nom de la seva o les seves connexions en la pàgina de la redacció d`un nou missatge.');
...
DEFINE ('_UDDEADM_ALLOWBB_EXP', 'Escolliu <i>només formats de font</i> per a permetre als usuaris/es utilitzar el codi BB per a negreta, subratllat i tamany i color de les lletres. Quan marqueu aquesta opció com a <i>sí</i>, els usuaris/es poden emprar <strong>tots</strong> els codis BB en els seus missatges (fins i tot enllaços i imatges).');
...
DEFINE ('_UDDEADM_DISPLAY', 'Visualització');
...
DEFINE ('_UDDEADM_SHOWTITLE_EXP', 'Introdueix el títol del component de missatgeria privada, per exemple `Missatges privats`. Deixeu-ho en blanc si no voleu mostrar cap títol.');
...
DEFINE ('_UDDEADM_GETPICLINK_EXP', 'Marqueu-ho com a <i>sí</i> si voleu mostrar els thumbnails de CB dels usuaris/es en les llistes de missatges (safata d`entrada, missatges enviats, etc.)');
...
DEFINE ('_UDDEIM_EMN', 'Notificació per correu electrònic');
DEFINE ('_UDDEIM_EMN_EXP', 'Pots rebre un correu electrònic quan rebis un nou missatge privat.');
DEFINE ('_UDDEIM_EMN_ALWAYS', 'Notificació per correu electrònic de nous missatges');
DEFINE ('_UDDEIM_EMN_NONE', 'No notificació per correu electrònic');
DEFINE ('_UDDEIM_EMN_WHENOFFLINE', 'Notificació per correu electrònic quan estàs desconnectat/da');
DEFINE ('_UDDEIM_EMN_NOTONREPLY', 'No enviïs notificació de respostes');
DEFINE ('_UDDEIM_BLOCKSYSTEM', 'Bloqueig d`usuari'); // Headline for blocking system in settings
DEFINE ('_UDDEIM_BLOCKSYSTEM_EXP', 'Pots prevenir que usuaris/es us enviïn missatges bloquejant-los. Escolliu <i>bloquejar usuari</i> quan veieu un missatge del respectiu usuari/a'); // block user is the same as _UDDEIM_BLOCKNOW
