...
DEFINE ('_UDDEADM_REVIEWUPDATE', 'Důležité: Pokud jsi upgradoval uddeIM z předchozích verzí pročti si README. Možná budš muset přidat nebo změnit tabulky nebo pole v databázi!');
...
DEFINE ('_UDDEADM_PUBMODESHOWALLUSERS_EXP', 'Zvol, jestli řádek "Všichni uživatelé" by měl být potlačen v Public Frontendu, zobrazen nebo jestli vždy všichni uživatelé mají být <br />zobrazeni.');
...
DEFINE ('_UDDEIM_RECIPIENTFOUND', 'příjemce nalezen');
