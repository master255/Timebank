...
// *******************************************************************
// Language file: French (source file is ANSI)
...
// Translator:    Stéphane Bourderiou alias lavsteph ajout de la traduction pour la version 2.5 béta
// *******************************************************************
DEFINE ('_UDDEADM_TRANSLATORS_CREDITS', 'Translated by Florent Nouvellon, Jyhelle, Baboon, Sarki pour <a href="http://www.joomla.fr" target="_blank">Joomla.fr</a> et lavsteph pour <a href="http://www.aide-joomla.com" target="_blank">Aide-Joomla.com</a>');
...
DEFINE ('_UDDEIM_MENUICONS_P3', 'Pas de menu');
...
DEFINE ('_UDDEADM_GRAVATAR_EXP', 'Permettre gravatar.');
...
DEFINE ('_UDDEIM_SYSGM_FORCEEMBEDDED', 'Le texte sera intégré dans l\'email de notification');
...
DEFINE ('_UDDEIM_SUBJECT_SPAMREPORT', 'Un message a été signalé du site %site%');
DEFINE ('_UDDEADM_KBYTES', 'KByte');
DEFINE ('_UDDEADM_MBYTES', 'MByte');
DEFINE ('_UDDEIM_ATT_FILEDELETED', 'Le fichier a été supprimé');
DEFINE ('_UDDEIM_ATT_FILENOTEXISTS', 'Erreur: le fichier est inexistant');
...
DEFINE ('_UDDEADM_PUBEMAIL_HEAD', 'E-mail requis');
DEFINE ('_UDDEADM_PUBEMAIL_EXP', 'Si activé, un utilisateur public peut indiquer une adresse e-mail.');
...
DEFINE ('_UDDEIM_FILESIZE_EXCEEDED', 'Poids de fichier trop elevé');
...
DEFINE ('_UDDEADM_FILEMAINTENANCEDEL_EXP', 'Effacer dans la base de données les entrées des fichiers supprimés. This is the same as ´Prune files now´ on the system tab.');
...
DEFINE ('_UDDEADM_SHOWLISTATTACHMENT_EXP', 'Afficher l´icône des fichiers joints dans la liste des messages (re&ccedil;us, envoyés, corbeille).');
...
DEFINE ('_UDDEIM_NOMESSAGES2_UNTO_FILTERED', '<b>Vous n´avez pas de messages non lu à cet utilisateur dans votre%s%s.</b>');

// New: 1.7
DEFINE ('_UDDEADM_EMAILSTOPPED', 'Notification par e-mails désactivée');
...
DEFINE ('_UDDEIM_TRASHORIGINALSENT', 'Message de suppression');
...
DEFINE ('_UDDEADM_MAINTENANCE_XML4', "Sera fait pour les mise à jour suivantes:<br />");
...
DEFINE ('_UDDEAIM_ADDEMAIL_TITLE', 'Inclure le message complet dans l´e-mail de notification.');
...
DEFINE ('_UDDEADM_PARTIALIMPORTDONE', 'L\'import partiel des messages de l´ancien pms est effectué. Ne l´importez pas A nouveau car cela importera les messages A nouveau et vous les aurez donc deux fois.');
...
DEFINE ('_UDDEADM_RESTRALLUSERS_EXP', 'Vous pouvez restreindre l´accès a la liste "Tout les utilisateurs". Généralement la liste "Tous les utilisateurs" est disponible pour tous (<i>pas de restriction</i>).');
...
DEFINE ('_UDDEIM_HELP_AUTORESPONDER', 'Quant le répondeur est validé chaque message re&ccedil;ut aura automatiquement une réponse.');
...
DEFINE ('_UDDEADM_FILTER_EXP', 'Si  cela est validé les utilisateurs peuvent filtrés leurs messages entrant et sortant pour ne montre que ceux re&ccedil;ut ou envoyés.');
...
DEFINE ('_UDDEIM_AUTORESPONDER_EXP', 'Lorsque le répondeur est validé tout les messages re&ccedil;ut auront immédiatement une réponse.');
...
// New: 1.1
DEFINE ('_UDDEADM_NOTRASHACCESS_NOT', 'Accès A la corbeille interdit.');
...
DEFINE ('_UDDEADM_HIDEUSERS_EXP', 'Indiquez les ID des utilisateurs A masquer dans la liste (p.ex. 65,66,67). Les administrateurs verront toujours la liste.');
...
DEFINE ('_UDDEADM_BACKUPRESTORE_EXP', 'Vous pouvez sauvegarder votre configuration dans la base de donnée et la restaurer quand c´est nécessaire. Ceci est utile quand vous mettez A jour uddeIM ou quand vous voulez sauvegarder une certaine configuration pour faire des tests.');
...
DEFINE ('_UDDEADM_DELETEREADAFTERNOTE_EXP', 'Montrer la note "Les messages lus seront effacés après x jours"');
DEFINE ('_UDDEADM_DELETEUNREADAFTERNOTE_HEAD', 'Montrer la note sur les messages non-lus');
DEFINE ('_UDDEADM_DELETEUNREADAFTERNOTE_EXP', 'Montrer la note "Les messages non-lus seront effacés après x jours"');
DEFINE ('_UDDEADM_DELETESENTAFTERNOTE_HEAD', 'Montrer la note sur les messages envoyés');
DEFINE ('_UDDEADM_DELETESENTAFTERNOTE_EXP', 'Montrer la note "Les messages envoyés seront effacés après x jours"');
DEFINE ('_UDDEADM_DELETETRASHAFTERNOTE_HEAD', 'Montrer la note sur les messages supprimés');
DEFINE ('_UDDEADM_DELETETRASHAFTERNOTE_EXP', 'Montrer la note "Les messages supprimés seront effacés après x jours"');
...
DEFINE ('_UDDEADM_MAINTENANCE_NOTHINGTODO', '<b>Rien A faire</b><br />');
...
define ('_UDDEIM_INBOX', 'Re&ccedil;us');
...
define ('_UDDEIM_CANTREPLY', 'Vous ne pouvez pas répondre A ce message.');
...
define ('_UDDEADM_FINISHED', 'Installation terminée. Bienvenue A uddeIM. ');
...
define ('_UDDEADM_BLOCKSYSTEM_EXP', 'Blocage activé : les utilisateurs peuvent en bloquer d´autres. Un utilisateur bloqué ne peut envoyer de message A celui qui l´a bloqué. Les Administrateurs ne peuvent pas être bloqués.');
...
define ('_UDDEADM_SYSM_USERNAME_EXP', 'uddeIM prend en charge les messages systèmes. Leur auteur ne sont pas visibles et les utilisateurs ne peuvent pas répondre A ce type de messages. Entrez ici l´alias de l´identifiant par défaut pour les messages systèmes (par exemple <i>Support</i>, <i>Aide</i> ou <i>Modérateur</i>).');
define ('_UDDEADM_ALLOWTOALL_HEAD', 'Permettre les administrateurs à envoyer des messages en masse.');
define ('_UDDEADM_ALLOWTOALL_EXP', 'uddeIM permet l´envoi de messages en masse. Les messages seront envoyés A tous les utilisateurs. A utiliser avec modération.');
...
define ('_UDDEADM_COPYTOME_EXP', 'Ajoute une case à cocher pour permettre aux expéditeurs de recevoir une copie de leur message. Ces copies seront consultables dans la bôite de réception.');
...
define ('_UDDEADM_ENABLEDOWNLOAD_EXP', 'Permet A l´utilisateur de récupérer les messages archivés en les envoyant à son adresse e-mail.');
...
define ('_UDDEADM_ARCHIVETOTRASH_INBOX_EXP', 'Les messages seront déplacés dans la boîte de réception de chaque utilisateur (ou dans le corbeille s´ils ne sont plus conformes A la durée de conservation définie).');		
...
define ('_UDDEIM_SYSGM_WILLSENDTOALL', 'Message A <strong>tous les utilisateurs</strong>');
...
DEFINE ('_UDDEADM_ALLOWSMILE_EXP', 'Choisissez <i>oui</i> pour que les émoticônes (smileys) remplacent les combinaisons de signes comme :-) dans les messages. Consultez le fichier readme.txt pour avoir la liste des émoticônes supportées.');
...
DEFINE ('_UDDEADM_SHOWCONNEX_EXP', 'Sélectionner <b>Oui</b> si vous avez installé CB/CBE/JS et que vous souhaitez afficher les connexions utilsateurs sur la page de composition d\'un nouveau message.');
...
DEFINE ('_UDDEADM_FONTFORMATONLY', 'Seulement les formats de polices');
DEFINE ('_UDDEADM_ALLOWBB_EXP', 'Utilisez <b>uniquement</b> les formats de polices pour permettre aux utilisateurs d\'utiliser les balises BBcodes pour les caractères gras, italique, souligné, ainsi que la couleur et la taille de la police. Lorsque vous définissez cette option sur <b>oui</b>, tous les utilisateurs sont autorisés à utiliser tous les <b>balises</b> prises en charge par le BBcode (par exemple, liens et images).');
DEFINE ('_UDDEADM_ALLOWSMILE_HEAD', 'Autoriser les émoticônes');
...
DEFINE ('_UDDEADM_SHOWMENUICONS_EXP', 'Lorsque l\'option est réglée sur <b>oui</b>, les liens du menu seront affiché via une icône.');
DEFINE ('_UDDEADM_SHOWTITLE_HEAD', 'Titre du composant');
...
DEFINE ('_UDDEADM_SHOWABOUT_EXP', 'Sélectionner <b>oui</b> pour afficher un lien vers la page de crédit et license du composant uddeIM. Ce lien sera placé au bas de la page de uddeIM..');
DEFINE ('_UDDEADM_STOPALLEMAIL_HEAD', 'Stop Courriel');
...
DEFINE ('_UDDEADM_GETPICLINK_HEAD', 'Vignettes CB dans les listes');
DEFINE ('_UDDEADM_GETPICLINK_EXP', 'Sélectionner <b>oui</b> si vous souhaitez afficher les vignettes de Community Builder dans l\'aperçu de la liste des messages (inbox, outbox, etc.)');
...
"Hi %you%,\n\n%user% vous a envoyé un message privé sur le site %site%. Veuillez vous connecter pour le lire!\n\n%livesite%");
