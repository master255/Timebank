...
// *******************************************************************
DEFINE ('_UDDEADM_TRANSLATORS_CREDITS', 'Translated by http://www.netiv.info');	// Enter your credits line here, e.g. 'Translation by <a href="http://domain.com" target="_new">John Doe</a>'
...
DEFINE ('_UDDEADM_FILTER_HEAD', 'Enable Filter');
...
DEFINE ('_UDDEIM_PASSWORD', 'נידרשת סיסמה');
...
DEFINE ('_UDDEADM_POPUP_EXP','הראה חלון קופץ מתי שהתקבלה הודעה חדשה');
...
DEFINE ('_UDDEIM_NOMESSAGES_INBOX', 'אין הודעות חדשות');
	// changed in 0.4 (one dot that was too much after </strong> deleted)
	
DEFINE ('_UDDEIM_NOMESSAGES_OUTBOX', 'אין הודעות חדשות');
DEFINE ('_UDDEIM_NOMESSAGES_TRASHCAN', 'אין הודעות בסל המיחזור');
