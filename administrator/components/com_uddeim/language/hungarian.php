...
// *******************************************************************
// Language file: Hungarian (source file is UTF-8)
// Translator:    Bulcsú Szász <agy@neuro.hu>, www.neuroweb.hu
// *******************************************************************
DEFINE ('_UDDEADM_TRANSLATORS_CREDITS', 'Translated by Bulcsú Szász');	// Enter your credits line here, e.g. 'Translation by <a href="http://domain.com" target="_new">John Doe</a>'
...
// New: 2.0
DEFINE ('_UDDEADM_RECAPTCHAPRV_HEAD', 'reCaptcha privát kulcs');
DEFINE ('_UDDEADM_RECAPTCHAPRV_EXP', 'A reCaptcha használatához írjuk be a privát kulcsunkat.');
DEFINE ('_UDDEADM_RECAPTCHAPUB_HEAD', 'reCaptcha publikus kulcs');
DEFINE ('_UDDEADM_RECAPTCHAPUB_EXP', 'A reCaptcha használatához írjuk be a publikus kulcsunkat.');
DEFINE ('_UDDEADM_CAPTCHA_INTERNAL', 'Belsõ');
DEFINE ('_UDDEADM_CAPTCHA_RECAPTCHA', 'reCaptcha');
DEFINE ('_UDDEADM_CAPTCHATYPE_HEAD', 'Captcha szolgáltatás');
DEFINE ('_UDDEADM_CAPTCHATYPE_EXP', 'Melyik kulcsszavas védelmi (captcha) szolgáltatást szeretnénk használni: A beípítettet vagy a reCaptcha-t (további infó:<a href="http://recaptcha.net" target="_new">reCaptcha</a>)?');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_6', '...alapértelmezett kulcsszavas védelmi szolgáltatás beállítva');
DEFINE ('_UDDEADM_AUP', 'AlphaUserPoints');
DEFINE ('_UDDEADM_CHECKFILESFOLDER', 'Helyezzük át a <i>\uddeimfiles</i> mappát a <i>\images\uddeimfiles</i>-ba. Lásd a dokumentációban!');
DEFINE ('_UDDEADM_CRYPT4', 'Erõs védelmi kódolás');
DEFINE ('_UDDEADM_ALLOWTOALL2_HEAD', 'Rendszer üzenetek küldése');
DEFINE ('_UDDEADM_ALLOWTOALL2_EXP', 'uddeIM rendszer üzeneteket is tud küldeni. Ezek az üzenetek akár a weboldal összes felhasználójának is kiküldhetõk. Ésszel használjuk...');
DEFINE ('_UDDEADM_ALLOWTOALL2_0', 'kikapcsolva');
DEFINE ('_UDDEADM_ALLOWTOALL2_1', 'csak adminoknak');
DEFINE ('_UDDEADM_ALLOWTOALL2_2', 'adminoknak és kezelõknek (managers)');

// New: 1.9
DEFINE ('_UDDEIM_FILEUPLOAD_FAILED', 'A fájlfeltöltés nem sikerült');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_5', '...alapértelmezettnek a fájl hozzáadáshoz');
DEFINE ('_UDDEADM_ENABLEATTACHMENT_HEAD', 'Fájl hozzáadás engedélyezése');
DEFINE ('_UDDEADM_ENABLEATTACHMENT_EXP', 'Minden regisztrált felhasználó vagy csak az adminisztrátorok küldhessenek fájlokat?');
DEFINE ('_UDDEADM_MAXSIZEATTACHMENT_HEAD', 'Max. fájlméret');
DEFINE ('_UDDEADM_MAXSIZEATTACHMENT_EXP', 'A csatolandó fájl legnagyobb mérete.');
DEFINE ('_UDDEIM_FILESIZE_EXCEEDED', 'Fájlméret korlát túllépése');
DEFINE ('_UDDEADM_BYTES', 'Byte-ok');
DEFINE ('_UDDEADM_MAXATTACHMENTS_HEAD', 'Max. csatolmányok');
DEFINE ('_UDDEADM_MAXATTACHMENTS_EXP', 'Egy üzenetben elküldendõ fájlok maximális száma.');
DEFINE ('_UDDEIM_DOWNLOAD', 'Letöltés');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_HEAD', 'Fájlok törlése');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_YES', 'csak az adminisztrátorok');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_NO', 'bármelyik felhasználó');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_MANUALLY', 'kézi');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_EXP', 'Az automatikus törlések jelentõs szerverterhelést okozhatnak. Ha azt választjuk, hogy <b>csak az adminisztrátorok</b>, az automatikus törlés az adminisztrátor postaládájának ellenõrzésekor lesz végrehajtva. Abban az esetben válasszuk ezt az opciót, ha az adminisztrátor gyakran ellenõrzi a postaládáját. Ritka adminisztrátori jelenlét esetén válasszuk a <b>bármelyik felhasználó</b> lehetõséget.');
DEFINE ('_UDDEADM_FILEMAINTENANCE_PRUNE', 'Fájlok ritkítása');
DEFINE ('_UDDEADM_FILEMAINTENANCEDEL_HEAD', 'Fájlok törlése');
DEFINE ('_UDDEADM_FILEMAINTENANCEDEL_EXP', 'A törölt fájlok adatbázisból történõ eltávolítása. Ez ugyanaz, mint a \'Fájlok ritkítása\' a rendszer fülön.');
DEFINE ('_UDDEADM_FILEMAINTENANCEDEL_ERASE', 'TÖRLÉS');
DEFINE ('_UDDEIM_ATTACHMENTS', 'Csatolmányok (max. %u bytes fájlonként):');
DEFINE ('_UDDEADM_MAINTENANCE_F1', 'Kallódó fájlok az adatbázisban: ');
DEFINE ('_UDDEADM_MAINTENANCE_F2', 'Kallódó fájlok törlése');
DEFINE ('_UDDEADM_BACKUP_DONE', 'Beállítások tárolva.');
DEFINE ('_UDDEADM_RESTORE_DONE', 'Tárolt beállítások visszaállítva.');
DEFINE ('_UDDEADM_PRUNE_DONE', 'Üzenetek ritkítása kész.');
DEFINE ('_UDDEADM_FILEPRUNE_DONE', 'Csatolmányok ritkítása kész.');
DEFINE ('_UDDEADM_FOLDERCREATE_ERROR', 'Hiba az alkönyvtár létrehozásakor: ');
DEFINE ('_UDDEADM_ATTINSTALL_WRITEFAILED', 'Hiba a fájl létrehozásakor: ');
DEFINE ('_UDDEADM_ATTINSTALL_IGNORE', 'Amennyiben nem található meg a File attachments premium plugin, ez a hiba figyelmen kívül hagyható.');
DEFINE ('_UDDEADM_ATTACHMENTGROUPS_HEAD', 'Engedélyezett csoportok');
DEFINE ('_UDDEADM_ATTACHMENTGROUPS_EXP', 'A fájl csatolására engedélyezett csoport.');
DEFINE ('_UDDEIM_SELECT', 'Kiválaszt');
DEFINE ('_UDDEIM_ATTACHMENT', 'Csatolmány');
DEFINE ('_UDDEADM_SHOWLISTATTACHMENT_HEAD', 'Csatolmány ikon megjelenítése');
DEFINE ('_UDDEADM_SHOWLISTATTACHMENT_EXP', 'Csatolmány ikon megjelenítése a listákban (postaláda, elküldött levelek, archívum).');
DEFINE ('_UDDEIM_HELP_ATTACHMENT', 'Az üzenet csatolt fájlt tartalmaz.');
DEFINE ('_UDDEADM_MAINTENANCE_COUNTFILES', 'A fájlok adatbázis hivatkozásai:');
DEFINE ('_UDDEADM_MAINTENANCE_COUNTFILESDISTINCT', 'Fájl csatolmányok tárolva:');
DEFINE ('_UDDEADM_SHOWMENUCOUNT_HEAD', 'Számláló megjelenítése');
DEFINE ('_UDDEADM_SHOWMENUCOUNT_EXP', ' <b>Igen</b> választása esetén a menüben megjelenik egy számláló. Fontos: Ez a mûvelet számos adatbázis lekérdezéssel jár, gyenge szerveren nem javasolt a használata!');
DEFINE ('_UDDEADM_CONFIG_FTPLAYER', 'Beállítás (elérés FTP-vel):');
DEFINE ('_UDDEADM_ENCODEHEADER_HEAD', 'Üzenet fejlécének kódolása');
DEFINE ('_UDDEADM_ENCODEHEADER_EXP', 'Állítsuk <b>igen</b>-re, ha az üzenetek fejléc-részénél (mint pl. a tárgy mezõ) rfc 2047 kódolást szeretnénk használni. Hasznos lehet, ha probléma merült fel a speciális karakterek megjelenítésével.');
DEFINE ('_UDDEIM_UP', 'növekvõ rendezés');
DEFINE ('_UDDEIM_DOWN', 'csökkenõ rendezés');
DEFINE ('_UDDEIM_UPDOWN', 'rendezés');
DEFINE ('_UDDEADM_ENABLESORT_HEAD', 'Rendezés használata');
DEFINE ('_UDDEADM_ENABLESORT_EXP', 'Válaszuk az <b>yes</b>-t, ha engedélyezni szeretnénk, hogy a felhasználó módosíthassa az üzenetlisták sorbarendezéseit. (Használata megterhelheti az adatbázis szervert!)');
...
DEFINE ('_UDDEIM_NOMESSAGES2_FR_FILTERED', '<b>Ettõl a felhasználótól nincsen üzenet a %s -ban.</b>');
DEFINE ('_UDDEIM_NOMESSAGES2_TO_FILTERED', '<b>Ennek a felhasználónak nincsen üzenet a %s -ban.</b>');
DEFINE ('_UDDEIM_NOMESSAGES2_UNFR_FILTERED', '<b>Ettõl a felhasználótól nincsen új üzeneted a %s -ban.</b>');
DEFINE ('_UDDEIM_NOMESSAGES2_UNTO_FILTERED', '<b>Ennek a felhasználónak nincsen új üzenet a %s -ban.</b>');

// New: 1.7
DEFINE ('_UDDEADM_EMAILSTOPPED', '\'Email megállítás\' engedélyezve.');
DEFINE ('_UDDEIM_ACCOUNTLOCKED', 'A postafiók hozzáférése blokkolva van. Kérjük lépjen kapcsolatba az adminisztrátorral.');
DEFINE ('_UDDEADM_USERSET_LOCKED', 'Zárva');
DEFINE ('_UDDEADM_USERSET_SELLOCKED', '- Zárva -');
DEFINE ('_UDDEADM_CBBANNED_HEAD', 'CB bannolt felhasználók keresése');
DEFINE ('_UDDEADM_CBBANNED_EXP', 'Bekapcsolása eseténe az uddeIM letiltja a CB-rõl bannolt felhasználókat. A többi felhasználó sem tud nekik üzenetet küldeni.');
DEFINE ('_UDDEIM_YOUAREBANNED', 'Ez a felhasználó bannolva (letiltva) van! Kérjük lépjen kapcsolatba az adminisztrátorral!');
DEFINE ('_UDDEIM_USERBANNED', 'A felhasználó bannolva van.');
DEFINE ('_UDDEADM_JOOBB', 'Joo!BB');
DEFINE ('_UDDEPLUGIN_SEARCHSECTION', 'Magán üzenetek');
DEFINE ('_UDDEPLUGIN_MESSAGES', 'Magán üzenetek');
DEFINE ('_UDDEADM_MAINTENANCEDEL_HEAD', 'Üzenetek törlése');
// note "This  is the same as _UDDEADM_MAINTENANCE_PRUNE on the system tab."
DEFINE ('_UDDEADM_MAINTENANCEDEL_EXP', 'Eltávolítja a törölt üzeneteket az adatbázisból. Megegyezik az  \'Üzenetek ritkítása\' funkcióval.');
DEFINE ('_UDDEADM_MAINTENANCEDEL_ERASE', 'TÖRLÉS');
DEFINE ('_UDDEADM_REPORTSPAM_HEAD', 'Üzenet bejelentése');
DEFINE ('_UDDEADM_REPORTSPAM_EXP', 'Bekapcsolása esetén megjelenik egy \'Üzenet bejelentése\' link, amivel a SPAM-nak vélt üzenetek jelezhetõk az adminisztrátornak.');
DEFINE ('_UDDEIM_TOOLBAR_REMOVESPAM', 'Üzenet törlése');
DEFINE ('_UDDEIM_TOOLBAR_REMOVEREPORT', 'Üzenet eltávolítása');
DEFINE ('_UDDEIM_TOOLBAR_SPAMCONTROL', 'Bejelentések');
DEFINE ('_UDDEADM_INFORMATION', 'Információ');
DEFINE ('_UDDEADM_SPAMCONTROL_STAT', 'Bejelentett üzenetek:');
DEFINE ('_UDDEADM_SPAMCONTROL_TRASHED', 'Törölt');
DEFINE ('_UDDEADM_SPAMCONTROL_NOTEDEL', 'Töröljük ezt az üzenetet az adatbázisból?');
DEFINE ('_UDDEADM_SPAMCONTROL_NOTEREMOVE', 'Eltávolítsuk ezt a bejelentést?');
DEFINE ('_UDDEADM_SPAMCONTROL_SHOWHIDE', 'Megjelenés/Elrejtés');
DEFINE ('_UDDEADM_SPAMCONTROL_EDIT', 'Bejelentések');
DEFINE ('_UDDEADM_SPAMCONTROL_FROM', 'Küldõ');
DEFINE ('_UDDEADM_SPAMCONTROL_TO', 'Címzett');
DEFINE ('_UDDEADM_SPAMCONTROL_TEXT', 'Üzenet');
DEFINE ('_UDDEADM_SPAMCONTROL_DELETE', 'Törlés');
DEFINE ('_UDDEADM_SPAMCONTROL_REMOVE', 'Eltávolítás');
DEFINE ('_UDDEADM_SPAMCONTROL_DATE', 'Dátum');
DEFINE ('_UDDEADM_SPAMCONTROL_REPORTED', 'Bejelentve');
DEFINE ('_UDDEIM_SPAMCONTROL_REPORT', 'Üzenet');
DEFINE ('_UDDEIM_SPAMCONTROL_MARKED', 'Üzenet bejelentve');
DEFINE ('_UDDEIM_SPAMCONTROL_UNREPORT', 'Bejelentés visszahívása');
DEFINE ('_UDDEADM_JOMSOCIAL', 'JomSocial');
DEFINE ('_UDDEADM_KUNENA', 'Kunena');
DEFINE ('_UDDEADM_ADMIN_FILTER', 'Szûrõ');
DEFINE ('_UDDEADM_ADMIN_DISPLAY', 'Megjelenítve #');
DEFINE ('_UDDEADM_TRASHORIGINALSENT_HEAD', 'Elküldött üzenet a kukába');
DEFINE ('_UDDEADM_TRASHORIGINALSENT_EXP', 'Használatakor a \'Küldés\' gomb mellett kiválaszthatjuk, hogy az üzenet elküldéskor törlõdjön is.');
DEFINE ('_UDDEIM_TRASHORIGINALSENT', 'üzenet törlõdjön');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_4', '...set default for delete sent message, report spam, CB banned users');
DEFINE ('_UDDEADM_VERSIONCHECK_IMPORTANT', 'Fontos linkek:');
DEFINE ('_UDDEADM_VERSIONCHECK_HOTFIX', 'Javítások');
DEFINE ('_UDDEADM_VERSIONCHECK_NONE', 'Nincsen');
DEFINE ('_UDDEADM_MAINTENANCEFIX_HEAD', "Kompatibilitási karbantartás");
DEFINE ('_UDDEADM_MAINTENANCEFIX_EXP', "Az uddeIM két XML fájlt használ, hogy telepíthetõ legyen Joomla 1.0 és 1.5x rendszerekre. Joomla 1.5 esetében az egyik XML fájl nem szükséges, sõt emiatt a telepítõ kezelõ kompatibilitási hibát is jelez. Eltávolíthatjuk ezt a fájlt, így a hiba megszûnik.");
DEFINE ('_UDDEADM_MAINTENANCE_FIX', "JAVÍTÁS");
DEFINE ('_UDDEADM_MAINTENANCE_XML1', "Joomla 1.0 és Joomla 1.5 uddeIM XML telepítõfájlok megvannak.<br />");
DEFINE ('_UDDEADM_MAINTENANCE_XML2', "Ez szükséges a Joomla 1.0 és Joomla 1.5 rendszerekre való telepítéshez.<br />");
DEFINE ('_UDDEADM_MAINTENANCE_XML3', "Mivel telepítés után már nincs rájuk szükség, a Joomla 1.0 XML fájl nyugodtan törölhetõ a Joomla 1.5 rendszeren.<br />");
DEFINE ('_UDDEADM_MAINTENANCE_XML4', "Az alábbit fogjuk elvégezni:<br />");
DEFINE ('_UDDEADM_MAINTENANCE_FXML1', "Felesleges XML telepítõfájl eltávolítása:<br />");
DEFINE ('_UDDEADM_MAINTENANCE_FXML2', "Nem található XML telepítõfájl!<br />");
DEFINE ('_UDDEADM_SHOWMENUICONS1_HEAD', 'Menü felület megjelenése');
DEFINE ('_UDDEADM_SHOWMENUICONS1_EXP', 'Itt adhatjuk meg, hogy a menü szüveges vagy ikonos megjelenésû legyen.');
DEFINE ('_UDDEIM_MENUICONS_P1', 'Ikonok és szöveg');
DEFINE ('_UDDEIM_MENUICONS_P2', 'Csak ikonok');
DEFINE ('_UDDEIM_MENUICONS_P0', 'Csak szöveg');
DEFINE ('_UDDEIM_LISTSLIMIT_2', 'Listában szereplõ címzettek maximális száma:');
DEFINE ('_UDDEADM_ADDEMAIL_ADMIN', 'Adminisztrátorok is választhatók');
DEFINE ('_UDDEAIM_ADDEMAIL_SELECT', 'Értesítés az üzenettel');
DEFINE ('_UDDEAIM_ADDEMAIL_TITLE', 'Emailes értesítõben szerepeljen a komplett üzenet is.');

// New: 1.6
DEFINE ('_UDDEIM_NOLISTSELECTED', 'Nincsen taglista kiválasztva!');
DEFINE ('_UDDEADM_NOPREMIUM', 'Nincsen telepítve a Premium plugin');
DEFINE ('_UDDEIM_LISTGLOBAL_CREATOR', 'Szerzõ:');
DEFINE ('_UDDEIM_LISTGLOBAL_ENTRIES', 'Elemek');
DEFINE ('_UDDEIM_LISTGLOBAL_TYPE', 'Típus');
DEFINE ('_UDDEIM_LISTGLOBAL_NORMAL', 'Normal');
DEFINE ('_UDDEIM_LISTGLOBAL_GLOBAL', 'Globálsi');
DEFINE ('_UDDEIM_LISTGLOBAL_RESTRICTED', 'Korlátozott');
DEFINE ('_UDDEIM_LISTGLOBAL_P0', 'Normal címlista');
DEFINE ('_UDDEIM_LISTGLOBAL_P1', 'Globális címlista');
DEFINE ('_UDDEIM_LISTGLOBAL_P2', 'Korlátozott címlista (csak a címlista tagjai férhetnek hozzá a listához)');
DEFINE ('_UDDEIM_TOOLBAR_USERSETTINGS', 'Felhasználói beállítások');
DEFINE ('_UDDEIM_TOOLBAR_REMOVESETTINGS', 'Beállítás eltávolítása');
DEFINE ('_UDDEIM_TOOLBAR_CREATESETTINGS', 'Beállítás létrehozása');
DEFINE ('_UDDEIM_TOOLBAR_SAVE', 'Mentés');
DEFINE ('_UDDEIM_TOOLBAR_BACK', 'Vissza');
DEFINE ('_UDDEIM_TOOLBAR_TRASHMSGS', 'Törölt üzenetek');
DEFINE ('_UDDEIM_CBPLUG_CONT', '[folytatás]');
DEFINE ('_UDDEIM_CBPLUG_UNBLOCKNOW', '[felold]');
DEFINE ('_UDDEIM_CBPLUG_DOBLOCK', 'Felhasználó blokkolása');
DEFINE ('_UDDEIM_CBPLUG_DOUNBLOCK', 'Felhasználó feloldása');
DEFINE ('_UDDEIM_CBPLUG_BLOCKINGCFG', 'Blokkolás');
DEFINE ('_UDDEIM_CBPLUG_BLOCKED', 'Blokkoltad ezt a felhasználót.');
DEFINE ('_UDDEIM_CBPLUG_UNBLOCKED', 'Ez a felhasználó üzenhet nekünk.');
DEFINE ('_UDDEIM_CBPLUG_NOWBLOCKED', 'Ez a felhasználó most blokkolva van.');
DEFINE ('_UDDEIM_CBPLUG_NOWUNBLOCKED', 'Ez a felhasználó már nincsen blokkolva.');
DEFINE ('_UDDEADM_PARTIALIMPORTDONE', 'A korábbi PMS üzeneteinek egy részét importáltuk. Ne importáljuk ezt a részletet mégegyszer, mert akkor duplán fog megjelenni.');
DEFINE ('_UDDEADM_IMPORT_HELP', 'Fontos: Az üzeneteket egyszerre teljes egészében vagy részekre bontva is lehet importálni. Olyankor érdemes részletekre bontva importálni az üzenetket, ha egyébként az üzenetek nagy száma miatt az egyszerre történõ importálás nem sikerül.');
DEFINE ('_UDDEADM_IMPORT_PARTIAL', 'Importálás részletekben:');
DEFINE ('_UDDEADM_UPDATEYOURDB', 'Fontos: Nem sikerült az adatbázis frissítése! A README-ben találjuk az uddeIM helyes frissítésnek a menetét!');
DEFINE ('_UDDEADM_RESTRALLUSERS_HEAD', 'Az "Összes felhasználó" hozzáférésének a korlátozása');
DEFINE ('_UDDEADM_RESTRALLUSERS_EXP', 'Korlátozni lehet az "Összes felhasználó" listájának az elérését. Alaphelyzetben az "Összes felhasználó" listázása mindenkinek elérhetõ (<i>nincsen korlátozva</i>).');
DEFINE ('_UDDEADM_RESTRALLUSERS_0', 'nincsen korlátozva');
DEFINE ('_UDDEADM_RESTRALLUSERS_1', 'speciális felhasználók');
DEFINE ('_UDDEADM_RESTRALLUSERS_2', 'csak az adminisztrátorok');
DEFINE ('_UDDEIM_MESSAGE_UNARCHIVED', 'Az üzenet visszakerült az archívumból.');
DEFINE ('_UDDEADM_AUTOFORWARD_SPECIAL', 'speciális felhasználók');
DEFINE ('_UDDEIM_HELP', 'Súgó');
DEFINE ('_UDDEIM_HELP_HEADLINE1', 'uddeIM Súgó');
DEFINE ('_UDDEIM_HELP_HEADLINE2', 'Az összes funkció rövid bemutatása');
DEFINE ('_UDDEIM_HELP_INBOX', 'A <b>Postaláda</b> tárolja az összes beérkezett üzenetet.');
DEFINE ('_UDDEIM_HELP_OUTBOX', 'A <b>Kimenõ mappa</b> örzi azokat az üzeneteket, amiket elküldtünk.');
DEFINE ('_UDDEIM_HELP_TRASHCAN', 'A <b>Kuka</b> tárolja az összes törölt üzenetet. Az üzenetek ugyanis nem törlõdnek azonnal véglegese, egy bizonyos ideig itt tárolódnak. Ameddig az üzenet a kukában van, bármikor visszaállítható.');
DEFINE ('_UDDEIM_HELP_ARCHIVE', 'Az <b>Archívum</b> tárolja az összes Postaládából archívált üzenetet. Amennyiben általunk küldött üzenetet kívánunk archíválni, jelöljük be a küldésnél a <i>másolat nekem</i> opciót.');
DEFINE ('_UDDEIM_HELP_USERLISTS', 'A <b>Címzett lista</b> lehetõvé teszi, hogy a címzetteket listákban tároljuk. Ezeknek a listáknak a segítságável könnyen küldhetünk egyszerre több címzettnek üzenetet. Ahelyett, hogy egyenként kellene összeválogatnunk a címzetteket, kiválaszthatjuk az adott <i>#címzettlistánkat</i>.');
DEFINE ('_UDDEIM_HELP_SETTINGS', 'A <b>Beállítások</b>ban találjuk az összes felhasználói beállítási lehetõségeket.');
DEFINE ('_UDDEIM_HELP_COMPOSE', '<b>Üzenet írása</b>val küldhetünk új üzeneteket.');
DEFINE ('_UDDEIM_HELP_IREAD', 'Az üzenetet elolvasták (állítható az állapota).');
DEFINE ('_UDDEIM_HELP_IUNREAD', 'Az üzenet még nincsen elolvasva (állítható az állapota).');
DEFINE ('_UDDEIM_HELP_OREAD', 'Az üzenetet elolvasták.');
DEFINE ('_UDDEIM_HELP_OUNREAD', 'Az üzenetet még nem olvasták el. Az olvasatlan üzenetek visszahívhatók!');
DEFINE ('_UDDEIM_HELP_TREAD', 'Az üzenetet elolvasták.');
DEFINE ('_UDDEIM_HELP_TUNREAD', 'Az üzenet még mindíg olvasatlan.');
DEFINE ('_UDDEIM_HELP_FLAGGED', 'Az üzenet megjelölve, pl. fontos üzenet esetén (állítható az állapota).');
DEFINE ('_UDDEIM_HELP_UNFLAGGED', '<i>Normál</i> üzenet (állítható az állapota).');
DEFINE ('_UDDEIM_HELP_ONLINE', 'A felhasználó jeleleg online.');
DEFINE ('_UDDEIM_HELP_OFFLINE', 'A felhasználó jelenleg offline.');
DEFINE ('_UDDEIM_HELP_DELETE', 'Üzenet törlése (az üzenet kukába dobása).');
DEFINE ('_UDDEIM_HELP_FORWARD', 'Az üzenet továbbítása másik címzettnek.');
DEFINE ('_UDDEIM_HELP_ARCHIVEMSG', 'Az üzenet archíválása. Az archívált üzenetek nem törlõdnek automatikusan, akkor sem ha be van állítva a postaládában lévõ üzenetek tárolásának a határideje.');
DEFINE ('_UDDEIM_HELP_UNARCHIVEMSG', 'Archivált üzenet visszaállítása. Az üzenet visszakerül a postaládába.');
DEFINE ('_UDDEIM_HELP_RECALL', 'Üzenet visszahívása. Az elküldött üzenetek visszahívhatók, ha a címzett még nem olvasta õket.');
DEFINE ('_UDDEIM_HELP_RECYCLE', 'Üzenet visszaállítása (a kukából visszakerül az üzenet a postaládába vagy az elküldött üzenetek mappájába).');
DEFINE ('_UDDEIM_HELP_NOTIFY', 'Email értesítés beállítása, ha új üzenet érkezik.');
DEFINE ('_UDDEIM_HELP_AUTORESPONDER', 'Ha az automata válaszoló be van állítva, minden beérkezett üzenetre autmatikus válasz lesz kiküldve.');
DEFINE ('_UDDEIM_HELP_AUTOFORWARD', 'Az új üzenetek automatikusan egy másik felhasználónak lesznek továbbküldve.');
DEFINE ('_UDDEIM_HELP_BLOCKING', 'Blokkolhatunk felhasználókat. Ezek a felhasználók nem küldhetnek nekünk üzeneteket.');
DEFINE ('_UDDEIM_HELP_MISC', 'Itt találunk néhágy beállítási lehetõséget');
DEFINE ('_UDDEIM_HELP_FEED', 'RSS csatornaként is elérhetjük a postaládánkat.');
DEFINE ('_UDDEADM_SEPARATOR_HEAD', 'Elválasztó');
DEFINE ('_UDDEADM_SEPARATOR_EXP', 'Válasszuk ki a címzetteket elválasztó karaktert (alapesetben ",").');
DEFINE ('_UDDEADM_SEPARATOR_P0', 'vesszõ (alap)');
DEFINE ('_UDDEADM_SEPARATOR_P1', 'pontosvesszõ');
DEFINE ('_UDDEADM_RSSLIMIT_HEAD', 'RSS opciók');
DEFINE ('_UDDEADM_RSSLIMIT_EXP', 'RSS elemek száma (0 - korlátlan).');
DEFINE ('_UDDEADM_SHOWHELP_HEAD', 'Súgó gomb megjelenítése');
DEFINE ('_UDDEADM_SHOWHELP_EXP', 'Ha engedélyezzük, meg fog jelenni a súgó gombja.');
DEFINE ('_UDDEADM_SHOWIGOOGLE_HEAD', 'iGoogle gomb megjelenítése');
DEFINE ('_UDDEADM_SHOWIGOOGLE_EXP', 'Ha engedélyezzük, meg fog jelenni egy <i>Hozzáadás az iGoogle-hoz</i> gomb az uddeIM felhasználói adatoknál.');
DEFINE ('_UDDEADM_MOOTOOLS_NONE11', 'a MooTools ne töltõdjön be (1.1 van használatban)');
DEFINE ('_UDDEADM_MOOTOOLS_NONE12', 'a MooTools ne töltõdjön be (1.2 van használatban)');
DEFINE ('_UDDEIM_RSS_INTRO1', 'A postaláda RSS csatornaként (0.91) is elérhetõ.');
DEFINE ('_UDDEIM_RSS_INTRO1B', 'Az elérés URL-je:');
DEFINE ('_UDDEIM_RSS_INTRO2', '!!! Ne adjuk át ezt az URL-t másoknak, mert a így postafiókunk mások által is elérhetõvé válik!!!');
DEFINE ('_UDDEIM_RSS_FEED', 'RSS üzenet csatorna');
DEFINE ('_UDDEIM_RSS_NOOBJECT', 'No object error...');
DEFINE ('_UDDEIM_RSS_USERBLOCKED', 'A felhasználó blokkolva...');
DEFINE ('_UDDEIM_RSS_NOTALLOWED', 'Hozzáférés nem engedélyezett...');
DEFINE ('_UDDEIM_RSS_WRONGPASSWORD', 'Hibás felhasználónév vagy jelszó...');
DEFINE ('_UDDEIM_RSS_NOMESSAGES', 'Nincs üzenet');
DEFINE ('_UDDEIM_RSS_NONEWMESSAGES', 'Nincen új üzenet');
DEFINE ('_UDDEADM_ENABLERSS_HEAD', 'RSS engedélyezése');
DEFINE ('_UDDEADM_ENABLERSS_EXP', 'Amennyiben ezt az opciót engedélyezzük, az üzeneteink RSS csatornaként is elérhetõk lesznek a számunkra. A szükséges elérési URL a felhasználói adatlapon szerepel.');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_3', '...RSS alapértelmezettnek');
DEFINE ('_UDDEADM_DELETEM_DELETING', 'Üzenetek törlése:');
DEFINE ('_UDDEADM_DELETEM_FROMUSER', 'Üzenetek törlése a felhasználótól ');
DEFINE ('_UDDEADM_DELETEM_MSGSSENT', '- üzenetek elküldve: ');
DEFINE ('_UDDEADM_DELETEM_MSGSRECV', '- üzenetek berékezve: ');
DEFINE ('_UDDEIM_PMNAV_THISISARESPONSE', 'Hozzá tartozik:');
DEFINE ('_UDDEIM_PMNAV_THEREARERESPONSES', 'Hozzá kapcsoljuk:');
DEFINE ('_UDDEIM_PMNAV_DELETED', 'Üzenet nem elérhetõ');
DEFINE ('_UDDEIM_PMNAV_EXISTS', 'ügrás az üzenethez');
DEFINE ('_UDDEIM_PMNAV_COPY2ME', '(Másol)');
DEFINE ('_UDDEADM_PMNAV_HEAD', 'Navigáció engedélyezése');
DEFINE ('_UDDEADM_PMNAV_EXP', 'Navigációs panel használata, amely megkönnyítí az üzenetk közötti böngészést.');
DEFINE ('_UDDEADM_MAINTENANCE_ALLDAYS', 'Üzenetek:');
DEFINE ('_UDDEADM_MAINTENANCE_7DAYS', 'Az elmúlt 7 nap üzenetei:');
DEFINE ('_UDDEADM_MAINTENANCE_30DAYS', 'Az elmúlt 30 nap üzenetei:');
DEFINE ('_UDDEADM_MAINTENANCE_365DAYS', 'Az elmúlt 365 nap üzenetei:');
DEFINE ('_UDDEADM_MAINTENANCE_HEAD1', 'Emlékeztetõ küldése (Nefelejtsel: %s nap):');
DEFINE ('_UDDEADM_MAINTENANCE_HEAD2', '%s nap múlva emlékeztetõ küldése:');
DEFINE ('_UDDEADM_MAINTENANCE_NO', 'Szám:');
DEFINE ('_UDDEADM_MAINTENANCE_USERID', 'Felhasználói azonosító:');
DEFINE ('_UDDEADM_MAINTENANCE_TONAME', 'Név:');
DEFINE ('_UDDEADM_MAINTENANCE_MID', 'Üzenet azonosító:');
DEFINE ('_UDDEADM_MAINTENANCE_WRITTEN', 'Írta:');
DEFINE ('_UDDEADM_MAINTENANCE_TIMER', 'Idõzítés:');

// New: 1.5
DEFINE ('_UDDEMODULE_ALLDAYS', ' üzenet');
DEFINE ('_UDDEMODULE_7DAYS', ' az elmúlt 7 nap üzenetei');
DEFINE ('_UDDEMODULE_30DAYS', ' az elmúlt 30 nap üzenetei');
DEFINE ('_UDDEMODULE_365DAYS', ' az elmúlt 365 nap üzenetei');
DEFINE ('_UDDEADM_EMN_SENDERMAIL_WARNING', '<br /><b>Fontos!<br />Amennyiben mosMail-t használunk, valós emailcím beállítása szükséges!</b>');
DEFINE ('_UDDEIM_FILTEREDMESSAGE', 'üzenet megszûrve');
DEFINE ('_UDDEIM_FILTEREDMESSAGES', 'üzenetek megszûrve');
DEFINE ('_UDDEIM_FILTER', 'Szûrõ:');
DEFINE ('_UDDEIM_FILTER_TITLE_INBOX', 'Csak ettõl a felhasználótól érkezetteket mutassa');
DEFINE ('_UDDEIM_FILTER_TITLE_OUTBOX', 'Csak ennek a felhasználónak címzetteket mutassa');
DEFINE ('_UDDEIM_FILTER_UNREAD_ONLY', 'csak a nem olvasottakat');
DEFINE ('_UDDEIM_FILTER_SUBMIT', 'Szûrõ');
DEFINE ('_UDDEIM_FILTER_ALL', '- összes -');
DEFINE ('_UDDEIM_FILTER_PUBLIC', '- publikus felhasználók -');
DEFINE ('_UDDEADM_FILTER_HEAD', 'Szûrõ engedélyezése');
DEFINE ('_UDDEADM_FILTER_EXP', 'Használata esetén a beérkezett és elküldött üzenetek listája felhaszálók szerint szürhetõ.');
DEFINE ('_UDDEADM_FILTER_P0', 'kikapcsolva');
DEFINE ('_UDDEADM_FILTER_P1', 'üzenetlista fölött');
DEFINE ('_UDDEADM_FILTER_P2', 'üzenetlista alatt');
DEFINE ('_UDDEADM_FILTER_P3', 'üzenetlista alatt ÉS fölött');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED', '<b> no%s üzenet%s a in your%s .</b>');	// see next  six lines
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_UNREAD', ' olvasatlan');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_FROM', ' ettõl a felhasználótól');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_TO', ' ennek a felhasználónak');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_INBOX', ' beérkezett üzenetek között');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_OUTBOX', ' elküldött üzenetek között');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_ARCHIVE', ' archívumban');
DEFINE ('_UDDEIM_TODP_TITLE', 'Címzett');
DEFINE ('_UDDEIM_TODP_TITLE_CC', 'Egy vagy több címzett (vesszõvel elválasztva)');
DEFINE ('_UDDEIM_ADDCCINFO_TITLE', 'Használatakor a sorban az üzenet összes címzettje megjelenik.');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_2', '...alapértelmezetté tétele az automatikus válaszolónak, automatikus továbbítónak, postaládának, szûrõnek');
DEFINE ('_UDDEADM_AUTORESPONDER_HEAD', 'Automatikus válaszoló');
DEFINE ('_UDDEADM_AUTORESPONDER_EXP', 'Használatakor a felhasználó automatikus értesítést kap a beállítottak szerint.');
DEFINE ('_UDDEIM_EMN_AUTORESPONDER', 'Automatikus válaszoló engedélyezése');
DEFINE ('_UDDEIM_AUTORESPONDER', 'Automatikus válaszoló');
DEFINE ('_UDDEIM_AUTORESPONDER_EXP', 'Az automatikus válaszoló az összes beérkezõ üzenetre választ küld.');
DEFINE ('_UDDEIM_AUTORESPONDER_DEFAULT', "Jelenleg sajnos nem vagyok elérhetõ.\nAmint tudok válaszolok az üzeneteimre.");
DEFINE ('_UDDEADM_USERSET_AUTOR', 'AutoV');
DEFINE ('_UDDEADM_USERSET_SELAUTOR', '- AutoV -');
DEFINE ('_UDDEIM_USERBLOCKED', 'Falhasználó blokkolva.');
DEFINE ('_UDDEADM_AUTOFORWARD_HEAD', 'Automatikus továbbító');
DEFINE ('_UDDEADM_AUTOFORWARD_EXP', 'Használatával a beérkezõ üzenetek egy másik felhasználó postaládájába továbbítódnak.');
DEFINE ('_UDDEIM_EMN_AUTOFORWARD', 'Automatikus továbbító engedélyezése');
DEFINE ('_UDDEADM_USERSET_AUTOF', 'AutoT');
DEFINE ('_UDDEADM_USERSET_SELAUTOF', '- AutoT -');
DEFINE ('_UDDEIM_AUTOFORWARD', 'Automatikus továbbítás');
DEFINE ('_UDDEIM_AUTOFORWARD_EXP', 'Az új üzenetek egy mésik felhasználónak továbbíthatók.');
DEFINE ('_UDDEIM_THISISAFORWARD', 'Üzenet automatikus továbbítása ');
DEFINE ('_UDDEADM_COLSROWS_HEAD', 'Üzenet doboz (oszlopok/sorok)');
DEFINE ('_UDDEADM_COLSROWS_EXP', 'Megadható az üzenet doboz mérete (alapértelmezett értékek: 60/10).');
DEFINE ('_UDDEADM_WIDTH_HEAD', 'Üzenet doboz (szélessége)');
DEFINE ('_UDDEADM_WIDTH_EXP', 'Megadható az üzenet doboz szélessége pixelben (alapértelmezett 0). Amennyiben 0, a rendszer a CSS-ben tárolt értékeket fogja használni.');
...
DEFINE ('_UDDEADM_MOOTOOLS_EXP', 'Ez határozza meg, hogy hogyan töltse be az uddeIM a MooTools-t (a MooTools az Autocompleter-hez szükséges): <i>Nincs</i> ezt akkor válasszuk, hogyha a template-bõl töltjük be a MooTools-t, <i>Auto</i> ajánlott alapértelmezett (ugyanaz, mint az uddeIM 1.2-nél), J1.0 esetében megválaszthatjuk, hogy MooTools 1.1 vagy 1.2-t használjunk.');
...
DEFINE ('_UDDEADM_TIMEZONE_HEAD', 'Idõzóna beállítása');
DEFINE ('_UDDEADM_TIMEZONE_EXP', 'Amennyiben az uddeIM nem megfelelõen mutatja az idõt, át lehet állítani az idõzónát.');
...
DEFINE ('_UDDEADM_STATISTICS_EXP', 'Itt találhatunk néhágy fontos statisztikát az üzeneteinkrõl, pl. tárolt üzenetek száma, stb.');
...
DEFINE ('_UDDEADM_MAINTENANCE_COUNT_SENDER', 'A küldõ által törölt üzenetek: ');
...
DEFINE ('_UDDEADM_SHOWLINK_EXP', 'Amennyiben <i>igen</i>-re állítjuk, az összes uddeIM-ben megjelenõ felhasználónév a felhasználói profilokhoz fog kapcsolódni.');
...
DEFINE ('_UDDEADM_THUMBLISTS_EXP', 'Amennyiben<i>igen</i>-re állítjuk, a felhasználók bélyegképei megjelennek a listában (postaláda, kimenõ, stb.)');
...
DEFINE ('_UDDEADM_REVIEWUPDATE', 'Fontos: Ha az uddeIM-et egy korábbi verzióról frissítjük, feltétlenül olvassuk el a README fájlt! Elõfordulhat ugyanis, hogy adatbázis táblákat vagy mezõket kell felvennünk vagy módosítanunk!');
...
DEFINE ('_UDDEIM_PLUG_SENDER', 'Küldõ');
DEFINE ('_UDDEIM_PLUG_MESSAGE', 'Üzenet');
DEFINE ('_UDDEIM_PLUG_EMPTYINBOX', 'Üres a postaláda');
...
"Hello %you%,\n\n%user% a következõ privát üzenetet küldte a %site% szájtról.\n__________________\n%pmessage%");
...
DEFINE ('_UDDEIM_YOUHAVETOWAIT', 'Elnézést, de az új üzenet küldése elõtt várni kell!');
DEFINE ('_UDDEADM_USERSET_LASTSENT', 'Utoljára küldött');
DEFINE ('_UDDEADM_TIMEDELAY_HEAD', 'Idõköz');
DEFINE ('_UDDEADM_TIMEDELAY_EXP', 'Idõ, amelynek el kell telnie két üzenet küldse között (0, ha nincsen várakoztatás).');
DEFINE ('_UDDEADM_SECONDS', 'másodperc');
DEFINE ('_UDDEIM_PUBLICSENT', 'Üzenet elküldve.');
DEFINE ('_UDDEIM_ERRORINFROMNAME', 'Hiba a küldõ nevében');
...
DEFINE ('_UDDEADM_VERSIONCHECK_EXP', 'Felkapcsolódik az uddeIM fejlesztõi weboldalára, a jelenlegi legfrissebb verzió ellenörzéséért.');
DEFINE ('_UDDEADM_VERSIONCHECK_CHECK', 'ELLENÕRZÉS');
...
DEFINE ('_UDDEADM_ENABLELISTS_EXP', 'Az uddeIM lehetõvé teszi, hogy a felhasználók címlistákat hozzanak létre. Ezekkel a listákkal egyszerûen küldhetõ üzenet több címzettnek. Ne felejtsük el bekapcsolni a "Több címzett engedélyezését", ha címlistát szeretnénk használni.');
...
DEFINE ('_UDDEADM_UNBLOCKCB_EXP', 'Azoknak a felhasználóknak lehet üzenetet küldeni, akik a CB ismerõs listán szerepelnek. (mégha az adott felhasználó a blokkolt listán szerepel is). Ez a beállítás független a felhasználók egyéni blokkolásától. (lásd a fenti beállítást).');
...
DEFINE ('_UDDEADM_BLOCKGROUPS_19', 'Szerzõ');
DEFINE ('_UDDEADM_BLOCKGROUPS_20', 'Szerkesztõ');
DEFINE ('_UDDEADM_BLOCKGROUPS_21', 'Közzétevõ');
...
DEFINE ('_UDDEADM_PUBHIDEALLUSERS_HEAD', '"Összes tag" lista elrejtése a vendég felhasználók elõl');
DEFINE ('_UDDEADM_PUBHIDEALLUSERS_EXP', 'A publikus hozzáférés elõl több csoportot is elrejthetünk az "Összes tag" listában. Figyelem: Ez csak a neveket rejti el, ettõl még küldhetõ a felhasználónak üzenet. Azok a tagok, akik lekapcsolják a publikus megjelenést, nem fognak szerepelni ebben a listában!');
DEFINE ('_UDDEADM_HIDEALLUSERS_HEAD', 'Elrejtés az "Összes tag" listából');
DEFINE ('_UDDEADM_HIDEALLUSERS_EXP', 'A hozzáférés elõl több csoportot is elrejthetünk az "Összes tag" listában. Figyelem: Ez csak a neveket rejti el, ettõl még küldhetõ a felhasználónak üzenet.');
...
DEFINE ('_UDDEADM_PUBMODESHOWALLUSERS_HEAD', 'Az "Összes tag" lista link mûködése');
...
DEFINE ('_UDDEADM_DONATE', 'Ha elégedett vagy az uddeIM-mel egy kis adománnyal segítheted a fejlesztõk munkáját.');
// New: 1.0rc2
...
DEFINE ('_UDDEADM_LANGUAGECHARSET_EXP', 'A Joomla 1.0-nél általában az <strong>(ISO-8859-1)</strong> (alapértlemezett) a megfelelõ, Joomla 1.5-höz pedig a <strong>UTF-8</strong> javasolt.');
...
DEFINE ('_UDDEIM_READ_INFO_2', ' napig maradnak a postaládában, azután automatikusan törlõdni fognak.');
DEFINE ('_UDDEIM_UNREAD_INFO_1', 'Az olvasatlan üzenetek maximum ');
DEFINE ('_UDDEIM_UNREAD_INFO_2', ' napig maradnak a postaládában, azután automatikusan törlõdni fognak.');
DEFINE ('_UDDEIM_SENT_INFO_1', 'Az elküldött üzenetek maximum ');
DEFINE ('_UDDEIM_SENT_INFO_2', ' napig maradnak a postaládában, azután automatikusan törlõdni fognak.');
DEFINE ('_UDDEADM_DELETEREADAFTERNOTE_HEAD', 'Cimke megjelenítése az olvasott üzenetknél');
DEFINE ('_UDDEADM_DELETEREADAFTERNOTE_EXP', 'Cimke megjelenítése \"Az olvasott üzenetek n nap múlva törlõdnek\" ');
DEFINE ('_UDDEADM_DELETEUNREADAFTERNOTE_HEAD', 'Cimke megjelenítése az olvasatlan üzenetknél');
DEFINE ('_UDDEADM_DELETEUNREADAFTERNOTE_EXP', 'Cimke megjelenítése \"Az olvasatlan üzenetek n nap múlva törlõdnek\" ');
DEFINE ('_UDDEADM_DELETESENTAFTERNOTE_HEAD', 'Cimke megjelenítése az elküldött üzenetknél');
DEFINE ('_UDDEADM_DELETESENTAFTERNOTE_EXP', 'Cimke megjelenítése \"Az olvasatlan üzenetek n nap múlva törlõdnek\" ');
DEFINE ('_UDDEADM_DELETETRASHAFTERNOTE_HEAD', 'Cimke megjelenítése a kukában lévõ üzenetknél');
DEFINE ('_UDDEADM_DELETETRASHAFTERNOTE_EXP', 'Cimke megjelenítése \"A kukában lévõ üzenetek n nap múlva törlõdnek\"');
DEFINE ('_UDDEADM_DELETESENTAFTER_HEAD', 'Elküldött üzenek megtartása  napig');
DEFINE ('_UDDEADM_DELETESENTAFTER_EXP', 'Adjuk meg, hogy az <b>elküldött</b> uzenetek hány nap múlva törlõdjenek a postaládából.');
...
DEFINE ('_UDDEADM_USERSET_EXISTING', 'létezõ');
DEFINE ('_UDDEADM_USERSET_NONEXISTING', 'nem létezõ');
...
DEFINE ('_UDDEADM_USERSET_WHENOFFLINEEXCEPT', 'Ha nem elérhetõ (kivéve a válaszok)');
DEFINE ('_UDDEADM_USERSET_ALWAYSEXCEPT', 'Mindíg (kivéve a válaszok)');
DEFINE ('_UDDEADM_USERSET_WHENOFFLINE', 'Ha nem elérhetõ');
DEFINE ('_UDDEADM_USERSET_ALWAYS', 'Mindíg');
DEFINE ('_UDDEADM_USERSET_NONOTIFICATION', 'Nincs értesítõ');
DEFINE ('_UDDEADM_WELCOMEMSG', "Köszöntünk az uddeIM magánüzenet küldõ rendszerben!\n\nSikeresen telepítetted az uddeIM komponenst.\n\nPróbáljuk ki a többi sablont is, ezeket az uddeIM adminisztraciós felületén lehet váltani.\n\nAz uddeIM jelenleg is fejlesztés alatt áll, ezért bármilyen hiba, hiányosság vagy probléma esetén érdemes jelezni a fejlesztõknek, hogy együtt jobbá tudjuk tenni ezt a közösségi kapcsolattartó rendszert.\n\nMinden jót kívánunk az uddeIM használatához!");
DEFINE ('_UDDEADM_UDDEINSTCOMPLETE', 'Az uddeIM telepítése befejezve.');
DEFINE ('_UDDEADM_REVIEWSETTINGS', 'Az adminisztrációs felület beállításaival lehet befejezni a rendszer beüzemelését.');
DEFINE ('_UDDEADM_REVIEWLANG', 'Amennyiben a keretrendszer az ISO 8859-1 -tõl eltérõ karakterkódolást használ, feltétlenül ellenõrízzük az uddeIM kapcsolódó beállításait.');
DEFINE ('_UDDEADM_REVIEWEMAILSTOP', 'A telepítés után az összes uddeIM email forgalom (email értesítõk, emlékeztetõk) lekapcsolásra kerül, így ameddig a rendszer beállítása és tesztelése folyik addig ezek az emailek nem kerülnek kiküldésre! Ha végeztünk a rendszerünk finomhangolásával ne felejtsük el kikapcsolni a "emailek leállítása" opciót az adminisztrációs menüben!');
...
DEFINE ('_UDDEADM_SEARCHINSTRING_EXP', 'Szövegen belüli keresés (egyébként mindig csak a kezdetektõl keres)');
...
DEFINE ('_UDDEADM_CONFIGNOTWRITEABLE', 'A beállítások nem menthetõk:');
DEFINE ('_UDDEADM_CONFIGWRITEABLE', 'A beállítások menthetõk:');
...
DEFINE ('_UDDEADM_MAILSYSTEM_EXP', 'Válasszuk ki az uddeIM értesítõinek emailküldési módját.');
...
DEFINE ('_UDDEIM_FWDFROM', 'Eredeti üzenet küldõje:');
...
DEFINE ('_UDDEADM_ALLOWMULTIPLERECIPIENTS_EXP', 'Több címzett engedélyezése (vesszõvel elválasztva pl. Pisti,Józsi,Peti).');
...
DEFINE ('_UDDEADM_CBALLOWMULTIPLEUSER_HEAD', 'Ismerõsök kiválasztása a címzettekhez');
DEFINE ('_UDDEADM_CBALLOWMULTIPLEUSER_EXP', 'Ezáltal a CB \"Ismerõs\" listából is választhatunk címzetteket.');
DEFINE ('_UDDEADM_PMSFOUND', 'PMS-t találtunk: ');
DEFINE ('_UDDEIM_ENTERNAME', 'név megadása');
DEFINE ('_UDDEADM_USEAUTOCOMPLETE_HEAD', 'Autokiegészítõ használata');
DEFINE ('_UDDEADM_USEAUTOCOMPLETE_EXP', 'Autokiegészítõ használata a címzettek megadásakor.');
...
DEFINE ('_UDDEADM_CFGFILE_NOTFOUND', 'Nem megfelelõ konfigurációs fájlt találtunk!');
...
DEFINE ('_UDDEADM_MAINTENANCE_D1', 'Hibás törlési dátum (beérkezõ/kimenõ levelek): ');
...
DEFINE ('_UDDEADM_SHOWACTIONICONS_HEAD', 'Mûveleti ikonok megjelenítése');
DEFINE ('_UDDEADM_SHOWACTIONICONS_EXP', 'Amennyiben <i>igen</i> re állítjuk, a mûveleteket szöveg helyett ikonokkal fogjuk helyettesíteni.');
...
DEFINE ('_UDDEADM_POPUP_HEAD','Felugró értesítõ');
...
DEFINE ('_UDDEADM_POPUPDEFAULT_HEAD', 'Felugró értesítõablak alapértelmezettként');
DEFINE ('_UDDEADM_POPUPDEFAULT_EXP', 'Felugró értesítõablak engedélyezése alapértelmezettként, azoknak a felhasználóknak, akik ezt a beállítást még nem változtatták meg.');
...
DEFINE ('_UDDEADM_MAINTENANCE_EXP', "Ha egy felhasználót töröltünk az adatbázisból, az üzenete még megmaradhatott valahol. Ez a funkció lehetõvé teszi, hogy a gazdátlan üzeneteket szükség esetén törölhessük.<br />Továbbá kisebb adatbázis hibákat is javítani tudunk.");
DEFINE ('_UDDEADM_MAINTENANCE_MC1', "Ellenörzés...<br />");
DEFINE ('_UDDEADM_MAINTENANCE_MC2', "<i>#nnn (Username): [postaláda|postaláda törölt|kimenõ mappa|kimenõ törölt]</i><br />");
DEFINE ('_UDDEADM_MAINTENANCE_MC3', "<i>postaláda: a beérkezett üzenetek a felhasználók postaládájában tárolódnak</i><br />");
DEFINE ('_UDDEADM_MAINTENANCE_MC4', "<i>postaláda törölt: üzenetek a postaládából törölve, de valakinek a kimenõ mappájában még szerepel</i><br />");
DEFINE ('_UDDEADM_MAINTENANCE_MC5', "<i>kimenõ mappa: az elküldött üzenetek a kimenõ mappába kerülnek</i><br />");
DEFINE ('_UDDEADM_MAINTENANCE_MC6', "<i>kimenõ törölt: a kimenõ mappából már törölték, de a címzett postaládájában még szerepel</i><br />");
...
DEFINE ('_UDDEIM_TRASHCAN_INFO', 'Az üzenetek a törlés elõtt 24 óráig a kukában maradnak. Csak az üzenet elsõ néhány szava látható. Az üzenet elolvasásához elõször vissza kell helyezni a postaládába.');
DEFINE ('_UDDEIM_TRASHCAN_INFO_1', 'Az üzenetek ennyi ideig marajanak a kukában: ');
DEFINE ('_UDDEIM_TRASHCAN_INFO_2', ' utána törlõdni fognak. Csak az üzenet elsõ néhány szava látható. Az üzenet elolvasásához elõször vissza kell helyezni a postaládába.');
DEFINE ('_UDDEIM_RECALLEDMESSAGE_INFO', 'Az üzenetet visszahívtuk. Olvasható vagy újra küldhetõ.');
DEFINE ('_UDDEIM_COULDNOTRECALL', 'Az üzenetet nem tudtuk visszahívni! (pl. vagy már elolvasták, vagy kitörölték)');
DEFINE ('_UDDEIM_CANTRESTORE', 'Az üzenetet nem tudtuk visszaállítani. (Túl sokáig volt a kukában, és végleg törlõdött.)');
...
DEFINE ('_UDDEIM_NOMESSAGES_OUTBOX', '<strong>Nincsen üzenet a kimenõ mappában!</strong>');
DEFINE ('_UDDEIM_NOMESSAGES_TRASHCAN', '<strong>A kuka üres!</strong>');
DEFINE ('_UDDEIM_INBOX', 'Postaláda');
DEFINE ('_UDDEIM_OUTBOX', 'Kimenõ mappa');
...
DEFINE ('_UDDEIM_OUTBOX_WARNING', 'A kimenõ mappában találhatók az elküldött üzenetek, ameddig törlésre nem kerülnek. Vissza lehet hívni egy elküldött üzenetet, ameddig a címzett enm olvasta el vagy nem törölte. Az üzenet visszahívásakor kikerül a címzett postaládájából! ');
	// changed in 0.4
...
DEFINE ('_UDDEIM_MESSAGENOACCESS', 'ez az üzenet nem jeleníthetõ meg. <br />Lehetséges okok:<ul><li>Nincsen jogod elolvasni ezt az üzenetet</li><li>Az üzenetet törölték</li></ul>');
...
DEFINE ('_UDDEIM_DELETEREPLIED', 'A választ követõen az erdeti üzenet kerüljön a kukába');
...
DEFINE ('_UDDEIM_NOMESSAGE', 'Hiba: Az üzenet nem tartalmaz szöveget! Az üzenetet nem küldtük el.');
...
DEFINE ('_UDDEIM_VIOLATION', '<b>Hiba a folyamatban!</b> Ehhez a mûvelethez nincsen jogosultságod!');
...
DEFINE ('_UDDEADM_DATESETTINGS', 'Dátum/idõ');
...
DEFINE ('_UDDEADM_DELETETRASHAFTER_HEAD', 'Kukában lévõ üzenetek megörzése (napok)');
DEFINE ('_UDDEADM_DAYS', 'nap(ok)');
DEFINE ('_UDDEADM_DELETEREADAFTER_EXP', 'Adjuk meg a napok számát miután az <b>olvasott</b> üzenetek törlésre kerülnek a postaládából. Ha nem akarjuk, hogy az üzenetek maguktól törlõdjenek, nagyon nagy értéket adjunk meg (pl. 36524 nap egy évszázad). De tartsuk szemelõtt, hogy az adatbázis hamar megtelhet az üzenetekkel! Szóval csak okosan! ');
...
DEFINE ('_UDDEADM_DATEFORMAT_EXP', 'Válasszuk ki a megjelenõ dátum formátumot. A hónapok nevei az aktuális nyelvi beállítások szerint fognak megjelenni (amennyiben a megfelelõ uddeIM nyelvi fájl létezik!).');
DEFINE ('_UDDEADM_LDATEFORMAT_HEAD', 'Hosszabb dátum megjelenése');
DEFINE ('_UDDEADM_LDATEFORMAT_EXP', 'Az üzenet megnyitésakor nagyobb hely van a dátum megjelenítésére, ekkor a hosszabb dátumformátum fog megjelenni, ezért fontos, hogy ezt is megfelelõen beállítsuk. A napok és a hónapok nevei az aktuális nyelvi beállítások szerint fognak megjelenni (amennyiben a megfelelõ uddeIM nyelvi fájl létezik!).');
...
DEFINE ('_UDDEADM_ADMINIGNITIONONLY_EXP', 'Az automatikus törlés nagyon megterhelheti a szervert. Ha az <i>igen,&nbsp;csak&nbsp;az&nbsp;adminisztrátor</i> beállítást választottuk, akkor az összes felhasználók összes üzenetei megjelennek az adminisztrátor postaládájában! ezt akkor válasszuk, ha az adminisztrátor gyakran látogatja az oldalt és ellenörzi a postaládáját. Kis weboldalaknál állítsuk <i>nem,&nbsp;bárki</i>-re. Ha nem értjük pontosan ennek a mûködését, akkor is <i>nem,&nbsp;bárki</i>-re állítsuk!');

	// above string changed in 0.4
DEFINE ('_UDDEADM_SAVESETTINGS', 'Beállítások mentése');
DEFINE ('_UDDEADM_THISHASBEENSAVED', 'A kovetkezõ beállítások kerültek mentésre:');
DEFINE ('_UDDEADM_SETTINGSSAVED', 'A beállításokat elmentettük.');
DEFINE ('_UDDEADM_ICONONLINEPIC_HEAD', 'Ikon: felhasználó elérhetõ');
DEFINE ('_UDDEADM_ICONONLINEPIC_EXP', 'Ha másik ikonnal szeretnénk jelezni a felhasználó állapotát, adjuk meg a megfelelõ elérési utat.');
DEFINE ('_UDDEADM_ICONOFFLINEPIC_HEAD', 'Ikon: felhasználó nem elérhetõ');
DEFINE ('_UDDEADM_ICONOFFLINEPIC_EXP', 'Ha másik ikonnal szeretnénk jelezni a felhasználó állapotát, adjuk meg a megfelelõ elérési utat.');
DEFINE ('_UDDEADM_ICONREADPIC_HEAD', 'Ikon: üzenet olvasása');
DEFINE ('_UDDEADM_ICONREADPIC_EXP', 'Ha másik ikonnal szeretnénk jelezni az üzenet olvasását, adjuk meg a megfelelõ elérési utat.');
DEFINE ('_UDDEADM_ICONUNREADPIC_HEAD', 'Ikon: olvasatlan üzenet');
DEFINE ('_UDDEADM_ICONUNREADPIC_EXP', 'Ha másik ikonnal szeretnénk jelezni az olvasatlan üzenetet, adjuk meg a megfelelõ elérési utat.');
DEFINE ('_UDDEADM_MODULENEWMESS_HEAD', 'Modul: Új üzenet ikon');
DEFINE ('_UDDEADM_MODULENEWMESS_EXP', 'Ez a beállítás a mod_uddeim_new modult állítja. Adjuk meg az új üzenetet jelzõ ikon elérési útját, ha másikat szeretnénk használni.');

// admin import tab

DEFINE ('_UDDEADM_UDDEINSTALL', 'uddeIM telepítés');
DEFINE ('_UDDEADM_FINISHED', 'A telepítés befejezõdött. Köszöntjük az uddeIM magánüzenetküldõ rendszerben! ');
...
DEFINE ('_UDDEADM_PMSFOUND_2', ' üzenetet a korábbi PMS-bõl. Importáljuk az uddeIM-be?');
DEFINE ('_UDDEADM_IMPORT_EXP', 'Ez nem befolyásolja a jelenegi telepítést vagy a korábbi üzeneteket, sértetlenek maradnak. Mielõtt az importálást elkezdenénk mentsül el az idõközben módosított beállításokat. A jelenelgi uddeIM üzenetek is sértetlenek maradnak.');
...
DEFINE ('_UDDEADM_IMPORTDONE', 'Az importálás befejezõdött. Ne indítsuk el újra az importálást, különben az adatok duplán fognak szerepelni!');
...
DEFINE ('_UDDEIM_BLOCKS_EXP', 'A blokkolt felhasználók listája. Ezektõl a felhasználóktól nem fogadunk üzeneteket.');
...
DEFINE ('_UDDEADM_BLOCKALERT_EXP', 'Ha <i>igen</i>-re állítjuk, a blokkolt felhasználó értesítést kap, hogy az üzenetét nem tudja elküldeni, mert a címzett blokkolta õt. Ha <i>nem</i>-re állítjuk, a blokkolt felhasználó nem kap semmilyen értesítést, hogy az üzenete nem lett kézbesítve.');
...
DEFINE ('_UDDEADM_EMAILWITHMESSAGE_EXP', 'Ha <i>nem</i>-re állítjuk, az email csak értesít minket új üzenet érkezésérõl, de maga az üzenet nem fog szerepelni benne.');
DEFINE ('_UDDEADM_LONGWAITINGEMAIL_HEAD', 'Emlékeztetõ email');
DEFINE ('_UDDEADM_LONGWAITINGEMAIL_EXP', 'Ezzel emlékeztetõt küld a rendszer azoknak a felhasználóknak, akiknek régóta olvasatlan üzenetek vannak a postafiókjukban. Mivel ez független az email értesítõ beállításától, ezért külön kell ki-be kapcsolnunk!');
DEFINE ('_UDDEADM_LONGWAITINGDAYS_HEAD', 'Emlékeztetõ küldési ideje ');
DEFINE ('_UDDEADM_LONGWAITINGDAYS_EXP', 'Ha az emlékeztetõ be van kapcsolva, adjuk meg, hogy hány nap elteltével küldjön a rendszer emlékeztetõ emailt.');
DEFINE ('_UDDEADM_FIRSTWORDSINBOX_HEAD', 'Listában szereplõ karakterek száma');
DEFINE ('_UDDEADM_FIRSTWORDSINBOX_EXP', 'Beállíthatjuk, hogy hány karakter szerepeljen a postaláda, kimenõ mappa és a kuka listázásakor.');
DEFINE ('_UDDEADM_MAXLENGTH_HEAD', 'Üzenet maximális hossza');
DEFINE ('_UDDEADM_MAXLENGTH_EXP', 'Beállíthatjuk az üzenet maximális hosszát. \'0\'-re állítva bármilyen hosszú üzenet küldhetõ (NEM AJÁNLOTT!).');
...
DEFINE ('_UDDEADM_SYSM_USERNAME_EXP', 'uddeIM támogatja a rendszer üzenetek küldését. Ezeknek az üzeneteknek nem lesz igazi feladójuk, és a felhasználók nem is tudnak válaszolni rájuk. Adjuk meg a rendszer üzenet küldõjének kódnevét (pl. <i>Support</i> vagy <i>Ügyfélszolgálat</i> vagy <i>Koordinátor</i>)');
...
DEFINE ('_UDDEADM_EMN_SENDERNAME_HEAD', 'Email küldõ neve');
DEFINE ('_UDDEADM_EMN_SENDERNAME_EXP', 'Az értesítõ email küldõje, pl <i>weboldal címe</i>)');
DEFINE ('_UDDEADM_EMN_SENDERMAIL_HEAD', 'Email küldõ címe');
DEFINE ('_UDDEADM_EMN_SENDERMAIL_EXP', 'Adjuk meg az email címet, ahonnan az értesítõ érkezett. (Érdemes az oldal általános emailcímét használni.');
...
DEFINE ('_UDDEADM_ALLOWARCHIVE_EXP', 'Válasszuk ki, hogy mely felhasználók archíválhatják az üzeneteiket. Az archívumban lévõ üzenetek nem lesznek törölve.');
...
DEFINE ('_UDDEADM_TRASHORIGINAL_EXP', 'Ha bekapcsoljuk, válasz küldésekor az eredeti üzenet törlõdni fog a postaládából a kukába. Ezzel kordában tartható az adatbázis mérete, és a postaláda is áttekinthetõbb marad.');
	// translators info: 'Send' is the same as _UDDEIM_SUBMIT,
	// and 'trash original' the same as _UDDEIM_TRASHORIGINAL

DEFINE ('_UDDEADM_PERPAGE_HEAD', 'Egy oldalon megjelenõ üzenetek száma');
DEFINE ('_UDDEADM_PERPAGE_EXP', 'Meghatározhatjuk az egy oldalon szereplõ üzenetek számát a postaládában, kimenõ mappában, kukában.');
...
DEFINE ('_UDDEADM_EMN_BODY_NOMESSAGE_EXP', 'Ez az értesítõ email tartalma. Maga az üzenet nem fog szerepelni az emailben. Az alábbi változókat õrízzük meg: %you%, %user% és %site%  ');
DEFINE ('_UDDEADM_EMN_BODY_WITHMESSAGE_EXP', 'Ez az értesítõ email tartalma. Az email tartalmazni fogja magát az üzenetet is! Az alábbi változókat õrízzük meg: %you%, %user%, %pmessage% és %site%  ');
DEFINE ('_UDDEADM_EMN_FORGETMENOT_EXP', 'Ez az emlékeztetõ email tartalma. Az alábbi változókat õrízzük meg: %you% és %site%  ');
...
DEFINE ('_UDDEADM_EXPORT_FORMAT_EXP', 'Az a lehívó email formátuma. Az alábbi változókat õrízzük meg %user%, %msgdate% és %msgbody% ');
...
DEFINE ('_UDDEADM_ARCHIVETOTRASH_LEAVE_LINK', 'Hagyjuk õket');
DEFINE ('_UDDEADM_ARCHIVETOTRASH_LEAVE_EXP', 'Hagyjuk az archívumban (a felhasználó enm tudja olvasni õket, de a postaláda üzenetkorlátját ugyanúgy foglalja!)');
...
DEFINE ('_UDDEIM_SYSGM_PLEASECONFIRM', 'Az alul lévõ üzenet fog kiküldésre kerülni. Nézzük át és küldjük ki vagy töröljük!');
...
DEFINE ('_UDDEIM_SYSGM_CHECKLINK', '<b>Ellenõrizzük a linket (kattintsunk rá!) az elfogadás elõtt!</b>');
...
DEFINE ('_UDDEIM_EMNOFF', 'Email értesítõ kikapcsolva. ');
DEFINE ('_UDDEIM_EMNON', 'Email értesítõ bekapcsolva. ');
...
"Kedves %you%!\n\nOlvasatlan üzeneted van a %site%-on lévõ postaládádban. Az elolvasásukhoz jelentkezz be az oldalon!");
...
DEFINE ('_UDDEIM_ARCHIVE_ERROR', 'Az üzenetek archívumba történõ mozgatása meghiúsult.');
...
DEFINE ('_UDDEIM_ARC_SAVED_3', 'Az üzenet mentéséhez elõbb törölnöd kell valamelyik korábbi üzenetet!');
DEFINE ('_UDDEIM_ARC_CANSAVEMAX_1', 'Maximum ');
DEFINE ('_UDDEIM_ARC_CANSAVEMAX_2', ' üzenet menthetõ.');
...
DEFINE ('_UDDEADM_SHOWTITLE_EXP', 'Külön megadhatjuk a magánüzenet rendszer nevét, pl. \'Magán Üzenetek\'. Hagyjuk üresen, ha nem akarunk fõcímet használni.');
...
DEFINE ('_UDDEADM_STOPALLEMAIL_EXP', 'Kapcsoljuk be, hogy letiltsuk az uddeIM email küldését (email értesítõk és emlékeztetõk) hasznos, miközben teszteljük az oldalt. Ha nem akarjuk használni állítsuk <i>nem</i>-re.');
DEFINE ('_UDDEADM_GETPICLINK_HEAD', 'CB avatarok a listában');
DEFINE ('_UDDEADM_GETPICLINK_EXP', 'Állítsuk <i>igen</i>-re, ha a postaláda, kimenõ mappa vagy kuka listában meg szeretnénk jeleníteni a feladó nevénél a CB avatarját is.');
...
DEFINE ('_UDDEIM_EMN', 'Email értesítõ');
DEFINE ('_UDDEIM_EMN_EXP', 'Új üzenet érkezésérõl emailben kaphatsz értesítést.');
DEFINE ('_UDDEIM_EMN_ALWAYS', 'Emailes értesítés új üzenet érkezésérõl');
DEFINE ('_UDDEIM_EMN_NONE', 'Nincs emailes értesítõ');
DEFINE ('_UDDEIM_EMN_WHENOFFLINE', 'Email értesítõ, ha nem vagyok bejelentkezve');
DEFINE ('_UDDEIM_EMN_NOTONREPLY', 'Válaszokról ne küldjön értesítõt');
DEFINE ('_UDDEIM_BLOCKSYSTEM', 'Felhasználók blokkolása'); // Headline for blocking system in settings
DEFINE ('_UDDEIM_BLOCKSYSTEM_EXP', 'Blokkolhatunk felhasználókat, akiktõl nem szeretnénk fogadni üzeneteket. Válasszuk a <i>felhasználó blokkolása</i>-t, amikor a felhasználótól érkezett üzenetet olvassuk.'); // block user is the same as _UDDEIM_BLOCKNOW
DEFINE ('_UDDEIM_SAVECHANGE', 'Beállítások mentése');
DEFINE ('_UDDEIM_TOOLTIP_BOLD', 'BB kód vastag szöveghez. Használata: [b]vastag[/b]');
DEFINE ('_UDDEIM_TOOLTIP_ITALIC', 'BB kód dõlt szöveghez. Használata: [i]dõlt[/i]');
