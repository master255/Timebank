...
// *******************************************************************
DEFINE ('_UDDEADM_TRANSLATORS_CREDITS', 'Preveo <a href="http://fedora.fsn.rs" target="_new">Fedora Srbija</a> tim');	// Empty for English and German language files, enter your credits line here, e.g. 'Translation by <a href="http://domain.com" target="_new">John Doe</a>'
...
// New: 2.3
DEFINE ('_UDDEADM_CC_HEAD', 'Dugme „Prikaži CC: red“');
DEFINE ('_UDDEADM_CC_EXP', 'Kada je omogućeno, korisnik može da izabere da li će uddeIM dodati CC: red koji sadrži sve primaoce poruke ili ne.');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_9', '...postavljeno podrazumevano za CC: red i moderaciju');
DEFINE ('_UDDEIM_TOOLBAR_MCP', 'Centar za poruke');
DEFINE ('_UDDEIM_TOOLBAR_REMOVEMESSAGE', 'Obriši poruku');
DEFINE ('_UDDEIM_TOOLBAR_DELIVERMESSAGE', 'Dostavi poruku');
DEFINE ('_UDDEADM_OOD_MCP', 'Dodatak centra za poruke je zastareo!');
DEFINE ('_UDDEADM_MCP_STAT', 'Poruke za moderaciju:');
DEFINE ('_UDDEADM_MCP_TRASHED', 'Bačeno');
DEFINE ('_UDDEADM_MCP_NOTEDEL', 'Obrisati ovu poruku iz baze podataka?');
DEFINE ('_UDDEADM_MCP_NOTEDELIVER', 'Dostaviti ovu poruku primaocu?');
DEFINE ('_UDDEADM_MCP_SHOWHIDE', 'Prikaži/sakrij');
DEFINE ('_UDDEADM_MCP_EDIT', 'Kontrolni centar za poruke');
DEFINE ('_UDDEADM_MCP_FROM', 'Od');
DEFINE ('_UDDEADM_MCP_TO', 'Za');
DEFINE ('_UDDEADM_MCP_TEXT', 'Poruka');
DEFINE ('_UDDEADM_MCP_DELETE', 'Obriši');
DEFINE ('_UDDEADM_MCP_DATE', 'Datum');
DEFINE ('_UDDEADM_MCP_DELIVER', 'Dostavi');
DEFINE ('_UDDEADM_USERSET_MODERATE', 'Mod');
DEFINE ('_UDDEADM_USERSET_SELMODERATE', '- Mod -');
DEFINE ('_UDDEIM_MCP_MODERATED', 'Vaše poruke će biti moderisane. Moderator će ih proveriti pre nego što budu isporučene primaocima.');
DEFINE ('_UDDEIM_STATUS_DELAYED', 'Čeka se na moderatora');
DEFINE ('_UDDEADM_MODNEWUSERS_HEAD', 'Moderiši nove korisnike');
DEFINE ('_UDDEADM_MODNEWUSERS_EXP', 'Kada je omogućeno, poruke novo registrovanih korisnika će biti podrazumevano moderisane.');
DEFINE ('_UDDEADM_MODPUBUSERS_HEAD', 'Moderiši javne korisnike');
DEFINE ('_UDDEADM_MODPUBUSERS_EXP', 'Kada je omogućeno, poruke javnih korisnika će biti moderisane.');
DEFINE ('_UDDEIM_MENUICONS_P3', 'Bez menija');

// New: 2.2
DEFINE ('_UDDEADM_OOD_PF', 'Dodatak javnog sučelja je zastareo!');
DEFINE ('_UDDEADM_OOD_A', 'Dodatak za prilaganje datoteka je zastareo!');
DEFINE ('_UDDEADM_OOD_RSS', 'Dodatak za RSS je zastareo!');
DEFINE ('_UDDEADM_OOD_ASC', 'Dodatak centra za izveštaje o porukama je zastareo!');
DEFINE ('_UDDEIM_NOMESSAGES3_FILTERED', '<b>Nemate filtriranih poruka u%s.</b>');
DEFINE ('_UDDEIM_FILTER_UNREAD', 'nepročitane');
DEFINE ('_UDDEIM_FILTER_FLAGGED', 'označene');
DEFINE ('_UDDEADM_GRAVATAR_HEAD', 'gravatari su uključeni');
DEFINE ('_UDDEADM_GRAVATAR_EXP', 'Omogućava podršku za gravatare.');
DEFINE ('_UDDEADM_GRAVATARD_HEAD', 'skup gravatara');
DEFINE ('_UDDEADM_GRAVATARD_EXP', 'Izaberite skup za podrazumevane slike.');
DEFINE ('_UDDEADM_GRAVATARR_HEAD', 'ocena gravatara');
DEFINE ('_UDDEADM_GRAVATARR_EXP', 'Podrazumevano se prikazuju samo slike ocenjene sa „G“ osim ako ne naznačite višu ocenu. „X“ prikazuje sve slike gravatara.');
DEFINE ('_UDDEADM_GR404', '404');
DEFINE ('_UDDEADM_GRMM', 'mm');
DEFINE ('_UDDEADM_GRIDENTICON', 'identikona');
DEFINE ('_UDDEADM_GRMONSTERID', 'monsterid');
DEFINE ('_UDDEADM_GRWAVATAR', 'vavatar');
DEFINE ('_UDDEADM_GRRETRO', 'retro');
DEFINE ('_UDDEADM_GRDEFAULT', 'podrazumevano');
DEFINE ('_UDDEADM_GRG', 'G = opšte');
DEFINE ('_UDDEADM_GRPG', 'PG = roditeljsko usmeravanje');
DEFINE ('_UDDEADM_GRR', 'R = ograničeno');
DEFINE ('_UDDEADM_GRX', 'X = samo za odrasle');
DEFINE ('_UDDEADM_NINJABOARD', 'Ninjaboard');
DEFINE ('_UDDEADM_KUNENA16', 'Kunena 1.6+');
DEFINE ('_UDDEIM_PROCESSING', 'Obrađujem...');
DEFINE ('_UDDEIM_SEND_NONOTIFY', 'Ne šalji e-poruke obaveštenja');
DEFINE ('_UDDEIM_SYSGM_NONOTIFY', 'E-poruke obaveštenja neće biti poslata');
DEFINE ('_UDDEIM_SYSGM_FORCEEMBEDDED', 'Tekst će biti ugrađen u e-poruku obaveštenja');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_8', '...postavljeno podrazumevano za sličice');
DEFINE ('_UDDEADM_AVATARWH_HEAD', 'Veličina prikaza za sličice');
DEFINE ('_UDDEADM_AVATARWH_EXP', 'Širina i visina (u pikselima) za sličice (0 = veličina neće biti menjana).');
DEFINE ('_UDDEIM_SAVE', 'Sačuvaj');

// New: 2.1
DEFINE ('_UDDEIM_BODY_SPAMREPORT',
"Zdravo %you%,\n\nkorisnik %touser% je prijavio sumnjivu poruku od korisnika %fromuser%. Prijavite se i proverite je!\n\n%livesite%");
DEFINE ('_UDDEIM_SUBJECT_SPAMREPORT', 'Prijavljena je poruka na %site%');
DEFINE ('_UDDEADM_KBYTES', 'kbajta');
DEFINE ('_UDDEADM_MBYTES', 'Mbajta');
DEFINE ('_UDDEIM_ATT_FILEDELETED', 'Datoteka je obrisana');
DEFINE ('_UDDEIM_ATT_FILENOTEXISTS', 'Greška: Datoteka ne postoji');
DEFINE ('_UDDEIM_ATTACHMENTS2', 'Prilozi (maks. %s po datoteci):');
DEFINE ('_UDDEADM_JOOCM', 'Joo!CM');
DEFINE ('_UDDEADM_UNPROTECTATTACHMENT_HEAD', 'Nezaštićeno preuzimanje datoteka');
DEFINE ('_UDDEADM_UNPROTECTATTACHMENT_EXP', 'uddeIM obično ne otkriva putanju datoteka priloga na serveru, tako da niko - čak i kada je ime datoteke poznato - ne može preuzeti datoteku.  Omogućavanje ove opcije primorava uddeIM da vrati punu putanju na serveru. Iz bezbednosnih razloga, uddeIM dodaje MD5 heš originalnom imenu datoteke. Korisnici mogu preuzeti datoteku direktno kada je poznata puna putanja. Koristite samo sa pažnjom! PROČITAJTE ČPP KADA KORISTITE OVU OPCIJU!');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_7', '...postavljeno podrazumevano za datoteke priloga, javno sučelje');
DEFINE ('_UDDEIM_FILETYPE_NOTALLOWED', 'Vrsta datoteke nije dozvoljena');
DEFINE ('_UDDEADM_ALLOWEDEXTENSIONS_HEAD', 'Dozvoljeni nastavci');
DEFINE ('_UDDEADM_ALLOWEDEXTENSIONS_EXP', 'Unesite sve dozvoljene nastavke (razdvojene sa „;“). Ostavite prazno za neograničene.');
DEFINE ('_UDDEADM_PUBEMAIL_HEAD', 'Neophodna e-pošta');
DEFINE ('_UDDEADM_PUBEMAIL_EXP', 'Kada je omogućeno javni korisnik mora uneti adresu e-pošte.');
DEFINE ('_UDDEADM_WAITDAYS_HEAD', 'Dani za čekanje');
DEFINE ('_UDDEADM_WAITDAYS_EXP', 'Odredite koliko dana registrovani korisnik mora čekati dok mu nije dozvoljeno da šalje poruke (za 3 časa unesite 0.125).');
DEFINE ('_UDDEIM_WAITDAYS1', 'Morate čekati ');
DEFINE ('_UDDEIM_WAITDAYS2', ' dana dok ne možete slati poruke.');
DEFINE ('_UDDEIM_WAITDAYS2H', ' časova dok ne možete slati poruke.');

// New: 2.0
DEFINE ('_UDDEADM_RECAPTCHAPRV_HEAD', 'reCaptcha privatni ključ');
DEFINE ('_UDDEADM_RECAPTCHAPRV_EXP', 'Ako želite da koristite reCaptcha, unesite svoj privatni ključ ovde.');
DEFINE ('_UDDEADM_RECAPTCHAPUB_HEAD', 'reCaptcha javni ključ');
DEFINE ('_UDDEADM_RECAPTCHAPUB_EXP', 'Ako želite da koristite reCaptcha, unesite svoj javni ključ ovde.');
DEFINE ('_UDDEADM_CAPTCHA_INTERNAL', 'Ugrađen');
DEFINE ('_UDDEADM_CAPTCHA_RECAPTCHA', 'reCaptcha');
DEFINE ('_UDDEADM_CAPTCHATYPE_HEAD', 'Captcha servis');
DEFINE ('_UDDEADM_CAPTCHATYPE_EXP', 'Koji captcha servis želite da koristite: Ugrađeni servis ili reCaptcha (pogledajte <a href="http://recaptcha.net" target="_new">reCaptcha</a> za više informacija)?');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_6', '...postavljeno podrazumevano za captcha servis');
DEFINE ('_UDDEADM_AUP', 'AlphaUserPoints');
DEFINE ('_UDDEADM_CHECKFILESFOLDER', 'Premestite <i>\uddeimfiles</i> u <i>\images\uddeimfiles</i>. Proverite dokumentaciju!');
DEFINE ('_UDDEADM_CRYPT4', 'Jako šifrovanje');
DEFINE ('_UDDEADM_ALLOWTOALL2_HEAD', 'Dozvoli slanje sistemskih poruka');
DEFINE ('_UDDEADM_ALLOWTOALL2_EXP', 'uddeIM podržava sistemske poruke. One se šalju svim korisnicima na sistemu. Koristite ih umereno.');
DEFINE ('_UDDEADM_ALLOWTOALL2_0', 'isključeno');
DEFINE ('_UDDEADM_ALLOWTOALL2_1', 'samo administratori');
DEFINE ('_UDDEADM_ALLOWTOALL2_2', 'administratori i upravnici');

// New: 1.9
DEFINE ('_UDDEIM_FILEUPLOAD_FAILED', 'slanje datoteke nije uspelo');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_5', '...postavljeno podrazumevano za priložene datoteke');
DEFINE ('_UDDEADM_ENABLEATTACHMENT_HEAD', 'Uključi priložene datoteke');
DEFINE ('_UDDEADM_ENABLEATTACHMENT_EXP', 'Ovo omogućava slanje datoteka kao priloga svim registrovanim korisnicima ili samo administratorima.');
DEFINE ('_UDDEADM_MAXSIZEATTACHMENT_HEAD', 'Maks. veličina datoteke');
DEFINE ('_UDDEADM_MAXSIZEATTACHMENT_EXP', 'Maksimalna dozvoljena veličina za priložene datoteke.');
DEFINE ('_UDDEIM_FILESIZE_EXCEEDED', 'Maksimalna veličina datoteke je prevaziđena');
DEFINE ('_UDDEADM_BYTES', 'bajtova');
DEFINE ('_UDDEADM_MAXATTACHMENTS_HEAD', 'Maks. priloga');
DEFINE ('_UDDEADM_MAXATTACHMENTS_EXP', 'Maksimalan broj priloga po poruci.');
DEFINE ('_UDDEIM_DOWNLOAD', 'Preuzmi');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_HEAD', 'Brisanje datoteka pokreće');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_YES', 'samo administrator');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_NO', 'bilo koji korisnik');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_MANUALLY', 'se ručno');
DEFINE ('_UDDEADM_FILEADMINIGNITIONONLY_EXP', 'Automatsko brisanje stvara veliko opterećenje servera. Ako izaberete <b>samo administrator</b>, automatsko brisanje se pokreće kada administrator proverava svoje prijemno sanduče. Izaberite ovu opciju ako administrator redovno proverava svoje prijemno sanduče. Mali sajtovi ili oni koji se retko administriraju mogu da izaberu <b>bilo koji korisnik</b>.');
DEFINE ('_UDDEADM_FILEMAINTENANCE_PRUNE', 'Pročisti datoteke sada');
DEFINE ('_UDDEADM_FILEMAINTENANCEDEL_HEAD', 'Pokreni brisanje datoteka');
DEFINE ('_UDDEADM_FILEMAINTENANCEDEL_EXP', 'Uklanja obrisane datoteke iz baze podataka. Ovo je isto što i „Pročisti datoteke sada“ na sistemskom jezičku.');
DEFINE ('_UDDEADM_FILEMAINTENANCEDEL_ERASE', 'OBRIŠI');
DEFINE ('_UDDEIM_ATTACHMENTS', 'Prilozi (maks. %u bajtova po datoteci):');
DEFINE ('_UDDEADM_MAINTENANCE_F1', 'Napušteni prilozi uskladišteni u sistemu datoteka: ');
DEFINE ('_UDDEADM_MAINTENANCE_F2', 'Brišem napuštene datoteke');
DEFINE ('_UDDEADM_BACKUP_DONE', 'Kopiranje podešavanja je završeno.');
DEFINE ('_UDDEADM_RESTORE_DONE', 'Vraćanje podešavanja je završeno.');
DEFINE ('_UDDEADM_PRUNE_DONE', 'Čišćenje poruka je završeno.');
DEFINE ('_UDDEADM_FILEPRUNE_DONE', 'Čišćenje priloženih datoteka je završeno.');
DEFINE ('_UDDEADM_FOLDERCREATE_ERROR', 'Greška pri pravljenju fascikle: ');
DEFINE ('_UDDEADM_ATTINSTALL_WRITEFAILED', 'Greška pri pravljenju datoteke: ');
DEFINE ('_UDDEADM_ATTINSTALL_IGNORE', 'Možete zanemariti ovu grešku ako ne posedujete prvoklasni dodatak za priložene datoteke (vidite ČPP).');
DEFINE ('_UDDEADM_ATTACHMENTGROUPS_HEAD', 'Dozvoljene grupe');
DEFINE ('_UDDEADM_ATTACHMENTGROUPS_EXP', 'Grupe kojima je dozvoljeno da šalju priložene datoteke.');
DEFINE ('_UDDEIM_SELECT', 'Izaberi');
DEFINE ('_UDDEIM_ATTACHMENT', 'Prilog');
DEFINE ('_UDDEADM_SHOWLISTATTACHMENT_HEAD', 'Prikaži ikone priloga');
DEFINE ('_UDDEADM_SHOWLISTATTACHMENT_EXP', 'Prikazuje ikone priloga u spiskovima poruka (prijemno sanduče, otpremno sanduče, arhiva).');
DEFINE ('_UDDEIM_HELP_ATTACHMENT', 'Poruka sadrži priloženu datoteku.');
DEFINE ('_UDDEADM_MAINTENANCE_COUNTFILES', 'Reference datoteka u bazi podataka:');
DEFINE ('_UDDEADM_MAINTENANCE_COUNTFILESDISTINCT', 'Uskladištene priložene datoteke:');
DEFINE ('_UDDEADM_SHOWMENUCOUNT_HEAD', 'Prikaži brojače');
DEFINE ('_UDDEADM_SHOWMENUCOUNT_EXP', 'Kada je postavljeno na <b>da</b>, traka menija sadrži brojače poruka. Napomena: Ovo će zahtevati nekoliko dodatnih upita nad bazom podataka tako da nemojte koristiti na slabijim sistemima.');
DEFINE ('_UDDEADM_CONFIG_FTPLAYER', 'Podešavanje (pristup preko FTP sloja):');
DEFINE ('_UDDEADM_ENCODEHEADER_HEAD', 'Kodiraj zaglavlja poruka');
DEFINE ('_UDDEADM_ENCODEHEADER_EXP', 'Postavite na <b>da</b> kada zaglavlja poruka (kao tema) treba da budu rfc 2047 kodirana. Korisno kada imate probleme sa specijalnim znacima.');
DEFINE ('_UDDEIM_UP', 'rastući poredak');
DEFINE ('_UDDEIM_DOWN', 'opadajući poredak');
DEFINE ('_UDDEIM_UPDOWN', 'poređaj');
DEFINE ('_UDDEADM_ENABLESORT_HEAD', 'Uključi ređanje');
DEFINE ('_UDDEADM_ENABLESORT_EXP', 'Postavite na <b>da</b> kada korisniku treba omogućiti da poređa prijemno sanduče, otpremno sanduče i arhivu (stvara dodatno opterećenje servera baze podataka).');
...
DEFINE ('_UDDEIM_NOMESSAGES2_TO_FILTERED', '<b>Nemate poruka za ovog korisnika u%s.</b>');
DEFINE ('_UDDEIM_NOMESSAGES2_UNFR_FILTERED', '<b>Nemate nepročitanih poruka od ovog korisnika u%s.</b>');
DEFINE ('_UDDEIM_NOMESSAGES2_UNTO_FILTERED', '<b>Nemate nepročitanih poruka za ovog korisnika u%s.</b>');

// New: 1.7
DEFINE ('_UDDEADM_EMAILSTOPPED', '„Zaustavljanje e-pošte“ je uključeno.');
DEFINE ('_UDDEIM_ACCOUNTLOCKED', 'Pristup vašem poštanskom sandučetu je zaključan. Obratite se administratoru sajta.');
DEFINE ('_UDDEADM_USERSET_LOCKED', 'Zaključano');
DEFINE ('_UDDEADM_USERSET_SELLOCKED', '- Zaključano -');
DEFINE ('_UDDEADM_CBBANNED_HEAD', 'Proveri za zabranjene CB korisnike');
DEFINE ('_UDDEADM_CBBANNED_EXP', 'Kada je aktivirano, uddeIM proverava da li je korisnik zabranjen u CB-u i ne dozvoljava mu pristup uddeIM-u. Drugi korisnici takođe neće moći da šalju poruke zabranjenom korisniku.');
DEFINE ('_UDDEIM_YOUAREBANNED', 'Vi ste zabranjeni. Obratite se administratoru ili moderatoru.');
DEFINE ('_UDDEIM_USERBANNED', 'Korisnik je zabranjen');
DEFINE ('_UDDEADM_JOOBB', 'Joo!BB');
DEFINE ('_UDDEPLUGIN_SEARCHSECTION', 'Privatne poruke');
DEFINE ('_UDDEPLUGIN_MESSAGES', 'Privatne poruke');
DEFINE ('_UDDEADM_MAINTENANCEDEL_HEAD', 'Aktiviraj brisanje poruka');
// note "This  is the same as _UDDEADM_MAINTENANCE_PRUNE on the system tab."
DEFINE ('_UDDEADM_MAINTENANCEDEL_EXP', 'Uklanja obrisane poruke iz baze podataka. Ovo je isto što i „Pročisti poruke sada“ na sistemskom jezičku.');
DEFINE ('_UDDEADM_MAINTENANCEDEL_ERASE', 'OBRIŠI');
DEFINE ('_UDDEADM_REPORTSPAM_HEAD', 'Link za prijavu poruke');
DEFINE ('_UDDEADM_REPORTSPAM_EXP', 'Kada je aktivirano, ovo prikazuje link „Prijavi poruku“ koja dozvoljava korisnicima da administratoru prijave SPAM.');
DEFINE ('_UDDEIM_TOOLBAR_REMOVESPAM', 'Obriši poruku');
DEFINE ('_UDDEIM_TOOLBAR_REMOVEREPORT', 'Ukloni izveštaj');
DEFINE ('_UDDEIM_TOOLBAR_SPAMCONTROL', 'Centar za prijave');
DEFINE ('_UDDEADM_INFORMATION', 'Informacije');
DEFINE ('_UDDEADM_SPAMCONTROL_STAT', 'Prijavljene poruke:');
DEFINE ('_UDDEADM_SPAMCONTROL_TRASHED', 'U smeću');
DEFINE ('_UDDEADM_SPAMCONTROL_NOTEDEL', 'Obrisati ovu poruku iz baze podataka?');
DEFINE ('_UDDEADM_SPAMCONTROL_NOTEREMOVE', 'Ukloniti ovu prijavu?');
DEFINE ('_UDDEADM_SPAMCONTROL_SHOWHIDE', 'Prikaži/sakrij');
DEFINE ('_UDDEADM_SPAMCONTROL_EDIT', 'Kontrolni centar prijavljivanja');
DEFINE ('_UDDEADM_SPAMCONTROL_FROM', 'Od');
DEFINE ('_UDDEADM_SPAMCONTROL_TO', 'Za');
DEFINE ('_UDDEADM_SPAMCONTROL_TEXT', 'Poruka');
DEFINE ('_UDDEADM_SPAMCONTROL_DELETE', 'Obriši');
DEFINE ('_UDDEADM_SPAMCONTROL_REMOVE', 'Ukloni');
DEFINE ('_UDDEADM_SPAMCONTROL_DATE', 'Datum');
DEFINE ('_UDDEADM_SPAMCONTROL_REPORTED', 'Prijavljena');
DEFINE ('_UDDEIM_SPAMCONTROL_REPORT', 'Prijavite poruku');
DEFINE ('_UDDEIM_SPAMCONTROL_MARKED', 'Poruka je prijavljena');
DEFINE ('_UDDEIM_SPAMCONTROL_UNREPORT', 'Opozovi ovu prijavu');
DEFINE ('_UDDEADM_JOMSOCIAL', 'JomSocial');
DEFINE ('_UDDEADM_KUNENA', 'Kunena');
DEFINE ('_UDDEADM_ADMIN_FILTER', 'Filter');
DEFINE ('_UDDEADM_ADMIN_DISPLAY', 'Prikaz #');
DEFINE ('_UDDEADM_TRASHORIGINALSENT_HEAD', 'Bacanje poslate poruke');
DEFINE ('_UDDEADM_TRASHORIGINALSENT_EXP', 'Kada je ovo aktivirano, pored dugmeta „Pošalji“ će se pojaviti kućica sa oznakom „baci poruku“ koja nije podrazumevano štiklirana. Korisnici mogu da štikliraju kućicu ako žele da bace poruku odmah nakon njenog slanja.');
DEFINE ('_UDDEIM_TRASHORIGINALSENT', 'baci poruku');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_4', '...postavljeno podrazumevano za brisanje poslate poruke, spam prijavu, zabranjene CB korisnike');
DEFINE ('_UDDEADM_VERSIONCHECK_IMPORTANT', 'Važni linkovi:');
DEFINE ('_UDDEADM_VERSIONCHECK_HOTFIX', 'Važna ispravka');
DEFINE ('_UDDEADM_VERSIONCHECK_NONE', 'Nema');
DEFINE ('_UDDEADM_MAINTENANCEFIX_HEAD', "Održavanje usaglašenosti");
DEFINE ('_UDDEADM_MAINTENANCEFIX_EXP', "uddeIM koristi dve XML datoteke kako bi osigurao da paketi mogu biti instalirani na Joomla 1.0 i 1.5. Na Joomla 1.5 jedna XML datoteka nije neophodna pa ovo uzrokuje da menadžer proširenjima prikazuje upozorenje o neusaglašenosti (što je pogrešno). Ovo uklanja nepotrebne datoteke, tako da se upozorenje više ne prikazuje.");
DEFINE ('_UDDEADM_MAINTENANCE_FIX', "ISPRAVKA");
DEFINE ('_UDDEADM_MAINTENANCE_XML1', "Postoje Joomla 1.0 i Joomla 1.5 XML instalateri za uddeIM pakete.<br />");
DEFINE ('_UDDEADM_MAINTENANCE_XML2', "Ovo je neophodno zbog instalacije paketa i na Joomla 1.0 i na Joomla 1.5.<br />");
DEFINE ('_UDDEADM_MAINTENANCE_XML3', "Pošto nije neophodan nakon završetka instalacije, Joomla 1.0 instalater se može ukloniti sa Joomla 1.5 sistema.<br />");
DEFINE ('_UDDEADM_MAINTENANCE_XML4', "Ovo će biti izvršeno za sledeće pakete:<br />");
DEFINE ('_UDDEADM_MAINTENANCE_FXML1', "Nepotrebni XML instalateri za sledeće uddeIM pakete će biti uklonjeni:<br />");
DEFINE ('_UDDEADM_MAINTENANCE_FXML2', "Nepotrebni XML instalateri za uddeIM pakete nisu pronađeni!<br />");
DEFINE ('_UDDEADM_SHOWMENUICONS1_HEAD', 'Izgled trake menija');
DEFINE ('_UDDEADM_SHOWMENUICONS1_EXP', 'Ovde možete podesiti da li se traka menija prikazuje sa ikonama i/ili tekstom.');
DEFINE ('_UDDEIM_MENUICONS_P1', 'Ikone i tekst');
DEFINE ('_UDDEIM_MENUICONS_P2', 'Samo ikone');
DEFINE ('_UDDEIM_MENUICONS_P0', 'Samo tekst');
DEFINE ('_UDDEIM_LISTSLIMIT_2', 'Najveći broj primalaca u spisku:');
DEFINE ('_UDDEADM_ADDEMAIL_ADMIN', 'Administratori mogu da biraju');
DEFINE ('_UDDEAIM_ADDEMAIL_SELECT', 'Obaveštenje sadrži poruku');
DEFINE ('_UDDEAIM_ADDEMAIL_TITLE', 'Uključi punu poruku u e-pošti obaveštenja.');

// New: 1.6
DEFINE ('_UDDEIM_NOLISTSELECTED', 'Nije izabran spisak korisnika!');
DEFINE ('_UDDEADM_NOPREMIUM', 'Prvoklasni dodatak nije instaliran');
DEFINE ('_UDDEIM_LISTGLOBAL_CREATOR', 'Tvorac:');
DEFINE ('_UDDEIM_LISTGLOBAL_ENTRIES', 'Stavke');
DEFINE ('_UDDEIM_LISTGLOBAL_TYPE', 'Vrsta');
DEFINE ('_UDDEIM_LISTGLOBAL_NORMAL', 'Običan');
DEFINE ('_UDDEIM_LISTGLOBAL_GLOBAL', 'Globalni');
DEFINE ('_UDDEIM_LISTGLOBAL_RESTRICTED', 'Ograničen');
DEFINE ('_UDDEIM_LISTGLOBAL_P0', 'Običan spisak kontakata');
DEFINE ('_UDDEIM_LISTGLOBAL_P1', 'Globalni spisak kontakata');
DEFINE ('_UDDEIM_LISTGLOBAL_P2', 'Ograničen spisak kontakata (samo članovi spiska mogu pristupiti spisku)');
DEFINE ('_UDDEIM_TOOLBAR_USERSETTINGS', 'Korisničke postavke');
DEFINE ('_UDDEIM_TOOLBAR_REMOVESETTINGS', 'Ukloni postavke');
DEFINE ('_UDDEIM_TOOLBAR_CREATESETTINGS', 'Napravi postavke');
DEFINE ('_UDDEIM_TOOLBAR_SAVE', 'Sačuvaj');
DEFINE ('_UDDEIM_TOOLBAR_BACK', 'Nazad');
DEFINE ('_UDDEIM_TOOLBAR_TRASHMSGS', 'Baci poruke u smeće');
DEFINE ('_UDDEIM_CBPLUG_CONT', '[nastavi]');
DEFINE ('_UDDEIM_CBPLUG_UNBLOCKNOW', '[deblokiraj]');
DEFINE ('_UDDEIM_CBPLUG_DOBLOCK', 'Blokiraj korisnika');
DEFINE ('_UDDEIM_CBPLUG_DOUNBLOCK', 'Deblokiraj korisnika');
DEFINE ('_UDDEIM_CBPLUG_BLOCKINGCFG', 'Blokiranje');
DEFINE ('_UDDEIM_CBPLUG_BLOCKED', 'Blokirali ste ovog korisnika.');
DEFINE ('_UDDEIM_CBPLUG_UNBLOCKED', 'Ovaj korisnik vas može kontaktirati.');
DEFINE ('_UDDEIM_CBPLUG_NOWBLOCKED', 'Ovaj korisnik je sada blokiran.');
DEFINE ('_UDDEIM_CBPLUG_NOWUNBLOCKED', 'Ovaj korisnik više nije blokiran.');
DEFINE ('_UDDEADM_PARTIALIMPORTDONE', 'Delimičan uvoz poruka iz starog PMS-a je završen. Nemojte uvoziti ovaj deo ponovo jer će time poruke biti ponovo uvezene i pojaviće se dvaput.');
DEFINE ('_UDDEADM_IMPORT_HELP', 'Napomena: Poruke će be biti uvezene sve odjednom ili u delovima. Uvoz u delovima može biti neophodan kada se uvoz prekine zbog prevelikog broja poruka za uvoz.');
DEFINE ('_UDDEADM_IMPORT_PARTIAL', 'Delimični uvoz:');
DEFINE ('_UDDEADM_UPDATEYOURDB', 'Važno: Niste ažurirali bazu podataka! Pogledajte README kako biste ispravno ažurirali uddeIM!');
DEFINE ('_UDDEADM_RESTRALLUSERS_HEAD', 'Ograniči pristup za spisak „Svi korisnici“');
DEFINE ('_UDDEADM_RESTRALLUSERS_EXP', 'Možete ograničiti pristup spisku „Svi korisnici“. Obično je spisak „Svi korisnici“ dostupan za sve (<i>bez ograničenja</i>).');
...
DEFINE ('_UDDEIM_MESSAGE_UNARCHIVED', 'Poruka je dearhivirana.');
...
DEFINE ('_UDDEIM_HELP_INBOX', '<b>Prijemno sanduče</b> sadrži sve vaše primljene poruke, svaka e-poruka koju primite se nalazi ovde.');
DEFINE ('_UDDEIM_HELP_OUTBOX', '<b>Otpremno sanduče</b> čuva kopiju svake poruke koju pošaljete, i možete im se vratiti bilo kada da biste pogledali šta ste poslali.');
DEFINE ('_UDDEIM_HELP_TRASHCAN', '<b>Kanta za smeće</b> sadrži sve obrisane poruke. Poruke se ne brišu odmah i zadržavaju se neko određeno vreme. Dokle god je poruka smeštena u kanti za smeće, moći ćete da je povratite.');
DEFINE ('_UDDEIM_HELP_ARCHIVE', '<b>Arhiva</b> sadrži sve vaše arhivirane poruke iz prijemnog sandučeta. Možete arhivirati poruke samo iz vašeg prijemnog sandučeta. Ako morate da arhivirate poruku koju ste sami napisali, pobrinite se da pri slanju izaberete <i>kopija meni</i>.');
DEFINE ('_UDDEIM_HELP_USERLISTS', '<b>Kontakti</b> omogućava održavanje spiskova kontakata (takođe poznatih kao distribucioni spiskovi). Ovi spiskovi omogućuju slanje PP-a višestrukim primaocima. Umesto dodavanja višestrukih primalaca, možete jednostavno uneti <i>#imespiska</i>.');
DEFINE ('_UDDEIM_HELP_SETTINGS', '<b>Podešavanja</b> sadrže sve opcije koje korisnik može podesiti.');
DEFINE ('_UDDEIM_HELP_COMPOSE', '<b>Napiši</b> omogućava pisanje nove privatne poruke.');
DEFINE ('_UDDEIM_HELP_IREAD', 'Poruka je pročitana (možete menjati status).');
DEFINE ('_UDDEIM_HELP_IUNREAD', 'Poruka je još uvek nepročitana (možete menjati status).');
DEFINE ('_UDDEIM_HELP_OREAD', 'Poruka je pročitana.');
DEFINE ('_UDDEIM_HELP_OUNREAD', 'Poruka je još uvek nepročitana. Nepročitane poruke se mogu opozvati.');
DEFINE ('_UDDEIM_HELP_TREAD', 'Poruka je pročitana.');
DEFINE ('_UDDEIM_HELP_TUNREAD', 'Poruka je još uvek nepročitana.');
DEFINE ('_UDDEIM_HELP_FLAGGED', 'Poruka je označena, npr. kada je poruka važna (možete menjati status).');
DEFINE ('_UDDEIM_HELP_UNFLAGGED', '<i>Obična</i> poruka (možete menjati status).');
DEFINE ('_UDDEIM_HELP_ONLINE', 'Korisnik je trenutno na vezi.');
DEFINE ('_UDDEIM_HELP_OFFLINE', 'Korisnik trenutno nije na vezi.');
DEFINE ('_UDDEIM_HELP_DELETE', 'Brisanje poruke (premeštanje poruke u kantu za smeće).');
DEFINE ('_UDDEIM_HELP_FORWARD', 'Prosleđivanje poruke drugom primaocu.');
DEFINE ('_UDDEIM_HELP_ARCHIVEMSG', 'Arhiviranje poruke. Arhivirane poruke neće biti samostalno obrisane kada je administrator podesio vremensko ograničenje za poruke sačuvane u prijemnom sandučetu.');
DEFINE ('_UDDEIM_HELP_UNARCHIVEMSG', 'Dearhiviranje poruke. Poruka će biti prebačena natrag u prijemno sanduče.');
DEFINE ('_UDDEIM_HELP_RECALL', 'Opoziv poruke. Poslate poruke mogu biti opozvane ako ih primalac još uvek nije pročitao.');
DEFINE ('_UDDEIM_HELP_RECYCLE', 'Recikliranje poruke (premeštanje poruke iz kante za smeće natrag u prijemno ili otpremno sanduče).');
DEFINE ('_UDDEIM_HELP_NOTIFY', 'Podešavanje obaveštenja e-poštom kada stigne nova poruka.');
DEFINE ('_UDDEIM_HELP_AUTORESPONDER', 'Kada su uključeni automatski odgovori na svaku primljenu poruku će biti odmah odgovoreno.');
DEFINE ('_UDDEIM_HELP_AUTOFORWARD', 'Nove poruke mogu samostalno biti prosleđene drugom korisniku.');
DEFINE ('_UDDEIM_HELP_BLOCKING', 'Možete blokirati korisnike. Ovi korisnici vam ne mogu slati privatne poruke.');
DEFINE ('_UDDEIM_HELP_MISC', 'Ovde možete pronaći još neke postavke podešavanja');
DEFINE ('_UDDEIM_HELP_FEED', 'Možete pristupiti svom prijemnom sandučetu koristeći RSS izvor.');
DEFINE ('_UDDEADM_SEPARATOR_HEAD', 'Graničnik');
DEFINE ('_UDDEADM_SEPARATOR_EXP', 'Odaberite graničnik koji će se koristiti za višestruke primaoce (podrazumevano je „,“).');
DEFINE ('_UDDEADM_SEPARATOR_P0', 'zapeta (podrazumevano)');
DEFINE ('_UDDEADM_SEPARATOR_P1', 'tačka zapeta');
DEFINE ('_UDDEADM_RSSLIMIT_HEAD', 'RSS stavke');
DEFINE ('_UDDEADM_RSSLIMIT_EXP', 'Ograniči broj vraćenih RSS stavki (0 za neograničeno).');
DEFINE ('_UDDEADM_SHOWHELP_HEAD', 'Prikaži dugme za pomoć');
DEFINE ('_UDDEADM_SHOWHELP_EXP', 'Kada je uključeno, biće prikazano dugme za pomoć.');
DEFINE ('_UDDEADM_SHOWIGOOGLE_HEAD', 'Prikaži dugme za iGoogle vidžet');
DEFINE ('_UDDEADM_SHOWIGOOGLE_EXP', 'Kada je uključeno, u korisničkim postavkama će biti prikazano dugme <i>Dodaj u iGoogle</i> za uddeIM iGoogle vidžet.');
DEFINE ('_UDDEADM_MOOTOOLS_NONE11', 'ne učitavaj MooTools (koristi se 1.1)');
DEFINE ('_UDDEADM_MOOTOOLS_NONE12', 'ne učitavaj MooTools (koristi se 1.2)');
DEFINE ('_UDDEIM_RSS_INTRO1', 'Možete pristupiti svom prijemnom sandučetu koristeći RSS izvor (0.91).');
DEFINE ('_UDDEIM_RSS_INTRO1B', 'Pristupni URL je:');
DEFINE ('_UDDEIM_RSS_INTRO2', 'Nemojte davati ovaj URL drugim korisnicima jer on dozvoljava pristup vašem prijemnom sandučetu.');
DEFINE ('_UDDEIM_RSS_FEED', 'Izvor RSS poruka');
DEFINE ('_UDDEIM_RSS_NOOBJECT', 'Nema objekta...');
DEFINE ('_UDDEIM_RSS_USERBLOCKED', 'Korisnik je blokiran...');
DEFINE ('_UDDEIM_RSS_NOTALLOWED', 'Pristup nije dozvoljen...');
DEFINE ('_UDDEIM_RSS_WRONGPASSWORD', 'Pogrešno korisničko ime ili lozinka...');
DEFINE ('_UDDEIM_RSS_NOMESSAGES', 'Nema poruka');
DEFINE ('_UDDEIM_RSS_NONEWMESSAGES', 'Nema novih poruka');
DEFINE ('_UDDEADM_ENABLERSS_HEAD', 'Uključi RSS');
DEFINE ('_UDDEADM_ENABLERSS_EXP', 'Kada je ova opcija uključena, poruke će biti primane sa RSS izvora. Korisnici mogu pronaći neophodan URL u svom profilu.');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_3', '...postavljeno podrazumevano za RSS, iGoogle, pomoć, graničnik');
DEFINE ('_UDDEADM_DELETEM_DELETING', 'Brisanje poruka:');
DEFINE ('_UDDEADM_DELETEM_FROMUSER', 'Brisanje poruka od korisnika ');
DEFINE ('_UDDEADM_DELETEM_MSGSSENT', '- poslate poruke: ');
...
DEFINE ('_UDDEIM_PMNAV_EXISTS', 'skoči na poruku');
DEFINE ('_UDDEIM_PMNAV_COPY2ME', '(kopija)');
DEFINE ('_UDDEADM_PMNAV_HEAD', 'Dozvoli navigaciju');
DEFINE ('_UDDEADM_PMNAV_EXP', 'Prikazuje traku za navigaciju koja dozvoljava navigaciju kroz temu.');
DEFINE ('_UDDEADM_MAINTENANCE_ALLDAYS', 'Poruke:');
DEFINE ('_UDDEADM_MAINTENANCE_7DAYS', 'Poruke u 7 dana:');
DEFINE ('_UDDEADM_MAINTENANCE_30DAYS', 'Poruke u 30 dana:');
DEFINE ('_UDDEADM_MAINTENANCE_365DAYS', 'Poruke u 365 dana:');
DEFINE ('_UDDEADM_MAINTENANCE_HEAD1', 'Slanje podsetnika za (nezaboravak: %s dana):');
DEFINE ('_UDDEADM_MAINTENANCE_HEAD2', 'Za %s dana se šalju podsetnici za:');
DEFINE ('_UDDEADM_MAINTENANCE_NO', 'Br.:');
...
DEFINE ('_UDDEADM_MAINTENANCE_TIMER', 'Tajmer:');

// New: 1.5
DEFINE ('_UDDEMODULE_ALLDAYS', ' poruka');
DEFINE ('_UDDEMODULE_7DAYS', ' poruka u poslednjih 7 dana');
DEFINE ('_UDDEMODULE_30DAYS', ' poruka u poslednjih 30 dana');
DEFINE ('_UDDEMODULE_365DAYS', ' poruka u poslednjih 365 dana');
DEFINE ('_UDDEADM_EMN_SENDERMAIL_WARNING', '<br /><b>Napomena:<br />Kada koristite mosMail, morate da podesite ispravnu adresu e-pošte!</b>');
DEFINE ('_UDDEIM_FILTEREDMESSAGE', 'poruka je filtrirana');
DEFINE ('_UDDEIM_FILTEREDMESSAGES', 'poruka je filtrirano');
DEFINE ('_UDDEIM_FILTER', 'Filter:');
DEFINE ('_UDDEIM_FILTER_TITLE_INBOX', 'Prikaži samo od ovog korisnika');
DEFINE ('_UDDEIM_FILTER_TITLE_OUTBOX', 'Prikaži samo za ovog korisnika');
DEFINE ('_UDDEIM_FILTER_UNREAD_ONLY', 'samo nepročitane');
DEFINE ('_UDDEIM_FILTER_SUBMIT', 'Filtriraj');
DEFINE ('_UDDEIM_FILTER_ALL', '- sve -');
DEFINE ('_UDDEIM_FILTER_PUBLIC', '- javne korisnike -');
DEFINE ('_UDDEADM_FILTER_HEAD', 'Uključi filter');
DEFINE ('_UDDEADM_FILTER_EXP', 'Ako je uključen, korisnici mogu da filtriraju svoje prijemne/otpremne sandučiće radi prikazivanja samo jednog primaoca ili pošiljaoca.');
DEFINE ('_UDDEADM_FILTER_P0', 'isključen');
DEFINE ('_UDDEADM_FILTER_P1', 'iznad spiska poruka');
DEFINE ('_UDDEADM_FILTER_P2', 'ispod spiska poruka');
DEFINE ('_UDDEADM_FILTER_P3', 'iznad i ispod spiska poruka');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED', '<b>Nemate%s poruka%s u%s.</b>');	// see next  six lines
...
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_INBOX', ' prijemnom sandučetu');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_OUTBOX', ' otpremnom sandučetu');
DEFINE ('_UDDEIM_NOMESSAGES_FILTERED_ARCHIVE', ' arhivi');
DEFINE ('_UDDEIM_TODP_TITLE', 'Primalac');
DEFINE ('_UDDEIM_TODP_TITLE_CC', 'Jedan ili više primalaca (razdvojenih zarezom)');
DEFINE ('_UDDEIM_ADDCCINFO_TITLE', 'Kada je štiklirano, red koji sadrži sve primaoce će biti dodat poruci.');
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_2', '...postavljeno podrazumevano za auto odgovore, auto prosleđivanje, prijemno sanduče, filter');
DEFINE ('_UDDEADM_AUTORESPONDER_HEAD', 'Uključi automatske odgovore');
DEFINE ('_UDDEADM_AUTORESPONDER_EXP', 'Kada su uključeni automatski odgovori korisnik može uključiti obaveštenja o automatskim odgovorima u ličnim korisničkim postavkama.');
DEFINE ('_UDDEIM_EMN_AUTORESPONDER', 'Uključi automatske odgovore');
DEFINE ('_UDDEIM_AUTORESPONDER', 'Automatski odgovori');
DEFINE ('_UDDEIM_AUTORESPONDER_EXP', 'Kada su uključeni automatski odgovori na svaku primljenu poruku će biti odmah odgovoreno.');
DEFINE ('_UDDEIM_AUTORESPONDER_DEFAULT', "Žao mi je, trenutno nisam na raspolaganju.\nObradiću svoje prijemno sanduče prvom sledećom prilikom.");
DEFINE ('_UDDEADM_USERSET_AUTOR', 'Auto odg.');
DEFINE ('_UDDEADM_USERSET_SELAUTOR', '- Auto odg. -');
DEFINE ('_UDDEIM_USERBLOCKED', 'Korisnik je blokiran.');
DEFINE ('_UDDEADM_AUTOFORWARD_HEAD', 'Uključi automatsko prosleđivanje');
DEFINE ('_UDDEADM_AUTOFORWARD_EXP', 'Kada je uključeno automatsko prosleđivanje korisnik može automatski prosleđivati nove poruke nekom drugom korisniku.');
DEFINE ('_UDDEIM_EMN_AUTOFORWARD', 'Uključi automatsko prosleđivanje');
DEFINE ('_UDDEADM_USERSET_AUTOF', 'Auto prosl.');
DEFINE ('_UDDEADM_USERSET_SELAUTOF', '- Auto prosl. -');
DEFINE ('_UDDEIM_AUTOFORWARD', 'Automatsko prosleđivanje');
DEFINE ('_UDDEIM_AUTOFORWARD_EXP', 'Nove poruke će automatski biti prosleđene drugom korisniku.');
DEFINE ('_UDDEIM_THISISAFORWARD', 'Automatski prosleđena poruka koja je prvobitno bila poslata za ');
DEFINE ('_UDDEADM_COLSROWS_HEAD', 'Okvir poruke (kolona/redova)');
DEFINE ('_UDDEADM_COLSROWS_EXP', 'Ovo određuje broj kolona i redova u okviru poruke (podrazumevane vrednosti su 60/10).');
DEFINE ('_UDDEADM_WIDTH_HEAD', 'Okvir poruke (širina)');
DEFINE ('_UDDEADM_WIDTH_EXP', 'Ovo određuje širinu okvira poruke u pikselima (podrazumevano je 0). Ako je ova vrednost 0, koristiće se širina navedena u CSS stilu.');
...
DEFINE ('_UDDEADM_MOOTOOLS_EXP', 'Ovo određuje kako uddeIM učitava MooTools (MooTools je neophodan za Autocompleter): <i>nemoj</i> je korisno kada šablon učitava MooTools, <i>auto</i> se preporučuje podrazumevano, kada koristite J1.0 takođe možete primorati učitavanje MooTools 1.1 ili 1.2.');
...
DEFINE ('_UDDEADM_CFGFILE_CONVERTING_1', '...postavljeno podrazumevano za MooTools');
...
DEFINE ('_UDDEADM_SHOWLINK_EXP', 'Sva korisnička imena koja se pojavljuju u uddeIM-u će biti prikazana kao veze do njihovih korisničkih profila u odabranom sistemu.');
DEFINE ('_UDDEADM_SHOWPIC_HEAD', 'Prikaži sličice');
DEFINE ('_UDDEADM_SHOWPIC_EXP', 'Sličica preuzeta iz odabranog sistema korisnika će biti prikazana pri čitanju poruke.');
...
DEFINE ('_UDDEADM_TIMEDELAY_EXP', 'Vreme u sekundama koje registrovani korisnik mora sačekati pre nego što može poslati sledeću poruku (0 za nikakvu zadršku).');
...
DEFINE ('_UDDEADM_VERSIONCHECK_EXP', 'Ovo stupa u kontakt sa veb sajtom uddeIM programera kako bi se dobavile informacije o tekućoj uddeIM verziji.');
...
DEFINE ('_UDDEADM_USERSET_PUBLIC', 'Javno suč.');
DEFINE ('_UDDEADM_USERSET_SELPUBLIC', '- Javno suč. -');
...
DEFINE ('_UDDEADM_DELETESENTAFTER_HEAD', 'Poslate poruke se čuvaju');
...
DEFINE ('_UDDEADM_USERSET_SELUSERNAME', '- Korisničko ime -');
DEFINE ('_UDDEADM_USERSET_SELNAME', '- Ime -');
...
DEFINE ('_UDDEADM_USERSET_SELENTRY', '- Stavka -');
DEFINE ('_UDDEADM_USERSET_SELNOTIFICATION', '- Obaveštenje -');
DEFINE ('_UDDEADM_USERSET_SELPOPUP', '- Iskačući prozor -');
...
DEFINE ('_UDDEADM_SHOWGROUPS_EXP', 'Prikaži Joomla grupe u sistemskom spisku poruka.');
...
DEFINE ('_UDDEIM_PASSWORD', 'Neophodna je lozinka');
...
DEFINE ('_UDDEADM_POPUP_EXP','Prikaži iskačuće obaveštenje kada stigne nova poruka (neophodan je mod_uddeim)');
...
DEFINE ('_UDDEADM_CONLISTBOX', 'Padajući spisak veza');
...
DEFINE ('_UDDEIM_NOMESSAGES_INBOX', 'Nemate poruka u prijemnom sandučetu.');

DEFINE ('_UDDEIM_NOMESSAGES_OUTBOX', 'Nemate poruka u otpremnom sandučetu.');
DEFINE ('_UDDEIM_NOMESSAGES_TRASHCAN', 'Nemate poruka u kanti za smeće.');
...
DEFINE ('_UDDEADM_DELETEREADAFTER_HEAD', 'Pročitane poruke se čuvaju');
DEFINE ('_UDDEADM_DELETEUNREADAFTER_HEAD', 'Nepročitane poruke se čuvaju');
DEFINE ('_UDDEADM_DELETETRASHAFTER_HEAD', 'Poruke se čuvaju u smeću');
...
DEFINE ('_UDDEADM_ADMINIGNITIONONLY_MANUALLY', 'se ručno');
...
DEFINE ('_UDDEADM_DELETIONS', 'Brisanje');
...
DEFINE ('_UDDEIM_SYSGM_SHORTHELP', 'Upotreba <b>samo u sistemskim porukama</b>:<br /> [b]<b>podebljano</b>[/b] [i]<em>kurziv</em>[/i]<br />[url=http://www.nekiurl.com]neki url[/url] ili [url]http://www.nekiurl.com[/url] su veze');
...
DEFINE ('_UDDEIM_EXPORT_NOW', 'pošalji e-poštu');
...
DEFINE ('_UDDEADM_SHOWCONNEX_EXP', 'Upotrebite <b>da</b> ukoliko imate instaliran CB/CBE/JS i želite da prikažete imena korisnikovih veza na stranici za pisanje nove poruke.');
...
"Zdravo %you%,\n\n%user% vam je poslao/la sledeću privatnu poruku na %site%.\n__________________\n%pmessage%");
DEFINE ('_UDDEIM_EMN_BODY_NOMESSAGE',
"Zdravo %you%,\n\n%user% vam je poslao/la privatnu poruku na %site%. Molimo vas da se prijavite da biste je pročitali!\n\n%livesite%");
