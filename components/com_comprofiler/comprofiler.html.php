...
* @version $Id: comprofiler.html.php 1750 2012-02-13 21:27:35Z beat $
...
<div class='contentheading'><?php echo _UE_USERAPPROVAL_MODERATE; ?></div><br />
		...
		<thead><tr align='left'>
		<th width=6>&nbsp;</th>
		<th width=75><?php echo _UE_USER; ?></th>
		<th width=70><?php echo _UE_EMAIL; ?></th>
		<th width=50><?php echo 'Телефон'; ?></th>
		<th width=50><?php echo 'Ник'; ?></th>
		<th width=100><?php echo _UE_REGISTERDATE; ?></th>
		<th width=10><?php echo _UE_COMMENT; ?></th>
		</tr></thead>	
<?php  
		for($i = 0; $i < count($users); $i++) {
			...
			$_CB_database->setQuery("SELECT cb_telnum FROM `#__comprofiler` where id=".$users[$i]->id);
			$dan=$_CB_database->loadResult();
			echo "<td>".$dan."</td>";
			echo "<td>".$users[$i]->username."</td>";
			echo "<td>".cbFormatDate($users[$i]->registerDate)."</td>";
			echo "<td><textarea name='comment".$users[$i]->id."' cols='18' rows='3'></textarea></td>";
			echo "</tr>";
		}
		echo '<tr align="center" valign="middle"><td colspan="7">'
