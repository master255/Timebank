...
* @version $Id: admin_reference_language.php 1732 2012-02-07 11:20:30Z beat $
...
'Note: Permissions for Community Builder User Manager are set in the Community Builder User Management Options.'	=>	'Note: Permissions for Community Builder User Manager are set in the Community Builder User Management Options.',
'Community Builder Permissions for Settings: Fields, Tabs, Lists and CB Plugins'	=>	'Community Builder Permissions for Settings: Fields, Tabs, Lists and CB Plugins',
'These are the Joomla Users Manager Options: Some of these Preferences and all of the Permissions also apply to the Community Builder User Manager:'	=>	'These are the Joomla Users Manager Options: Some of these Preferences and all of the Permissions also apply to the Community Builder User Manager:',
...
'Operation not allowed by the Permissions of your group(s).' => 'Operation not allowed by the Permissions of your group(s).',
...
'All groups above that level will also have access to this tab.' => 'All groups above that level will also have access to this tab.',
...
'View Access Level' => 'View Access Level',
'User Group to allow access to' => 'User Group to allow access to',
'Old deprecated method of Joomla 1.5, do not use here' => 'Old deprecated method of Joomla 1.5, do not use here',
'Keep setting "-- Everybody --" and Use View Access Level above instead' => 'Keep setting "-- Everybody --" and Use View Access Level above instead',
'New method working in all Joomla and Mambo versions' => 'New method working in all Joomla and Mambo versions',
'Old Joomla [VERSION] method' => 'Old Joomla [VERSION] method',
'Only users which are in groups assigned to this View Access Level will see this tab.' => 'Only users which are in groups assigned to this View Access Level will see this tab.',
'Only users which are in groups assigned to this View Access Level will see this list.' => 'Only users which are in groups assigned to this View Access Level will see this list.',
'This method is kept for backwards compatibility but will be removed at next major Community Builder version.' => 'This method is kept for backwards compatibility but will be removed at next major Community Builder version.',
'Use View Access Level above instead and set this Group setting to - "Everybody" -.' => 'Use View Access Level above instead and set this Group setting to - "Everybody" -.',
