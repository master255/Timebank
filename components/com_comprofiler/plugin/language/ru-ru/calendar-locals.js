...
// Encoding: UTF-8 without BOM only.
// Translated by Alexander Smirnov aka alex2010 at joomlapolis.com
...
Calendar._TT["TIME_PART"] = "(Shift-)Click или тянуть мышкой для смены значения";
