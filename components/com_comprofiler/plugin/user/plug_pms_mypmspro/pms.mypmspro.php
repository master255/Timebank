...
* @version $Id: pms.mypmspro.php 1799 2012-06-19 19:27:17Z beat $
		...
		switch($kind) {
			case 1:
				return array("caption"	=> $params->get('pmsMenuText', _UE_PM_USER),
							 ...
							 "tooltip"	=> $params->get('pmsMenuDesc', _UE_MENU_PM_USER_DESC), "caption"	=> $params->get('pmsMenuText', _UE_PM_USER),
							 "url"		=> $pmsurlSend.$pmsitemid,
