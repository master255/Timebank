...
if ($app->getCfg('debug') ==0) {
$doc2 = JFactory::getDocument();
$path555=substr_replace(JURI::root(), '', -1, 1);
$doc2->addScript($path555."/media/system/js/core.js");
$doc2->addScript($path555."/media/system/js/mootools-core.js");
$doc2->addScript($path555."/media/system/js/mootools-more.js");}
