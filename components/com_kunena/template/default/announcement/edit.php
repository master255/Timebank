...
<div class="kblock kannouncement">
	...
	<div class="kcontainer" id="kannouncement">
			...
			<div class="kanndesc">
				...
				<div>
					...
					<label>
						...
						<textarea class="ksmall required" rows="80" cols="4" name="sdescription" style="width: 99%;"><?php echo $this->escape($this->announcement->sdescription); ?></textarea>
					</label>
				</div>
				<div>
					<label>
		...
		?>
						...
						<textarea class="klarge" rows="80" cols="16" name="description" id="kbbcode-message" style="width: 99%;"><?php echo $this->escape($this->announcement->description); ?></textarea>
		<?php
