				...
				<form action="<?php echo CKunenaLink::GetUserlistPostURL(); ?>" method="post" name="adminForm">
					<table>
						<tr class="ksth userlist">
							...
							<th width=88><?php echo JText::_('COM_KUNENA_USRL_ONLINE'); ?></th>
							<?php endif; ?>
							...
							<th class="usersortable" width=80><?php echo JHTML::_( 'grid.sort', 'COM_KUNENA_USRL_JOIN_DATE', 'registerDate', $this->order_dir, $this->order); ?></th>
							<?php endif; ?>

							<?php if ($this->config->userlist_lastvisitdate) : ?>
							<th class="usersortable" width=90><?php echo JHTML::_( 'grid.sort', 'COM_KUNENA_USRL_LAST_LOGIN', 'lastvisitDate', $this->order_dir, $this->order); ?></th>
							<?php endif; ?>
