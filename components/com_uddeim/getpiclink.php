...
function uddeIMgetPicOnly($ofanid, $config) {				// PIC only
	...
	if ($config->showcbpic==1) {	// CB
		...
		if (uddeIMfileExists($filenamelocal)) {
			$gimmeback = uddeIMgetLinkOnly($ofanid, "<img class='uddeim-tn'".$picstyle." src='".$filenamelive."' alt='' />", $config);
			...
			$gimmeback = uddeIMgetLinkOnly($ofanid, "<img class='uddeim-tn'".$picstyle." src='".$grurl."' alt='' />", $config);
		} elseif (uddeIMfileExists($filename2local)) {
			$gimmeback = uddeIMgetLinkOnly($ofanid, "<img class='uddeim-tn'".$picstyle." src='".$filename2live."' alt='' />", $config);
		} elseif (uddeIMfileExists($filename3local)) {
			$gimmeback = uddeIMgetLinkOnly($ofanid, "<img class='uddeim-tn'".$picstyle." src='".$filename3live."' alt='' />", $config);
		}
...
//		}
		...
		if (uddeIMfileExists($filename1local) && $useavatars && $showavatars) {
			$gimmeback = uddeIMgetLinkOnly($ofanid, "<img class='uddeim-tn'".$picstyle." src='".$filename1live."' alt='' />", $config);
			...
			$gimmeback = uddeIMgetLinkOnly($ofanid, "<img class='uddeim-tn'".$picstyle." src='".$filename4live."' alt='' />", $config);
		}
		...
		if ($avatarFile) {
			$gimmeback = uddeIMgetLinkOnly($ofanid, "<img class='uddeim-tn'".$picstyle." src='".$avatarFile."' alt='' />", $config);
		}
