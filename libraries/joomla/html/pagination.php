...
class JPagination extends JObject
{
	...
	protected function _list_render($list)
	{
		...
		$html = '<label class="pagination-start"> '.$list['start']['data'].' </label>';
		$html .= '<label class="pagination-prev"> '.$list['previous']['data'].' </label>';
		foreach($list['pages'] as $page) {
			$html .= '<label> '.$page['data'].' </label>';
		}
		$html .= '<label class="pagination-next"> '. $list['next']['data'].' </label>';
		$html .= '<label class="pagination-end"> '. $list['end']['data'].' </label>';
